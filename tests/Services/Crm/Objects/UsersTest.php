...
final class UsersTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $result = $this->client->crm->objects->users->create(
            inputs: [
                [
                    'associations' => [
                        [
    ...
    public function testUpdate(): void
    {
        ...
        $result = $this->client->crm->objects->users->update(
    ...
    public function testList(): void
    {
        ...
        $page = $this->client->crm->objects->users->list();
    ...
    public function testDelete(): void
    {
        ...
        $result = $this->client->crm->objects->users->delete(
            inputs: [['id' => '430001']]
        );
    ...
    public function testGet(): void
    {
        ...
        $result = $this->client->crm->objects->users->get(
            inputs: [['id' => '430001']],
            properties: ['string'],
    ...
    public function testSearch(): void
    {
        ...
        $result = $this->client->crm->objects->users->search(
            after: 'after',
            filterGroups: [
                [
                    'filters' => [
    ...
    public function testUpsert(): void
    {
        ...
        $result = $this->client->crm->objects->users->upsert(
            inputs: [['id' => 'id', 'properties' => ['foo' => 'string']]]
        );
