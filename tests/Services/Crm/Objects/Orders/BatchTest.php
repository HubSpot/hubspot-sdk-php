...
namespace Tests\Services\Crm\Objects\Orders;
...
final class BatchTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $result = $this->client->crm->objects->orders->batch->create(
            [
    ...
    public function testUpdate(): void
    {
        ...
        $result = $this->client->crm->objects->orders->batch->update(
            [
    ...
    public function testDelete(): void
    {
        ...
        $result = $this->client->crm->objects->orders->batch->delete(
    ...
    public function testGet(): void
    {
        ...
        $result = $this->client->crm->objects->orders->batch->get(
    ...
    public function testUpsert(): void
    {
        ...
        $result = $this->client->crm->objects->orders->batch->upsert(
            [
