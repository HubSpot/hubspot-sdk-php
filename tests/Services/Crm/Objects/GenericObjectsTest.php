 ...
 */
#[CoversNothing]
final class GenericObjectsTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $result = $this->client->crm->objects->genericObjects->create(
            'objectType',
            associations: [
                [
                    'to' => ['id' => 'id'],
    ...
    public function testUpdate(): void
    {
        ...
        $result = $this->client->crm->objects->genericObjects->update(
            'objectId',
    ...
    public function testList(): void
    {
        ...
        $page = $this->client->crm->objects->genericObjects->list('objectType');
    ...
    public function testDelete(): void
    {
        ...
        $result = $this->client->crm->objects->genericObjects->delete(
            'objectId',
            objectType: 'objectType'
        );
    ...
    public function testGet(): void
    {
        ...
        $result = $this->client->crm->objects->genericObjects->get(
            'objectId',
            objectType: 'objectType'
        );
    ...
    public function testSearch(): void
    {
        ...
        $result = $this->client->crm->objects->genericObjects->search(
            'objectType',
            after: 'after',
            filterGroups: [
                [
