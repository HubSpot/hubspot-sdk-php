...
final class QuotesTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $result = $this->client->crm->objects->quotes->create([
            'associations' => [
                [
                    'to' => ['id' => '37295'],
                    'types' => [
    ...
    public function testUpdate(): void
    {
        ...
        $result = $this->client->crm->objects->quotes->update(
            'quoteId',
            ['properties' => ['foo' => 'string']]
        );
    ...
    public function testList(): void
    {
        ...
        $result = $this->client->crm->objects->quotes->list([]);
    ...
    public function testDelete(): void
    {
        ...
        $result = $this->client->crm->objects->quotes->delete('quoteId');
    ...
    public function testGet(): void
    {
        ...
        $result = $this->client->crm->objects->quotes->get('quoteId', []);
    ...
    public function testSearch(): void
    {
        ...
        $result = $this->client->crm->objects->quotes->search([
            'after' => 'after',
            'filterGroups' => [
                [
                    'filters' => [
