...
final class TaxesTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $result = $this->client->crm->objects->taxes->create(
            inputs: [
                [
                    'associations' => [
                        [
    ...
    public function testUpdate(): void
    {
        ...
        $result = $this->client->crm->objects->taxes->update(
    ...
    public function testList(): void
    {
        ...
        $page = $this->client->crm->objects->taxes->list();
    ...
    public function testDelete(): void
    {
        ...
        $result = $this->client->crm->objects->taxes->delete(
            inputs: [['id' => '430001']]
        );
    ...
    public function testGet(): void
    {
        ...
        $result = $this->client->crm->objects->taxes->get(
            inputs: [['id' => '430001']],
            properties: ['string'],
    ...
    public function testSearch(): void
    {
        ...
        $result = $this->client->crm->objects->taxes->search(
            after: 'after',
            filterGroups: [
                [
                    'filters' => [
    ...
    public function testUpsert(): void
    {
        ...
        $result = $this->client->crm->objects->taxes->upsert(
            inputs: [['id' => 'id', 'properties' => ['foo' => 'string']]]
        );
