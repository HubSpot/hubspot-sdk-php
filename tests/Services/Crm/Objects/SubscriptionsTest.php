...
final class SubscriptionsTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $result = $this->client->crm->objects->subscriptions->create(
            associations: [
                [
                    'to' => ['id' => 'id'],
                    'types' => [
    ...
    public function testUpdate(): void
    {
        ...
        $result = $this->client->crm->objects->subscriptions->update(
            'subscriptionId',
            properties: ['foo' => 'string']
        );
    ...
    public function testList(): void
    {
        ...
        $page = $this->client->crm->objects->subscriptions->list();
    ...
    public function testDelete(): void
    {
        ...
        $result = $this->client->crm->objects->subscriptions->delete(
            'subscriptionId'
        );
    ...
    public function testGet(): void
    {
        ...
        $result = $this->client->crm->objects->subscriptions->get('subscriptionId');
    ...
    public function testSearch(): void
    {
        ...
        $result = $this->client->crm->objects->subscriptions->search(
            after: 'after',
            filterGroups: [
                [
                    'filters' => [
