...
final class PostalMailTest extends TestCase
{
    ...
    public function testList(): void
    {
        ...
        $page = $this->client->crm->objects->postalMail->list();
    ...
    public function testDelete(): void
    {
        ...
        $result = $this->client->crm->objects->postalMail->delete(
            inputs: [['id' => '430001']]
        );
    ...
    public function testGet(): void
    {
        ...
        $result = $this->client->crm->objects->postalMail->get(
            inputs: [['id' => '430001']],
            properties: ['string'],
    ...
    public function testUpsert(): void
    {
        ...
        $result = $this->client->crm->objects->postalMail->upsert(
            inputs: [['id' => 'id', 'properties' => ['foo' => 'string']]]
        );
