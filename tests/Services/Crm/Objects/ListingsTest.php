...
final class ListingsTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $result = $this->client->crm->objects->listings->create(
            inputs: [
                [
                    'associations' => [
                        [
    ...
    public function testUpdate(): void
    {
        ...
        $result = $this->client->crm->objects->listings->update(
    ...
    public function testList(): void
    {
        ...
        $page = $this->client->crm->objects->listings->list();
    ...
    public function testDelete(): void
    {
        ...
        $result = $this->client->crm->objects->listings->delete(
            inputs: [['id' => '430001']]
        );
    ...
    public function testGet(): void
    {
        ...
        $result = $this->client->crm->objects->listings->get(
            inputs: [['id' => '430001']],
            properties: ['string'],
    ...
    public function testSearch(): void
    {
        ...
        $result = $this->client->crm->objects->listings->search(
            after: 'after',
            filterGroups: [
                [
                    'filters' => [
    ...
    public function testUpsert(): void
    {
        ...
        $result = $this->client->crm->objects->listings->upsert(
            inputs: [['id' => 'id', 'properties' => ['foo' => 'string']]]
        );
