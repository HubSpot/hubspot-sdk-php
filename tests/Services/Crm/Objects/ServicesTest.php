...
final class ServicesTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $result = $this->client->crm->objects->services->create(
            inputs: [
                [
                    'associations' => [
                        [
    ...
    public function testUpdate(): void
    {
        ...
        $result = $this->client->crm->objects->services->update(
    ...
    public function testList(): void
    {
        ...
        $page = $this->client->crm->objects->services->list();
    ...
    public function testDelete(): void
    {
        ...
        $result = $this->client->crm->objects->services->delete(
            inputs: [['id' => '430001']]
        );
    ...
    public function testGet(): void
    {
        ...
        $result = $this->client->crm->objects->services->get(
            inputs: [['id' => '430001']],
            properties: ['string'],
    ...
    public function testSearch(): void
    {
        ...
        $result = $this->client->crm->objects->services->search(
            after: 'after',
            filterGroups: [
                [
                    'filters' => [
    ...
    public function testUpsert(): void
    {
        ...
        $result = $this->client->crm->objects->services->upsert(
            inputs: [['id' => 'id', 'properties' => ['foo' => 'string']]]
        );
