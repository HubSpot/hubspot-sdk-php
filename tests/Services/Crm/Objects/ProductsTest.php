...
final class ProductsTest extends TestCase
{
    ...
    public function testList(): void
    {
        ...
        $page = $this->client->crm->objects->products->list();
    ...
    public function testDelete(): void
    {
        ...
        $result = $this->client->crm->objects->products->delete(
            inputs: [['id' => '430001']]
        );
    ...
    public function testGet(): void
    {
        ...
        $result = $this->client->crm->objects->products->get(
            inputs: [['id' => '430001']],
            properties: ['string'],
    ...
    public function testUpsert(): void
    {
        ...
        $result = $this->client->crm->objects->products->upsert(
            inputs: [['id' => 'id', 'properties' => ['foo' => 'string']]]
        );
