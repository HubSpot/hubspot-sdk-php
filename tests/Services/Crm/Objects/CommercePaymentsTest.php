 ...
 */
#[CoversNothing]
final class CommercePaymentsTest extends TestCase
{
    ...
    public function testList(): void
    {
        ...
        $page = $this->client->crm->objects->commercePayments->list();
    ...
    public function testDelete(): void
    {
        ...
        $result = $this->client->crm->objects->commercePayments->delete(
            'commercePaymentId'
        );
