...
final class TasksTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $result = $this->client->crm->objects->tasks->create([
            'associations' => [
                [
                    'to' => ['id' => '37295'],
                    'types' => [
    ...
    public function testUpdate(): void
    {
        ...
        $result = $this->client->crm->objects->tasks->update(
            'taskId',
            ['properties' => ['foo' => 'string']]
        );
    ...
    public function testList(): void
    {
        ...
        $result = $this->client->crm->objects->tasks->list([]);
    ...
    public function testDelete(): void
    {
        ...
        $result = $this->client->crm->objects->tasks->delete('taskId');
    ...
    public function testGet(): void
    {
        ...
        $result = $this->client->crm->objects->tasks->get('taskId', []);
    ...
    public function testSearch(): void
    {
        ...
        $result = $this->client->crm->objects->tasks->search([
            'after' => 'after',
            'filterGroups' => [
                [
                    'filters' => [
