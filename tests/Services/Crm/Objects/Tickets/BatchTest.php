...
namespace Tests\Services\Crm\Objects\Tickets;
...
final class BatchTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $result = $this->client->crm->objects->tickets->batch->create(
            [
    ...
    public function testUpdate(): void
    {
        ...
        $result = $this->client->crm->objects->tickets->batch->update(
            [
    ...
    public function testDelete(): void
    {
        ...
        $result = $this->client->crm->objects->tickets->batch->delete(
    ...
    public function testGet(): void
    {
        ...
        $result = $this->client->crm->objects->tickets->batch->get(
    ...
    public function testUpsert(): void
    {
        ...
        $result = $this->client->crm->objects->tickets->batch->upsert(
            [
