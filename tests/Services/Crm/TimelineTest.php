...
final class TimelineTest extends TestCase
{
    ...
    public function testCreateEvent(): void
    {
        ...
        $result = $this->client->crm->timeline->createEvent(
            id: 'id',
    ...
    #[Test]
    public function testCreateProjectType(): void
    {
        if (UnsupportedMockTests::$skip) {
            $this->markTestSkipped('Mock server tests are disabled');
        }

        $result = $this->client->crm->timeline->createProjectType(
            developerSymbol: 'developerSymbol',
            projectName: 'projectName'
        );

        // @phpstan-ignore-next-line method.alreadyNarrowedType
        $this->assertInstanceOf(AppEventResolutionResponse::class, $result);
    }

    #[Test]
    public function testCreateProjectTypeWithOptionalParams(): void
    {
        if (UnsupportedMockTests::$skip) {
            $this->markTestSkipped('Mock server tests are disabled');
        }
