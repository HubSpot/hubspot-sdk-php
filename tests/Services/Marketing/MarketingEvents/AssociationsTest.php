...
final class AssociationsTest extends TestCase
{
    ...
    public function testList(): void
    {
        ...
        $result = $this->client->marketing->marketingEvents->associations->list(
            'marketingEventId'
        );
    ...
    public function testDelete(): void
    {
        ...
        $result = $this->client->marketing->marketingEvents->associations->delete(
            'listId',
            'marketingEventId'
        );
    ...
    public function testAssociate(): void
    {
        ...
        $result = $this
            ...
            ->marketingEvents
            ->associations
            ->associate('listId', 'marketingEventId')
        ;
