...
final class WebsitePagesTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $result = $this->client->cms->pages->websitePages->create(
            id: 'id',
    ...
    public function testUpdate(): void
    {
        ...
        $result = $this->client->cms->pages->websitePages->update(
            'objectId',
            id: 'id',
            abStatus: 'automated_loser_variant',
            abTestID: 'abTestId',
    ...
    public function testList(): void
    {
        ...
        $page = $this->client->cms->pages->websitePages->list();
        ...
        if ($item = $page->getItems()[0] ?? null) {
            // @phpstan-ignore-next-line method.alreadyNarrowedType
            $this->assertInstanceOf(\HubspotSDK\Cms\Pages\Page::class, $item);
        }
    }
    ...
    public function testDelete(): void
    {
        ...
        $result = $this->client->cms->pages->websitePages->delete('objectId');
    ...
    public function testCloneWithOptionalParams(): void
    {
        ...
        $result = $this->client->cms->pages->websitePages->clone(
            id: 'id',
            cloneName: 'cloneName'
        );
    ...
    public function testPublishDraft(): void
    {
        ...
        $result = $this->client->cms->pages->websitePages->publishDraft('objectId');
    ...
    public function testSchedule(): void
    {
        ...
        $result = $this->client->cms->pages->websitePages->schedule(
            id: 'id',
            publishDate: new \DateTimeImmutable('2019-12-27T18:11:19.117Z')
        );
    ...
    public function testSetNewLangPrimary(): void
    {
        ...
        $result = $this->client->cms->pages->websitePages->setNewLangPrimary(
            id: 'id'
        );
    ...
    public function testUpdateDraft(): void
    {
        ...
        $result = $this->client->cms->pages->websitePages->updateDraft(
            'objectId',
            id: 'id',
            abStatus: 'automated_loser_variant',
            abTestID: 'abTestId',
