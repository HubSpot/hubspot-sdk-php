...
final class DraftTest extends TestCase
{
    ...
    public function testUpdate(): void
    {
        ...
        $result = $this->client->cms->pages->landingPages->draft->update(
            'objectId',
            id: 'id',
    ...
    public function testGet(): void
    {
        ...
        $result = $this->client->cms->pages->landingPages->draft->get('objectId');
    ...
    public function testPushLive(): void
    {
        ...
        $result = $this->client->cms->pages->landingPages->draft->pushLive(
            'objectId'
        );
    ...
    public function testReset(): void
    {
        ...
        $result = $this->client->cms->pages->landingPages->draft->reset('objectId');
