...
final class BatchTest extends TestCase
{
    ...
    public function testCreateFolders(): void
    {
        ...
        $result = $this->client->cms->pages->batch->createFolders(
            inputs: [
                [
                    'id' => 'id',
                    'category' => 0,
    ...
    public function testCreateLandingPages(): void
    {
        ...
        $result = $this->client->cms->pages->batch->createLandingPages(
            inputs: [
                [
                    'id' => 'id',
    ...
    #[Test]
    public function testCreateSitePages(): void
    {
        if (UnsupportedMockTests::$skip) {
            $this->markTestSkipped('Mock server tests are disabled');
        }

        $result = $this->client->cms->pages->batch->createSitePages(
            inputs: [
                [
                    'id' => 'id',
                    'abStatus' => 'automated_loser_variant',
    ...
    #[Test]
    public function testCreateSitePagesWithOptionalParams(): void
    {
        if (UnsupportedMockTests::$skip) {
            $this->markTestSkipped('Mock server tests are disabled');
        }
    ...
    public function testDeleteFolders(): void
    {
        ...
        $result = $this->client->cms->pages->batch->deleteFolders(
            inputs: ['string']
        );
    ...
    public function testDeleteLandingPages(): void
    {
        ...
        $result = $this->client->cms->pages->batch->deleteLandingPages(
            inputs: ['string']
        );
    ...
    #[Test]
    public function testDeleteSitePages(): void
    {
        if (UnsupportedMockTests::$skip) {
            $this->markTestSkipped('Mock server tests are disabled');
        }

        $result = $this->client->cms->pages->batch->deleteSitePages(
            inputs: ['string']
        );
    ...
    #[Test]
    public function testDeleteSitePagesWithOptionalParams(): void
    {
        if (UnsupportedMockTests::$skip) {
            $this->markTestSkipped('Mock server tests are disabled');
        }
    ...
    public function testGetLandingPages(): void
    {
        ...
        $result = $this->client->cms->pages->batch->getLandingPages(
            inputs: ['string']
        );
    ...
    public function testGetSitePages(): void
    {
        ...
        $result = $this->client->cms->pages->batch->getSitePages(
            inputs: ['string']
        );
    ...
    #[Test]
    public function testGetSitePagesWithOptionalParams(): void
    {
        if (UnsupportedMockTests::$skip) {
            $this->markTestSkipped('Mock server tests are disabled');
        }
    ...
    public function testUpdateFolders(): void
    {
        ...
        $result = $this->client->cms->pages->batch->updateFolders(
            inputs: [(object) []]
        );
    ...
    public function testUpdateLandingPages(): void
    {
        ...
        $result = $this->client->cms->pages->batch->updateLandingPages(
            inputs: [(object) []]
        );
    ...
    #[Test]
    public function testUpdateSitePages(): void
    {
        if (UnsupportedMockTests::$skip) {
            $this->markTestSkipped('Mock server tests are disabled');
        }

        $result = $this->client->cms->pages->batch->updateSitePages(
            inputs: [(object) []]
        );
    ...
    #[Test]
    public function testUpdateSitePagesWithOptionalParams(): void
    {
        if (UnsupportedMockTests::$skip) {
            $this->markTestSkipped('Mock server tests are disabled');
        }
