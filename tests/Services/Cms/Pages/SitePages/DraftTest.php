...
final class DraftTest extends TestCase
{
    ...
    public function testGetDraft(): void
    {
        ...
        $result = $this->client->cms->pages->sitePages->draft->getDraft('objectId');
    ...
    public function testPublishDraft(): void
    {
        ...
        $result = $this->client->cms->pages->sitePages->draft->publishDraft(
            'objectId'
        );
    ...
    public function testResetSitePageDraft(): void
    {
        ...
        $result = $this->client->cms->pages->sitePages->draft->resetSitePageDraft(
            'objectId'
        );
    ...
    public function testUpdateDraft(): void
    {
        ...
        $result = $this->client->cms->pages->sitePages->draft->updateDraft(
            'objectId',
            id: 'id',
