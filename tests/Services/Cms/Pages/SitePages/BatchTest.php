...
final class BatchTest extends TestCase
{
    ...
    public function testCreateSitePages(): void
    {
        ...
        $result = $this->client->cms->pages->sitePages->batch->createSitePages(
            inputs: [
                [
                    'id' => 'id',
    ...
    public function testDeleteSitePages(): void
    {
        ...
        $result = $this->client->cms->pages->sitePages->batch->deleteSitePages(
            inputs: ['string']
        );
    ...
    public function testGetSitePages(): void
    {
        ...
        $result = $this->client->cms->pages->sitePages->batch->getSitePages(
            inputs: ['string']
        );
    ...
    public function testUpdateSitePages(): void
    {
        ...
        $result = $this->client->cms->pages->sitePages->batch->updateSitePages(
            inputs: [(object) []]
        );
