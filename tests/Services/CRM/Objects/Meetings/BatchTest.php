...
namespace Tests\Services\CRM\Objects\Meetings;
...
final class BatchTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $result = $this->client->crm->objects->meetings->batch->create(
            [
    ...
    public function testUpdate(): void
    {
        ...
        $result = $this->client->crm->objects->meetings->batch->update(
            [
    ...
    public function testArchive(): void
    {
        ...
        $result = $this->client->crm->objects->meetings->batch->archive(
    ...
    public function testRead(): void
    {
        ...
        $result = $this->client->crm->objects->meetings->batch->read(
    ...
    public function testUpsert(): void
    {
        ...
        $result = $this->client->crm->objects->meetings->batch->upsert(
            [
