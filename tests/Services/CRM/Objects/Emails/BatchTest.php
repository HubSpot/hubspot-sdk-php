...
namespace Tests\Services\CRM\Objects\Emails;
...
final class BatchTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $result = $this->client->crm->objects->emails->batch->create(
            [
    ...
    public function testUpdate(): void
    {
        ...
        $result = $this->client->crm->objects->emails->batch->update(
            [
    ...
    public function testDelete(): void
    {
        ...
        $result = $this->client->crm->objects->emails->batch->delete(
    ...
    public function testRead(): void
    {
        ...
        $result = $this->client->crm->objects->emails->batch->read(
    ...
    public function testUpsert(): void
    {
        ...
        $result = $this->client->crm->objects->emails->batch->upsert(
            [
