...
namespace Tests\Services\CRM\Objects\Custom;
...
final class BatchTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $result = $this->client->crm->objects->custom->batch->create(
            'objectType',
            [
    ...
    public function testUpdate(): void
    {
        ...
        $result = $this->client->crm->objects->custom->batch->update(
            'objectType',
            [
    ...
    public function testDelete(): void
    {
        ...
        $result = $this->client->crm->objects->custom->batch->delete(
            'objectType',
    ...
    public function testRead(): void
    {
        ...
        $result = $this->client->crm->objects->custom->batch->read(
            'objectType',
    ...
    public function testUpsert(): void
    {
        ...
        $result = $this->client->crm->objects->custom->batch->upsert(
            'objectType',
            [
