...
namespace Tests\Services\CRM\Objects\Invoices;
...
final class BatchTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $result = $this->client->crm->objects->invoices->batch->create(
            [
    ...
    public function testUpdate(): void
    {
        ...
        $result = $this->client->crm->objects->invoices->batch->update(
            [
    ...
    public function testArchive(): void
    {
        ...
        $result = $this->client->crm->objects->invoices->batch->archive(
    ...
    public function testRead(): void
    {
        ...
        $result = $this->client->crm->objects->invoices->batch->read(
    ...
    public function testUpsert(): void
    {
        ...
        $result = $this->client->crm->objects->invoices->batch->upsert(
            [
