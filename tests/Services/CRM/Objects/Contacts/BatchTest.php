...
namespace Tests\Services\CRM\Objects\Contacts;
...
final class BatchTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $result = $this->client->crm->objects->contacts->batch->create(
            [
    ...
    public function testUpdate(): void
    {
        ...
        $result = $this->client->crm->objects->contacts->batch->update(
            [
    ...
    public function testRead(): void
    {
        ...
        $result = $this->client->crm->objects->contacts->batch->read(
    ...
    public function testUpsert(): void
    {
        ...
        $result = $this->client->crm->objects->contacts->batch->upsert(
            [
