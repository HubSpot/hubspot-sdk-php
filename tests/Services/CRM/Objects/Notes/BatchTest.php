...
namespace Tests\Services\CRM\Objects\Notes;
...
final class BatchTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $result = $this->client->crm->objects->notes->batch->create(
            [
    ...
    public function testUpdate(): void
    {
        ...
        $result = $this->client->crm->objects->notes->batch->update(
            [
    ...
    public function testArchive(): void
    {
        ...
        $result = $this->client->crm->objects->notes->batch->archive(
    ...
    public function testRead(): void
    {
        ...
        $result = $this->client->crm->objects->notes->batch->read(
    ...
    public function testUpsert(): void
    {
        ...
        $result = $this->client->crm->objects->notes->batch->upsert(
            [
