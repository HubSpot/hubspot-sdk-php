...
/**
 * @phpstan-type account_hydrated_critical_action = array{
 *   id: string,
 ...
 * }
 */
final class AccountHydratedCriticalAction implements BaseModel
{
    /** @use SdkModel<account_hydrated_critical_action> */
    use SdkModel;
    ...
    /**
     * `new AccountHydratedCriticalAction()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AccountHydratedCriticalAction::with(
     *   id: ..., createdAt: ..., type: ..., userID: ...
     * )
     * ```
     *
     ...
     *
     * ```
     * (new AccountHydratedCriticalAction)
     *   ->withID(...)
     *   ->withCreatedAt(...)
     *   ->withType(...)
     *   ->withUserID(...)
