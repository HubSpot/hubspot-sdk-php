...
use HubspotSDK\Marketing\Subscriptions\V4\Statuses\StatusBatchGetUnsubscribeAllStatusParams\Channel;
 ...
 *
 * @phpstan-type status_batch_get_unsubscribe_all_status_params = array{
 *   channel: Channel|value-of<Channel>, inputs: list<string>, businessUnitID?: int
 * }
 */
final class StatusBatchGetUnsubscribeAllStatusParams implements BaseModel
{
    /** @use SdkModel<status_batch_get_unsubscribe_all_status_params> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new StatusBatchGetUnsubscribeAllStatusParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * StatusBatchGetUnsubscribeAllStatusParams::with(channel: ..., inputs: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new StatusBatchGetUnsubscribeAllStatusParams)
     *   ->withChannel(...)
     *   ->withInputs(...)
     * ```
     */
