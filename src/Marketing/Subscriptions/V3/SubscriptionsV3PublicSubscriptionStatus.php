...
use HubspotSDK\Marketing\Subscriptions\V3\SubscriptionsV3PublicSubscriptionStatus\LegalBasis;
use HubspotSDK\Marketing\Subscriptions\V3\SubscriptionsV3PublicSubscriptionStatus\SourceOfStatus;
use HubspotSDK\Marketing\Subscriptions\V3\SubscriptionsV3PublicSubscriptionStatus\Status;

/**
 * @phpstan-type subscriptions_v3_public_subscription_status = array{
 *   id: string,
 *   name: string,
 ...
 * }
 */
final class SubscriptionsV3PublicSubscriptionStatus implements BaseModel
{
    /** @use SdkModel<subscriptions_v3_public_subscription_status> */
    use SdkModel;
    ...
    /**
     * `new SubscriptionsV3PublicSubscriptionStatus()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SubscriptionsV3PublicSubscriptionStatus::with(
     ...
     *
     * ```
     * (new SubscriptionsV3PublicSubscriptionStatus)
     *   ->withID(...)
     *   ->withName(...)
     *   ->withSourceOfStatus(...)
     *   ->withStatus(...)
