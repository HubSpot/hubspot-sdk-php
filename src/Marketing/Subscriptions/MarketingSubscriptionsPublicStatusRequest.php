...
use HubspotSDK\Marketing\Subscriptions\MarketingSubscriptionsPublicStatusRequest\Channel;
use HubspotSDK\Marketing\Subscriptions\MarketingSubscriptionsPublicStatusRequest\LegalBasis;
use HubspotSDK\Marketing\Subscriptions\MarketingSubscriptionsPublicStatusRequest\StatusState;

/**
 * @phpstan-type marketing_subscriptions_public_status_request = array{
 ...
 * }
 */
final class MarketingSubscriptionsPublicStatusRequest implements BaseModel
{
    /** @use SdkModel<marketing_subscriptions_public_status_request> */
    use SdkModel;
    ...
    /**
     * `new MarketingSubscriptionsPublicStatusRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingSubscriptionsPublicStatusRequest::with(
     ...
     *
     * ```
     * (new MarketingSubscriptionsPublicStatusRequest)
     *   ->withChannel(...)
     *   ->withStatusState(...)
