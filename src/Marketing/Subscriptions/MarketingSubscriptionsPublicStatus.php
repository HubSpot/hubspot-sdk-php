...
use HubspotSDK\Marketing\Subscriptions\MarketingSubscriptionsPublicStatus\Channel;
use HubspotSDK\Marketing\Subscriptions\MarketingSubscriptionsPublicStatus\LegalBasis;
use HubspotSDK\Marketing\Subscriptions\MarketingSubscriptionsPublicStatus\SetStatusSuccessReason;
use HubspotSDK\Marketing\Subscriptions\MarketingSubscriptionsPublicStatus\Status;

/**
 * @phpstan-type marketing_subscriptions_public_status = array{
 ...
 * }
 */
final class MarketingSubscriptionsPublicStatus implements BaseModel
{
    /** @use SdkModel<marketing_subscriptions_public_status> */
    use SdkModel;
    ...
    /**
     * `new MarketingSubscriptionsPublicStatus()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingSubscriptionsPublicStatus::with(
     *   channel: ...,
     *   source: ...,
     *   status: ...,
     *   subscriberIDString: ...,
     ...
     *
     * ```
     * (new MarketingSubscriptionsPublicStatus)
     *   ->withChannel(...)
     *   ->withSource(...)
     *   ->withStatus(...)
