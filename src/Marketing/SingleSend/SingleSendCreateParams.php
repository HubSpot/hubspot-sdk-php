 ...
 * }
 */
final class SingleSendCreateParams implements BaseModel
{
    /** @use SdkModel<SingleSendCreateParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new SingleSendCreateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SingleSendCreateParams::with(
