...
/**
 * @phpstan-type marketing_emails_email_statistics_data = array{
 ...
 * }
 */
final class MarketingEmailsEmailStatisticsData implements BaseModel
{
    /** @use SdkModel<marketing_emails_email_statistics_data> */
    use SdkModel;
    ...
    /**
     * `new MarketingEmailsEmailStatisticsData()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingEmailsEmailStatisticsData::with(
     ...
     *
     * ```
     * (new MarketingEmailsEmailStatisticsData)
     *   ->withCounters(...)
     *   ->withDeviceBreakdown(...)
     *   ->withQualifierStats(...)
     *   ->withRatios(...)
