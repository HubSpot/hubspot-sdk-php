...
use HubspotSDK\Marketing\Emails\MarketingEmailsEmailCreateRequest\Language;
use HubspotSDK\Marketing\Emails\MarketingEmailsEmailCreateRequest\State;
use HubspotSDK\Marketing\Emails\MarketingEmailsEmailCreateRequest\Subcategory;

/**
 * @phpstan-type marketing_emails_email_create_request = array{
 *   name: string,
 *   activeDomain?: string,
 *   archived?: bool,
 *   businessUnitID?: int,
 ...
 * }
 */
final class MarketingEmailsEmailCreateRequest implements BaseModel
{
    /** @use SdkModel<marketing_emails_email_create_request> */
    use SdkModel;
    ...
    /**
     * `new MarketingEmailsEmailCreateRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingEmailsEmailCreateRequest::with(name: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new MarketingEmailsEmailCreateRequest)->withName(...)
     * ```
     */
