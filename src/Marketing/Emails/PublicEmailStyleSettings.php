 ...
 *   backgroundImageType?: null|BackgroundImageType|value-of<BackgroundImageType>,
...
final class PublicEmailStyleSettings implements BaseModel
{
    ...
    /** @var value-of<BackgroundImageType>|null $backgroundImageType */
    #[Optional(enum: BackgroundImageType::class)]
     ...
     *
     * @param BackgroundImageType|value-of<BackgroundImageType>|null $backgroundImageType
    ...
    public static function with(
        ...
        BackgroundImageType|string|null $backgroundImageType = null,
    ...
    /**
     * @param BackgroundImageType|value-of<BackgroundImageType> $backgroundImageType
     */
    public function withBackgroundImageType(
        BackgroundImageType|string $backgroundImageType
    ): self {
        $self = clone $this;
