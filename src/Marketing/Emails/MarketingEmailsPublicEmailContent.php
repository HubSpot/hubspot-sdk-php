...
/**
 * @phpstan-type marketing_emails_public_email_content = array{
 ...
 * }
 */
final class MarketingEmailsPublicEmailContent implements BaseModel
{
    /** @use SdkModel<marketing_emails_public_email_content> */
    use SdkModel;
    ...
    #[Api(optional: true)]
    public ?MarketingEmailsPublicEmailStyleSettings $styleSettings;
    ...
    public static function with(
        ...
        ?MarketingEmailsPublicEmailStyleSettings $styleSettings = null,
    ...
    public function withStyleSettings(
        MarketingEmailsPublicEmailStyleSettings $styleSettings
    ): self {
        $obj = clone $this;
