...
/**
 * @phpstan-type marketing_emails_public_divider_style_settings = array{
 *   color?: mixed, height?: int, lineType?: string
 * }
 */
final class MarketingEmailsPublicDividerStyleSettings implements BaseModel
{
    /** @use SdkModel<marketing_emails_public_divider_style_settings> */
    use SdkModel;
