...
/**
 * @phpstan-type marketing_emails_public_email_recipients = array{
 *   exclude?: list<string>, include1?: list<string>
 * }
 */
final class MarketingEmailsPublicEmailRecipients implements BaseModel
{
    /** @use SdkModel<marketing_emails_public_email_recipients> */
    use SdkModel;
