...
/**
 * @phpstan-type marketing_emails_public_button_style_settings = array{
 *   backgroundColor?: mixed,
 *   cornerRadius?: int,
 *   fontStyle?: MarketingEmailsPublicFontStyle,
 * }
 */
final class MarketingEmailsPublicButtonStyleSettings implements BaseModel
{
    /** @use SdkModel<marketing_emails_public_button_style_settings> */
    use SdkModel;
    ...
    #[Api(optional: true)]
    public ?MarketingEmailsPublicFontStyle $fontStyle;
    ...
    public static function with(
        ...
        ?MarketingEmailsPublicFontStyle $fontStyle = null,
    ): self {
        $obj = new self;
    ...
    public function withFontStyle(
        MarketingEmailsPublicFontStyle $fontStyle
    ): self {
        $obj = clone $this;
