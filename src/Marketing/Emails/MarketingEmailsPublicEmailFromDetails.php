...
/**
 * @phpstan-type marketing_emails_public_email_from_details = array{
 *   customReplyTo?: string, fromName?: string, replyTo?: string
 * }
 */
final class MarketingEmailsPublicEmailFromDetails implements BaseModel
{
    /** @use SdkModel<marketing_emails_public_email_from_details> */
    use SdkModel;
