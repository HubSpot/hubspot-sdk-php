...
final class PublicEmailTestingDetails implements BaseModel
{
    ...
    /**
     * `new PublicEmailTestingDetails()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * PublicEmailTestingDetails::with(isAbVariation: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new PublicEmailTestingDetails)->withIsAbVariation(...)
     * ```
     */
