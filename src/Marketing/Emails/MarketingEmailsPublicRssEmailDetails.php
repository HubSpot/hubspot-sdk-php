...
/**
 * @phpstan-type marketing_emails_public_rss_email_details = array{
 ...
 * }
 */
final class MarketingEmailsPublicRssEmailDetails implements BaseModel
{
    /** @use SdkModel<marketing_emails_public_rss_email_details> */
    use SdkModel;
