...
namespace HubspotSDK\Marketing\Emails\SingleSend;
 ...
 *
 * @see HubspotSDK\Marketing\Emails\SingleSend->send
 *
 * @phpstan-type single_send_send_params = array{
 *   emailID: int,
 ...
 * }
 */
final class SingleSendSendParams implements BaseModel
{
    /** @use SdkModel<single_send_send_params> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new SingleSendSendParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SingleSendSendParams::with(emailID: ..., message: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new SingleSendSendParams)->withEmailID(...)->withMessage(...)
     * ```
     */
