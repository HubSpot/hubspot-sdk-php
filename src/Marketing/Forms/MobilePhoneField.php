...
use HubspotSDK\Marketing\Forms\MobilePhoneField\FieldType;
...
final class MobilePhoneField implements BaseModel
{
    ...
    /**
     * `new MobilePhoneField()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MobilePhoneField::with(
     *   dependentFields: ...,
     *   fieldType: ...,
     *   hidden: ...,
     *   label: ...,
