...
use HubspotSDK\Marketing\Forms\MarketingFormsDatepickerField\FieldType;

/**
 * @phpstan-type marketing_forms_datepicker_field = array{
 ...
 * }
 */
final class MarketingFormsDatepickerField implements BaseModel
{
    /** @use SdkModel<marketing_forms_datepicker_field> */
    use SdkModel;
    ...
    /**
     * `new MarketingFormsDatepickerField()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingFormsDatepickerField::with(
     *   dependentFields: ...,
     *   fieldType: ...,
     *   hidden: ...,
     *   label: ...,
     ...
     *
     * ```
     * (new MarketingFormsDatepickerField)
     *   ->withDependentFields(...)
     *   ->withFieldType(...)
     *   ->withHidden(...)
     *   ->withLabel(...)
