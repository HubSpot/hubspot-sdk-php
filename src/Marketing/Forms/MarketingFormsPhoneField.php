...
use HubspotSDK\Marketing\Forms\MarketingFormsPhoneField\FieldType;

/**
 * @phpstan-type marketing_forms_phone_field = array{
 ...
 * }
 */
final class MarketingFormsPhoneField implements BaseModel
{
    /** @use SdkModel<marketing_forms_phone_field> */
    use SdkModel;
    ...
    #[Api]
    public bool $useCountryCodeSelect;
    ...
    /**
     * `new MarketingFormsPhoneField()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingFormsPhoneField::with(
     *   dependentFields: ...,
     *   fieldType: ...,
     *   hidden: ...,
     *   label: ...,
