...
use HubspotSDK\Marketing\Forms\MarketingFormsPaymentLinkRadioField\FieldType;

/**
 * @phpstan-type marketing_forms_payment_link_radio_field = array{
 ...
 * }
 */
final class MarketingFormsPaymentLinkRadioField implements BaseModel
{
    /** @use SdkModel<marketing_forms_payment_link_radio_field> */
    use SdkModel;
    ...
    /**
     * `new MarketingFormsPaymentLinkRadioField()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingFormsPaymentLinkRadioField::with(
     *   defaultValues: ...,
     *   dependentFields: ...,
     *   fieldType: ...,
     *   hidden: ...,
     ...
     *
     * ```
     * (new MarketingFormsPaymentLinkRadioField)
     *   ->withDefaultValues(...)
     *   ->withDependentFields(...)
     *   ->withFieldType(...)
     *   ->withHidden(...)
