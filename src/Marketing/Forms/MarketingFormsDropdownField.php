...
use HubspotSDK\Marketing\Forms\MarketingFormsDropdownField\FieldType;

/**
 * @phpstan-type marketing_forms_dropdown_field = array{
 ...
 * }
 */
final class MarketingFormsDropdownField implements BaseModel
{
    /** @use SdkModel<marketing_forms_dropdown_field> */
    use SdkModel;
    ...
    /**
     * `new MarketingFormsDropdownField()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingFormsDropdownField::with(
     *   defaultValues: ...,
     *   dependentFields: ...,
     *   fieldType: ...,
     *   hidden: ...,
     ...
     *
     * ```
     * (new MarketingFormsDropdownField)
     *   ->withDefaultValues(...)
     *   ->withDependentFields(...)
     *   ->withFieldType(...)
     *   ->withHidden(...)
