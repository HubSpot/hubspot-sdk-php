...
use HubspotSDK\Marketing\Forms\MarketingFormsMultiLineTextField\FieldType;

/**
 * @phpstan-type marketing_forms_multi_line_text_field = array{
 ...
 * }
 */
final class MarketingFormsMultiLineTextField implements BaseModel
{
    /** @use SdkModel<marketing_forms_multi_line_text_field> */
    use SdkModel;
    ...
    /**
     * `new MarketingFormsMultiLineTextField()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingFormsMultiLineTextField::with(
     *   dependentFields: ...,
     *   fieldType: ...,
     *   hidden: ...,
     *   label: ...,
     ...
     *
     * ```
     * (new MarketingFormsMultiLineTextField)
     *   ->withDependentFields(...)
     *   ->withFieldType(...)
     *   ->withHidden(...)
     *   ->withLabel(...)
    ...
    public static function with(
        ...
        string $objectTypeID,
        bool $required,
        FieldType|string $fieldType = 'multi_line_text',
