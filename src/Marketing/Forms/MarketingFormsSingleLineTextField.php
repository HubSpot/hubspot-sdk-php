...
use HubspotSDK\Marketing\Forms\MarketingFormsSingleLineTextField\FieldType;

/**
 * @phpstan-type marketing_forms_single_line_text_field = array{
 ...
 * }
 */
final class MarketingFormsSingleLineTextField implements BaseModel
{
    /** @use SdkModel<marketing_forms_single_line_text_field> */
    use SdkModel;
    ...
    /**
     * `new MarketingFormsSingleLineTextField()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingFormsSingleLineTextField::with(
     *   dependentFields: ...,
     *   fieldType: ...,
     *   hidden: ...,
     *   label: ...,
     ...
     *
     * ```
     * (new MarketingFormsSingleLineTextField)
     *   ->withDependentFields(...)
     *   ->withFieldType(...)
     *   ->withHidden(...)
     *   ->withLabel(...)
