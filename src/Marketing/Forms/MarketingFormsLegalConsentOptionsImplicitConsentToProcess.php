...
use HubspotSDK\Marketing\Forms\MarketingFormsLegalConsentOptionsImplicitConsentToProcess\Type;

/**
 * @phpstan-type marketing_forms_legal_consent_options_implicit_consent_to_process = array{
 ...
 * }
 */
final class MarketingFormsLegalConsentOptionsImplicitConsentToProcess implements BaseModel
{
    /**
     * @use SdkModel<marketing_forms_legal_consent_options_implicit_consent_to_process>
     */
    use SdkModel;
    ...
    /**
     * `new MarketingFormsLegalConsentOptionsImplicitConsentToProcess()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingFormsLegalConsentOptionsImplicitConsentToProcess::with(
     ...
     *
     * ```
     * (new MarketingFormsLegalConsentOptionsImplicitConsentToProcess)
