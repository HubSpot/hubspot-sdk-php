...
use HubspotSDK\Marketing\Forms\MarketingFormsMultipleCheckboxesField\FieldType;

/**
 * @phpstan-type marketing_forms_multiple_checkboxes_field = array{
 ...
 * }
 */
final class MarketingFormsMultipleCheckboxesField implements BaseModel
{
    /** @use SdkModel<marketing_forms_multiple_checkboxes_field> */
    use SdkModel;
    ...
    /**
     * `new MarketingFormsMultipleCheckboxesField()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingFormsMultipleCheckboxesField::with(
     *   defaultValues: ...,
     *   dependentFields: ...,
     *   fieldType: ...,
     *   hidden: ...,
     ...
     *
     * ```
     * (new MarketingFormsMultipleCheckboxesField)
     *   ->withDefaultValues(...)
     *   ->withDependentFields(...)
     *   ->withFieldType(...)
     *   ->withHidden(...)
