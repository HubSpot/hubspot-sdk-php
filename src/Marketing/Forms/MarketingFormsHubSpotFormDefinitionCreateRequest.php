...
use HubspotSDK\Marketing\Forms\MarketingFormsHubSpotFormDefinitionCreateRequest\FormType;

/**
 * @phpstan-type marketing_forms_hub_spot_form_definition_create_request = array{
 *   archived: bool,
 ...
 * }
 */
final class MarketingFormsHubSpotFormDefinitionCreateRequest implements BaseModel
{
    /** @use SdkModel<marketing_forms_hub_spot_form_definition_create_request> */
    use SdkModel;
    ...
    /**
     * `new MarketingFormsHubSpotFormDefinitionCreateRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingFormsHubSpotFormDefinitionCreateRequest::with(
     *   archived: ...,
     *   configuration: ...,
     *   createdAt: ...,
     *   displayOptions: ...,
     ...
     *
     * ```
     * (new MarketingFormsHubSpotFormDefinitionCreateRequest)
     *   ->withArchived(...)
     *   ->withConfiguration(...)
     *   ->withCreatedAt(...)
     *   ->withDisplayOptions(...)
