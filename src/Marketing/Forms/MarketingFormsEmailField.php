...
use HubspotSDK\Marketing\Forms\MarketingFormsEmailField\FieldType;

/**
 * @phpstan-type marketing_forms_email_field = array{
 ...
 * }
 */
final class MarketingFormsEmailField implements BaseModel
{
    /** @use SdkModel<marketing_forms_email_field> */
    use SdkModel;
    ...
    #[Api]
    public MarketingFormsEmailFieldValidation $validation;
    ...
    /**
     * `new MarketingFormsEmailField()` is missing required properties by the API.
     *
    ...
    public static function with(
        ...
        string $objectTypeID,
        bool $required,
        MarketingFormsEmailFieldValidation $validation,
