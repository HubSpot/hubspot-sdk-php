...
use HubspotSDK\Marketing\Forms\MarketingFormsFormStyle\SubmitAlignment;

/**
 * @phpstan-type marketing_forms_form_style = array{
 ...
 * }
 */
final class MarketingFormsFormStyle implements BaseModel
{
    /** @use SdkModel<marketing_forms_form_style> */
    use SdkModel;
    ...
    /**
     * `new MarketingFormsFormStyle()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingFormsFormStyle::with(
     *   backgroundWidth: ...,
     *   fontFamily: ...,
     *   helpTextColor: ...,
     *   helpTextSize: ...,
