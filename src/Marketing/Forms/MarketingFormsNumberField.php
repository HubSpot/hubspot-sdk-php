...
use HubspotSDK\Marketing\Forms\MarketingFormsNumberField\FieldType;

/**
 * @phpstan-type marketing_forms_number_field = array{
 ...
 * }
 */
final class MarketingFormsNumberField implements BaseModel
{
    /** @use SdkModel<marketing_forms_number_field> */
    use SdkModel;
    ...
    #[Api(optional: true)]
    public ?MarketingFormsNumberFieldValidation $validation;

    /**
     * `new MarketingFormsNumberField()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingFormsNumberField::with(
     *   dependentFields: ...,
     *   fieldType: ...,
     *   hidden: ...,
     *   label: ...,
    ...
    public static function with(
        ...
        ?MarketingFormsNumberFieldValidation $validation = null,
    ): self {
        $obj = new self;
    ...
    public function withValidation(
        MarketingFormsNumberFieldValidation $validation
    ): self {
        $obj = clone $this;
