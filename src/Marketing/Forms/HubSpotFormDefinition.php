...
/**
 * @phpstan-type HubSpotFormDefinitionShape = array{
 *   id: string,
 *   archived: bool,
...
final class HubSpotFormDefinition implements BaseModel, ResponseConverter
{
    ...
    /**
     * `new HubSpotFormDefinition()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * HubSpotFormDefinition::with(
     *   id: ...,
     *   archived: ...,
     *   configuration: ...,
     *   createdAt: ...,
