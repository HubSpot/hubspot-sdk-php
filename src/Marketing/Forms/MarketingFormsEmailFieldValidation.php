...
/**
 * @phpstan-type marketing_forms_email_field_validation = array{
 *   blockedEmailDomains: list<string>, useDefaultBlockList: bool
 * }
 */
final class MarketingFormsEmailFieldValidation implements BaseModel
{
    /** @use SdkModel<marketing_forms_email_field_validation> */
    use SdkModel;
    ...
    /**
     * `new MarketingFormsEmailFieldValidation()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingFormsEmailFieldValidation::with(
     *   blockedEmailDomains: ..., useDefaultBlockList: ...
     * )
     * ```
     *
     ...
     *
     * ```
     * (new MarketingFormsEmailFieldValidation)
