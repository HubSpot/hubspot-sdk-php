...
/**
 * @phpstan-type marketing_forms_phone_field_validation = array{
 *   maxAllowedDigits: int, minAllowedDigits: int
 * }
 */
final class MarketingFormsPhoneFieldValidation implements BaseModel
{
    /** @use SdkModel<marketing_forms_phone_field_validation> */
    use SdkModel;
    ...
    /**
     * `new MarketingFormsPhoneFieldValidation()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingFormsPhoneFieldValidation::with(
     ...
     *
     * ```
     * (new MarketingFormsPhoneFieldValidation)
