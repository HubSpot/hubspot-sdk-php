...
use HubspotSDK\Marketing\Forms\MarketingFormsLegalConsentOptionsLegitimateInterest\LawfulBasis;
use HubspotSDK\Marketing\Forms\MarketingFormsLegalConsentOptionsLegitimateInterest\Type;

/**
 * @phpstan-type marketing_forms_legal_consent_options_legitimate_interest = array{
 ...
 * }
 */
final class MarketingFormsLegalConsentOptionsLegitimateInterest implements BaseModel
{
    /** @use SdkModel<marketing_forms_legal_consent_options_legitimate_interest> */
    use SdkModel;
    ...
    /**
     * `new MarketingFormsLegalConsentOptionsLegitimateInterest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingFormsLegalConsentOptionsLegitimateInterest::with(
     ...
     *
     * ```
     * (new MarketingFormsLegalConsentOptionsLegitimateInterest)
     *   ->withLawfulBasis(...)
     *   ->withPrivacyText(...)
