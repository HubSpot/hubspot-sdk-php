...
use HubspotSDK\Marketing\Forms\PhoneField\FieldType;
...
final class PhoneField implements BaseModel
{
     ...
     */
    #[Api]
    public PhoneFieldValidation $validation;
    ...
    /**
     * `new PhoneField()` is missing required properties by the API.
     *
     ...
     * Describes how a phone number should be validated.
     */
    public function withValidation(PhoneFieldValidation $validation): self
    {
        $obj = clone $this;
        $obj->validation = $validation;
