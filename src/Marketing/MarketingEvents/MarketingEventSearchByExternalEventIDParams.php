 ...
 *
 * @see HubspotSDK\Marketing\MarketingEvents->searchByExternalEventID
 *
 * @phpstan-type marketing_event_search_by_external_event_id_params = array{
 *   q: string
 * }
 */
final class MarketingEventSearchByExternalEventIDParams implements BaseModel
{
    /** @use SdkModel<marketing_event_search_by_external_event_id_params> */
    use SdkModel;
    use SdkParams;
