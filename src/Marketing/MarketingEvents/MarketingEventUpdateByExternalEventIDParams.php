 ...
 *
 * @see HubspotSDK\Marketing\MarketingEvents->updateByExternalEventID
 *
 * @phpstan-type marketing_event_update_by_external_event_id_params = array{
 ...
 * }
 */
final class MarketingEventUpdateByExternalEventIDParams implements BaseModel
{
    /** @use SdkModel<marketing_event_update_by_external_event_id_params> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new MarketingEventUpdateByExternalEventIDParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingEventUpdateByExternalEventIDParams::with(externalAccountID: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new MarketingEventUpdateByExternalEventIDParams)->withExternalAccountID(...)
     * ```
     */
