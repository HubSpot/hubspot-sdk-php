 ...
 *
 * @see HubspotSDK\Marketing\MarketingEvents->deleteBatch
 *
 * @phpstan-type marketing_event_delete_batch_params = array{
 *   inputs: list<MarketingEventPublicObjectIDDeleteRequest>
 * }
 */
final class MarketingEventDeleteBatchParams implements BaseModel
{
    /** @use SdkModel<marketing_event_delete_batch_params> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new MarketingEventDeleteBatchParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingEventDeleteBatchParams::with(inputs: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new MarketingEventDeleteBatchParams)->withInputs(...)
     * ```
     */
