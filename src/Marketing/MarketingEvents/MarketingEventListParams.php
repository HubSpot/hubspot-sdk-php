 ...
 *
 * @see HubspotSDK\Marketing\MarketingEvents->list
 *
 * @phpstan-type marketing_event_list_params = array{after?: string, limit?: int}
 */
final class MarketingEventListParams implements BaseModel
{
    /** @use SdkModel<marketing_event_list_params> */
    use SdkModel;
    use SdkParams;
