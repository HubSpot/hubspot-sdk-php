 ...
 *
 * @see HubSpotSDK\Services\Marketing\MarketingEventsService::create()
 *
 * @phpstan-import-type PropertyValueShape from \HubSpotSDK\PropertyValue
 *
 * @phpstan-type MarketingEventCreateParamsShape = array{
 ...
 * }
 */
final class MarketingEventCreateParams implements BaseModel
{
    /** @use SdkModel<MarketingEventCreateParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new MarketingEventCreateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingEventCreateParams::with(
     *   customProperties: ...,
     *   eventName: ...,
     *   eventOrganizer: ...,
     *   externalAccountID: ...,
     ...
     *
     * ```
     * (new MarketingEventCreateParams)
