 ...
 *
 * @see HubspotSDK\Marketing\MarketingEvents->upsertSubscriberStateByID
 *
 * @phpstan-type marketing_event_upsert_subscriber_state_by_id_params = array{
 *   externalEventID: string,
 *   externalAccountID: string,
 *   inputs: list<MarketingEventSubscriber>,
 * }
 */
final class MarketingEventUpsertSubscriberStateByIDParams implements BaseModel
{
    /** @use SdkModel<marketing_event_upsert_subscriber_state_by_id_params> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new MarketingEventUpsertSubscriberStateByIDParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MarketingEventUpsertSubscriberStateByIDParams::with(
     ...
     *
     * ```
     * (new MarketingEventUpsertSubscriberStateByIDParams)
     *   ->withExternalEventID(...)
