 ...
 *
 * @see HubspotSDK\Marketing\MarketingEvents->upsertByExternalEventID
 *
 * @phpstan-type marketing_event_upsert_by_external_event_id_params = array{
 *   eventName: string,
...
{
    /** @use SdkModel<marketing_event_upsert_by_external_event_id_params> */
    use SdkModel;
    use SdkParams;
