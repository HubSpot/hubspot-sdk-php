...
/**
 * @phpstan-type batch_response_public_campaign_with_errors = array{
...
{
    /** @use SdkModel<batch_response_public_campaign_with_errors> */
    use SdkModel;
     ...
     *
     * @param list<PublicCampaign> $results
