...
final class PublicBudgetItemInput implements BaseModel
{
    ...
    /**
     * `new PublicBudgetItemInput()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * PublicBudgetItemInput::with(amount: ..., name: ..., order: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new PublicBudgetItemInput)->withAmount(...)->withName(...)->withOrder(...)
     * ```
     */
