 ...
 * }
 */
final class ExchangeRateCreateExchangeRateParams implements BaseModel
{
    /** @use SdkModel<ExchangeRateCreateExchangeRateParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new ExchangeRateCreateExchangeRateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ExchangeRateCreateExchangeRateParams::with(
     ...
     *
     * ```
     * (new ExchangeRateCreateExchangeRateParams)
     *   ->withConversionRate(...)
