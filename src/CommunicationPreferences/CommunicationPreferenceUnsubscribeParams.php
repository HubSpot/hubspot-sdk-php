...
use HubspotSDK\CommunicationPreferences\CommunicationPreferenceUnsubscribeParams\LegalBasis;
 ...
 *
 * @see HubspotSDK\Services\CommunicationPreferencesService::unsubscribe()
 *
 * @phpstan-type CommunicationPreferenceUnsubscribeParamsShape = array{
 *   emailAddress: string,
 ...
 * }
 */
final class CommunicationPreferenceUnsubscribeParams implements BaseModel
{
    /** @use SdkModel<CommunicationPreferenceUnsubscribeParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new CommunicationPreferenceUnsubscribeParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CommunicationPreferenceUnsubscribeParams::with(
     ...
     *
     * ```
     * (new CommunicationPreferenceUnsubscribeParams)
     *   ->withEmailAddress(...)
     *   ->withSubscriptionID(...)
     * ```
     */
