...
use HubspotSDK\CommunicationPreferences\BatchResponsePublicStatusBulkResponse\Status;
...
final class BatchResponsePublicStatusBulkResponse implements BaseModel
{
    ...
    /**
     * An array of errors encountered during the batch operation, each represented by a StandardError object.
     *
    ...
    /**
     * The number of errors encountered during the batch operation, represented as an integer.
     */
    #[Optional]
