...
use HubSpotSDK\CommunicationPreferences\BatchResponsePublicStatusBulkResponseWithErrors\Status;
...
/**
 * @phpstan-import-type PublicStatusBulkResponseShape from \HubSpotSDK\CommunicationPreferences\PublicStatusBulkResponse
 ...
 * }
 */
final class BatchResponsePublicStatusBulkResponseWithErrors implements BaseModel
{
    /** @use SdkModel<BatchResponsePublicStatusBulkResponseWithErrorsShape> */
    use SdkModel;
    ...
    /**
     * `new BatchResponsePublicStatusBulkResponseWithErrors()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BatchResponsePublicStatusBulkResponseWithErrors::with(
     ...
     *
     * ```
     * (new BatchResponsePublicStatusBulkResponseWithErrors)
     *   ->withCompletedAt(...)
     *   ->withResults(...)
     *   ->withStartedAt(...)
     *   ->withStatus(...)
