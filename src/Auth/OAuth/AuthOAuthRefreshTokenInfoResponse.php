...
final class AuthOAuthRefreshTokenInfoResponse implements BaseModel, ResponseConverter
{
    ...
    /**
     * `new AuthOAuthRefreshTokenInfoResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AuthOAuthRefreshTokenInfoResponse::with(
     *   token: ...,
     *   clientID: ...,
     *   hubID: ...,
     *   scopes: ...,
     ...
     *
     * ```
     * (new AuthOAuthRefreshTokenInfoResponse)
     *   ->withToken(...)
     *   ->withClientID(...)
     *   ->withHubID(...)
     *   ->withScopes(...)
