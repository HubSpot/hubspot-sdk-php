...
/**
 * @phpstan-type auth_oauth_access_token_info_response = array{
 *   token: string,
 *   appID: int,
 *   expiresIn: int,
 *   hubID: int,
 ...
 * }
 */
final class AuthOAuthAccessTokenInfoResponse implements BaseModel
{
    /** @use SdkModel<auth_oauth_access_token_info_response> */
    use SdkModel;
    ...
    /**
     * `new AuthOAuthAccessTokenInfoResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AuthOAuthAccessTokenInfoResponse::with(
     *   token: ...,
     *   appID: ...,
     *   expiresIn: ...,
     *   hubID: ...,
     ...
     *
     * ```
     * (new AuthOAuthAccessTokenInfoResponse)
     *   ->withToken(...)
     *   ->withAppID(...)
     *   ->withExpiresIn(...)
     *   ->withHubID(...)
