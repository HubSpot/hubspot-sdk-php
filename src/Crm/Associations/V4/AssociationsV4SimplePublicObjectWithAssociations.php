...
use HubspotSDK\Crm\CollectionResponseAssociatedID;
 ...
 *
 * @phpstan-type AssociationsV4SimplePublicObjectWithAssociationsShape = array{
 *   id: string,
 *   archived: bool,
...
{
    /** @use SdkModel<AssociationsV4SimplePublicObjectWithAssociationsShape> */
    use SdkModel;
    ...
    /**
     * `new AssociationsV4SimplePublicObjectWithAssociations()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AssociationsV4SimplePublicObjectWithAssociations::with(
     ...
     *
     * ```
     * (new AssociationsV4SimplePublicObjectWithAssociations)
     *   ->withID(...)
     *   ->withArchived(...)
     *   ->withCreatedAt(...)
     *   ->withProperties(...)
