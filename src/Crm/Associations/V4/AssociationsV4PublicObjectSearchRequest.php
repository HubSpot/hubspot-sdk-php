 ...
 *
 * @phpstan-type AssociationsV4PublicObjectSearchRequestShape = array{
 *   after: string,
...
{
    /** @use SdkModel<AssociationsV4PublicObjectSearchRequestShape> */
    use SdkModel;
    ...
    /**
     * `new AssociationsV4PublicObjectSearchRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AssociationsV4PublicObjectSearchRequest::with(
     ...
     *
     * ```
     * (new AssociationsV4PublicObjectSearchRequest)
     *   ->withAfter(...)
     *   ->withFilterGroups(...)
     *   ->withLimit(...)
     *   ->withProperties(...)
