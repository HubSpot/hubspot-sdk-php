 ...
 *
 * @phpstan-type AssociationsV4SimplePublicObjectShape = array{
 *   id: string,
 *   archived: bool,
 ...
 * }
 */
final class AssociationsV4SimplePublicObject implements BaseModel
{
    /** @use SdkModel<AssociationsV4SimplePublicObjectShape> */
    use SdkModel;
    ...
    /**
     * `new AssociationsV4SimplePublicObject()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AssociationsV4SimplePublicObject::with(
     ...
     *
     * ```
     * (new AssociationsV4SimplePublicObject)
     *   ->withID(...)
     *   ->withArchived(...)
     *   ->withCreatedAt(...)
     *   ->withProperties(...)
