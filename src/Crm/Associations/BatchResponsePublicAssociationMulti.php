...
/**
 * @phpstan-import-type PublicAssociationMultiShape from \HubspotSDK\Crm\Associations\PublicAssociationMulti
 * @phpstan-import-type StandardErrorShape from \HubspotSDK\StandardError
 *
 * @phpstan-type BatchResponsePublicAssociationMultiShape = array{
 *   completedAt: \DateTimeInterface,
 *   results: list<PublicAssociationMulti|PublicAssociationMultiShape>,
...
final class BatchResponsePublicAssociationMulti implements BaseModel
{
    ...
    #[Required(list: PublicAssociationMulti::class)]
     ...
     *
     * @param list<PublicAssociationMulti|PublicAssociationMultiShape> $results
