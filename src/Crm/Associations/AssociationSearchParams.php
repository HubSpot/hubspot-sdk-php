 ...
 * }
 */
final class AssociationSearchParams implements BaseModel
{
    /** @use SdkModel<AssociationSearchParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new AssociationSearchParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AssociationSearchParams::with(
