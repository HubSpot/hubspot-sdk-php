 ...
 *
 * @see HubSpotSDK\Services\Crm\AssociationsService::updateLabels()
 *
 * @phpstan-import-type AssociationSpecShape from \HubSpotSDK\AssociationSpec
 *
 * @phpstan-type AssociationUpdateLabelsParamsShape = array{
 *   objectType: string,
 *   objectID: string,
 *   toObjectType: string,
 ...
 * }
 */
final class AssociationUpdateLabelsParams implements BaseModel
{
    /** @use SdkModel<AssociationUpdateLabelsParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new AssociationUpdateLabelsParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AssociationUpdateLabelsParams::with(
     ...
     *
     * ```
     * (new AssociationUpdateLabelsParams)
     *   ->withObjectType(...)
     *   ->withObjectID(...)
     *   ->withToObjectType(...)
     *   ->withBody(...)
