 ...
 *
 * @phpstan-type FeatureFlagDeleteParamsShape = array{appID: int, flagName: string}
 */
final class FeatureFlagDeleteParams implements BaseModel
{
     ...
     * ```
     * FeatureFlagDeleteParams::with(appID: ..., flagName: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new FeatureFlagDeleteParams)->withAppID(...)->withFlagName(...)
     * ```
     */
