 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\ProductsService::upsert()
 *
 ...
 *
 * @phpstan-type ProductUpsertParamsShape = array{
 *   inputs: list<SimplePublicObjectBatchInputUpsert|SimplePublicObjectBatchInputUpsertShape>,
 * }
 */
final class ProductUpsertParams implements BaseModel
{
    /** @use SdkModel<ProductUpsertParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new ProductUpsertParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ProductUpsertParams::with(inputs: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ProductUpsertParams)->withInputs(...)
     * ```
     */
