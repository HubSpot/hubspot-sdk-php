 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\InvoicesService::upsert()
 *
 ...
 *
 * @phpstan-type InvoiceUpsertParamsShape = array{
 *   inputs: list<SimplePublicObjectBatchInputUpsert|SimplePublicObjectBatchInputUpsertShape>,
 * }
 */
final class InvoiceUpsertParams implements BaseModel
{
    /** @use SdkModel<InvoiceUpsertParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new InvoiceUpsertParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * InvoiceUpsertParams::with(inputs: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new InvoiceUpsertParams)->withInputs(...)
     * ```
     */
