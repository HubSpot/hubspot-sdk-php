 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\InvoicesService::get()
 *
...
final class InvoiceGetParams implements BaseModel
{
    ...
    /**
     * `new InvoiceGetParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * InvoiceGetParams::with(inputs: ..., properties: ..., propertiesWithHistory: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new InvoiceGetParams)
     *   ->withInputs(...)
     *   ->withProperties(...)
