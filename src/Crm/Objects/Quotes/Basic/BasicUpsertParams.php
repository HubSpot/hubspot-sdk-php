 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\Quotes\BasicService::upsert()
 *
 ...
 *
 * @phpstan-type BasicUpsertParamsShape = array{
 *   inputs: list<SimplePublicObjectBatchInputUpsert|SimplePublicObjectBatchInputUpsertShape>,
 * }
 */
final class BasicUpsertParams implements BaseModel
{
    /** @use SdkModel<BasicUpsertParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new BasicUpsertParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BasicUpsertParams::with(inputs: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new BasicUpsertParams)->withInputs(...)
     * ```
     */
