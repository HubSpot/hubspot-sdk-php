 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\Quotes\BasicService::get()
 *
 * @phpstan-import-type SimplePublicObjectIDShape from \HubspotSDK\Crm\Objects\SimplePublicObjectID
 *
 * @phpstan-type BasicGetParamsShape = array{
 ...
 * }
 */
final class BasicGetParams implements BaseModel
{
    /** @use SdkModel<BasicGetParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new BasicGetParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BasicGetParams::with(inputs: ..., properties: ..., propertiesWithHistory: ...)
     * ```
     *
