 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\QuotesService::update()
 *
...
final class QuoteUpdateParams implements BaseModel
{
    ...
    /**
     * `new QuoteUpdateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * QuoteUpdateParams::with(properties: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new QuoteUpdateParams)->withProperties(...)
     * ```
     */
