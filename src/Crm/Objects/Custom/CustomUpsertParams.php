 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\CustomService::upsert()
 *
 ...
 *
 * @phpstan-type CustomUpsertParamsShape = array{
 *   inputs: list<SimplePublicObjectBatchInputUpsert|SimplePublicObjectBatchInputUpsertShape>,
 * }
 */
final class CustomUpsertParams implements BaseModel
{
    /** @use SdkModel<CustomUpsertParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new CustomUpsertParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CustomUpsertParams::with(inputs: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new CustomUpsertParams)->withInputs(...)
     * ```
     */
