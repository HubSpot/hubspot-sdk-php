 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\SubscriptionsService::search()
 *
 * @phpstan-import-type FilterGroupShape from \HubspotSDK\Crm\FilterGroup
 *
 * @phpstan-type SubscriptionSearchParamsShape = array{
 *   after: string,
 ...
 * }
 */
final class SubscriptionSearchParams implements BaseModel
{
    /** @use SdkModel<SubscriptionSearchParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new SubscriptionSearchParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SubscriptionSearchParams::with(
