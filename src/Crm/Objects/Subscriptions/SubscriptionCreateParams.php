 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\SubscriptionsService::create()
 *
...
final class SubscriptionCreateParams implements BaseModel
{
     ...
     * ```
     * SubscriptionCreateParams::with(associations: ..., properties: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new SubscriptionCreateParams)->withAssociations(...)->withProperties(...)
     * ```
     */
