 ...
 * }
 */
final class BatchResponseSimplePublicUpsertObjectWithErrors implements BaseModel
{
    /** @use SdkModel<BatchResponseSimplePublicUpsertObjectWithErrorsShape> */
    use SdkModel;
    ...
    /**
     * `new BatchResponseSimplePublicUpsertObjectWithErrors()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BatchResponseSimplePublicUpsertObjectWithErrors::with(
     ...
     *
     * ```
     * (new BatchResponseSimplePublicUpsertObjectWithErrors)
     *   ->withCompletedAt(...)
     *   ->withResults(...)
     *   ->withStartedAt(...)
     *   ->withStatus(...)
