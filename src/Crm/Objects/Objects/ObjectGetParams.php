 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\ObjectsService::get()
 *
...
{
    /** @use SdkModel<ObjectGetParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new ObjectGetParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ObjectGetParams::with(objectType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ObjectGetParams)->withObjectType(...)
     * ```
     */
