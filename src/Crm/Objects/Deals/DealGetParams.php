 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\DealsService::get()
 *
 * @phpstan-type DealGetParamsShape = array{
 *   archived?: bool|null,
 ...
 * }
 */
final class DealGetParams implements BaseModel
{
    /** @use SdkModel<DealGetParamsShape> */
    use SdkModel;
    use SdkParams;
