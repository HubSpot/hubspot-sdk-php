 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\DealsService::search()
 *
...
final class DealSearchParams implements BaseModel
{
    ...
    /**
     * `new DealSearchParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * DealSearchParams::with(
