 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\ListingsService::get()
 *
 * @phpstan-import-type SimplePublicObjectIDShape from \HubspotSDK\Crm\Objects\SimplePublicObjectID
 *
 * @phpstan-type ListingGetParamsShape = array{
 ...
 * }
 */
final class ListingGetParams implements BaseModel
{
    /** @use SdkModel<ListingGetParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new ListingGetParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ListingGetParams::with(inputs: ..., properties: ..., propertiesWithHistory: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ListingGetParams)
     *   ->withInputs(...)
     *   ->withProperties(...)
