 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\ListingsService::upsert()
 *
 ...
 *
 * @phpstan-type ListingUpsertParamsShape = array{
 *   inputs: list<SimplePublicObjectBatchInputUpsert|SimplePublicObjectBatchInputUpsertShape>,
 * }
 */
final class ListingUpsertParams implements BaseModel
{
    /** @use SdkModel<ListingUpsertParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new ListingUpsertParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ListingUpsertParams::with(inputs: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ListingUpsertParams)->withInputs(...)
     * ```
     */
