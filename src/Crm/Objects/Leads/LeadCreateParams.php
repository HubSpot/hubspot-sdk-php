...
final class LeadCreateParams implements BaseModel
{
    ...
    /**
     * `new LeadCreateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * LeadCreateParams::with(associations: ..., properties: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new LeadCreateParams)->withAssociations(...)->withProperties(...)
     * ```
     */
