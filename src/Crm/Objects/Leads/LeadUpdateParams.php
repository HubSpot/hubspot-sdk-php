 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\LeadsService::update()
 *
...
final class LeadUpdateParams implements BaseModel
{
    ...
    /**
     * `new LeadUpdateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * LeadUpdateParams::with(properties: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new LeadUpdateParams)->withProperties(...)
     * ```
     */
