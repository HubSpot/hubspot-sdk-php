 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\LeadsService::get()
 *
 * @phpstan-type LeadGetParamsShape = array{
 *   archived?: bool,
 ...
 * }
 */
final class LeadGetParams implements BaseModel
{
    /** @use SdkModel<LeadGetParamsShape> */
    use SdkModel;
    use SdkParams;
