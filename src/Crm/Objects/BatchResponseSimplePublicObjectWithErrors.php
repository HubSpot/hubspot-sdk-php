 ...
 * }
 */
final class BatchResponseSimplePublicObjectWithErrors implements BaseModel
{
    /** @use SdkModel<BatchResponseSimplePublicObjectWithErrorsShape> */
    use SdkModel;
    ...
    /**
     * `new BatchResponseSimplePublicObjectWithErrors()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BatchResponseSimplePublicObjectWithErrors::with(
     ...
     *
     * ```
     * (new BatchResponseSimplePublicObjectWithErrors)
     *   ->withCompletedAt(...)
     *   ->withResults(...)
     *   ->withStartedAt(...)
     *   ->withStatus(...)
