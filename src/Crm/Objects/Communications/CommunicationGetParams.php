 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\CommunicationsService::get()
 *
 * @phpstan-type CommunicationGetParamsShape = array{
 *   archived?: bool|null,
 ...
 * }
 */
final class CommunicationGetParams implements BaseModel
{
    /** @use SdkModel<CommunicationGetParamsShape> */
    use SdkModel;
    use SdkParams;
