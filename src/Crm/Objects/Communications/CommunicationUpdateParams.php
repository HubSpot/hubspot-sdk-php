...
final class CommunicationUpdateParams implements BaseModel
{
    ...
    /**
     * `new CommunicationUpdateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CommunicationUpdateParams::with(properties: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new CommunicationUpdateParams)->withProperties(...)
     * ```
     */
