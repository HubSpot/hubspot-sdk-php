 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\TaxesService::upsert()
 *
 ...
 *
 * @phpstan-type TaxUpsertParamsShape = array{
 *   inputs: list<SimplePublicObjectBatchInputUpsert|SimplePublicObjectBatchInputUpsertShape>,
 * }
 */
final class TaxUpsertParams implements BaseModel
{
    /** @use SdkModel<TaxUpsertParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new TaxUpsertParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TaxUpsertParams::with(inputs: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new TaxUpsertParams)->withInputs(...)
     * ```
     */
