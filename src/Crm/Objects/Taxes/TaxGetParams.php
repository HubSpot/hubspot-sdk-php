 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\TaxesService::get()
 *
...
final class TaxGetParams implements BaseModel
{
    ...
    /**
     * `new TaxGetParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TaxGetParams::with(inputs: ..., properties: ..., propertiesWithHistory: ...)
     * ```
     *
