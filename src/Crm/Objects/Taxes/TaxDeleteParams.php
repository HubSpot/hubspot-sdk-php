 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\TaxesService::delete()
 *
 * @phpstan-import-type SimplePublicObjectIDShape from \HubspotSDK\Crm\Objects\SimplePublicObjectID
 *
 * @phpstan-type TaxDeleteParamsShape = array{
 *   inputs: list<SimplePublicObjectID|SimplePublicObjectIDShape>
 * }
 */
final class TaxDeleteParams implements BaseModel
{
    /** @use SdkModel<TaxDeleteParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new TaxDeleteParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TaxDeleteParams::with(inputs: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new TaxDeleteParams)->withInputs(...)
     * ```
     */
