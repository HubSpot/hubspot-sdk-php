 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\UsersService::get()
 *
...
final class UserGetParams implements BaseModel
{
    ...
    /**
     * `new UserGetParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * UserGetParams::with(inputs: ..., properties: ..., propertiesWithHistory: ...)
     * ```
     *
