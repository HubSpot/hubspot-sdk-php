 ...
 *
 * @see HubSpotSDK\Services\Crm\Objects\ContractsService::update()
 *
...
final class ContractUpdateParams implements BaseModel
{
    ...
    /**
     * `new ContractUpdateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ContractUpdateParams::with(properties: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ContractUpdateParams)->withProperties(...)
     * ```
     */
