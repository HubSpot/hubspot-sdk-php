 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\ContractsService::create()
 *
...
final class ContractCreateParams implements BaseModel
{
    ...
    /**
     * `new ContractCreateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ContractCreateParams::with(associations: ..., properties: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ContractCreateParams)->withAssociations(...)->withProperties(...)
     * ```
     */
