 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\FeesService::update()
 *
...
final class FeeUpdateParams implements BaseModel
{
    ...
    /**
     * `new FeeUpdateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * FeeUpdateParams::with(properties: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new FeeUpdateParams)->withProperties(...)
     * ```
     */
