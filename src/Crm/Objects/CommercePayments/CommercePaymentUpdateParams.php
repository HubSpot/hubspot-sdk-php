 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\CommercePaymentsService::update()
 *
...
final class CommercePaymentUpdateParams implements BaseModel
{
    ...
    /**
     * `new CommercePaymentUpdateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CommercePaymentUpdateParams::with(properties: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new CommercePaymentUpdateParams)->withProperties(...)
     * ```
     */
