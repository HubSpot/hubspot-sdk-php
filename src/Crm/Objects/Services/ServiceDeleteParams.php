 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\ServicesService::delete()
 *
 * @phpstan-import-type SimplePublicObjectIDShape from \HubspotSDK\Crm\Objects\SimplePublicObjectID
 *
 * @phpstan-type ServiceDeleteParamsShape = array{
 *   inputs: list<SimplePublicObjectID|SimplePublicObjectIDShape>
 * }
 */
final class ServiceDeleteParams implements BaseModel
{
    /** @use SdkModel<ServiceDeleteParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new ServiceDeleteParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ServiceDeleteParams::with(inputs: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ServiceDeleteParams)->withInputs(...)
     * ```
     */
