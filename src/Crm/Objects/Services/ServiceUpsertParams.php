 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\ServicesService::upsert()
 *
 ...
 *
 * @phpstan-type ServiceUpsertParamsShape = array{
 *   inputs: list<SimplePublicObjectBatchInputUpsert|SimplePublicObjectBatchInputUpsertShape>,
 * }
 */
final class ServiceUpsertParams implements BaseModel
{
    /** @use SdkModel<ServiceUpsertParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new ServiceUpsertParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ServiceUpsertParams::with(inputs: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ServiceUpsertParams)->withInputs(...)
     * ```
     */
