 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\GenericObjectsService::create()
 *
 * @phpstan-import-type PublicAssociationsForObjectShape from \HubspotSDK\Crm\Objects\PublicAssociationsForObject
 *
 * @phpstan-type GenericObjectCreateParamsShape = array{
 *   associations: list<PublicAssociationsForObject|PublicAssociationsForObjectShape>,
 *   properties: array<string,string>,
 * }
 */
final class GenericObjectCreateParams implements BaseModel
{
    /** @use SdkModel<GenericObjectCreateParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new GenericObjectCreateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * GenericObjectCreateParams::with(associations: ..., properties: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new GenericObjectCreateParams)->withAssociations(...)->withProperties(...)
     * ```
     */
