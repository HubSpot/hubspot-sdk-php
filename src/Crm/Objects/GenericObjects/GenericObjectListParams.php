 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\GenericObjectsService::list()
 *
 * @phpstan-type GenericObjectListParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class GenericObjectListParams implements BaseModel
{
    /** @use SdkModel<GenericObjectListParamsShape> */
    use SdkModel;
    use SdkParams;
