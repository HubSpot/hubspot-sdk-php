...
/**
 * @see HubSpotSDK\Services\Crm\Objects\GenericObjectsService::search()
 *
 * @phpstan-import-type FilterGroupShape from \HubSpotSDK\Crm\FilterGroup
 *
 * @phpstan-type GenericObjectSearchParamsShape = array{
 *   after: string,
 ...
 * }
 */
final class GenericObjectSearchParams implements BaseModel
{
    /** @use SdkModel<GenericObjectSearchParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new GenericObjectSearchParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * GenericObjectSearchParams::with(
