 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\GenericObjectsService::get()
 *
 * @phpstan-type GenericObjectGetParamsShape = array{
 *   objectType: string,
 *   archived?: bool|null,
 ...
 * }
 */
final class GenericObjectGetParams implements BaseModel
{
    /** @use SdkModel<GenericObjectGetParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new GenericObjectGetParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * GenericObjectGetParams::with(objectType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new GenericObjectGetParams)->withObjectType(...)
     * ```
     */
