...
final class LineItemCreateParams implements BaseModel
{
    ...
    /**
     * `new LineItemCreateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * LineItemCreateParams::with(associations: ..., properties: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new LineItemCreateParams)->withAssociations(...)->withProperties(...)
     * ```
     */
