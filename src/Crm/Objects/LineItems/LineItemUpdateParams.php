 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\LineItemsService::update()
 *
...
final class LineItemUpdateParams implements BaseModel
{
    ...
    /**
     * `new LineItemUpdateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * LineItemUpdateParams::with(properties: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new LineItemUpdateParams)->withProperties(...)
     * ```
     */
