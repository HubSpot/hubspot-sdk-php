 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\TasksService::update()
 *
...
final class TaskUpdateParams implements BaseModel
{
    ...
    /**
     * `new TaskUpdateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TaskUpdateParams::with(properties: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new TaskUpdateParams)->withProperties(...)
     * ```
     */
