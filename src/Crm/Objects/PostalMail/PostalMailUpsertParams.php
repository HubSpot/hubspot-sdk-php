 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\PostalMailService::upsert()
 *
 ...
 *
 * @phpstan-type PostalMailUpsertParamsShape = array{
 *   inputs: list<SimplePublicObjectBatchInputUpsert|SimplePublicObjectBatchInputUpsertShape>,
 * }
 */
final class PostalMailUpsertParams implements BaseModel
{
    /** @use SdkModel<PostalMailUpsertParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new PostalMailUpsertParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * PostalMailUpsertParams::with(inputs: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new PostalMailUpsertParams)->withInputs(...)
     * ```
     */
