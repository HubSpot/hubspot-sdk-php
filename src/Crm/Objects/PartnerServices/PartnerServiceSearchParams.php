 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\PartnerServicesService::search()
 *
 * @phpstan-import-type FilterGroupShape from \HubspotSDK\Crm\FilterGroup
 *
 * @phpstan-type PartnerServiceSearchParamsShape = array{
 *   after: string,
 ...
 * }
 */
final class PartnerServiceSearchParams implements BaseModel
{
    /** @use SdkModel<PartnerServiceSearchParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new PartnerServiceSearchParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * PartnerServiceSearchParams::with(
     ...
     *
     * ```
     * (new PartnerServiceSearchParams)
     *   ->withAfter(...)
     *   ->withFilterGroups(...)
     *   ->withLimit(...)
     *   ->withProperties(...)
