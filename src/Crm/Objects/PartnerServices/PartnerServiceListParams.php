...
final class PartnerServiceListParams implements BaseModel
{
    ...
    /**
     * `new PartnerServiceListParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * PartnerServiceListParams::with(partnerServiceID: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new PartnerServiceListParams)->withPartnerServiceID(...)
     * ```
     */
