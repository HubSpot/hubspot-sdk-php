 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\PartnerServicesService::get()
 *
 * @phpstan-import-type SimplePublicObjectIDShape from \HubspotSDK\Crm\Objects\SimplePublicObjectID
 *
 * @phpstan-type PartnerServiceGetParamsShape = array{
 ...
 * }
 */
final class PartnerServiceGetParams implements BaseModel
{
    /** @use SdkModel<PartnerServiceGetParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new PartnerServiceGetParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * PartnerServiceGetParams::with(
