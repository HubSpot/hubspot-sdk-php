 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\ProjectsService::search()
 *
 * @phpstan-type ProjectSearchParamsShape = array{
 *   after: string,
 ...
 * }
 */
final class ProjectSearchParams implements BaseModel
{
    /** @use SdkModel<ProjectSearchParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new ProjectSearchParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ProjectSearchParams::with(
