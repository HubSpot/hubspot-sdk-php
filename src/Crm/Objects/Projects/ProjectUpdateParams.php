 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\ProjectsService::update()
 *
...
final class ProjectUpdateParams implements BaseModel
{
    ...
    /**
     * `new ProjectUpdateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ProjectUpdateParams::with(properties: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ProjectUpdateParams)->withProperties(...)
     * ```
     */
