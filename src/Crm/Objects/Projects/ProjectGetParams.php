 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\ProjectsService::get()
 *
 * @phpstan-type ProjectGetParamsShape = array{
 *   archived?: bool|null,
 ...
 * }
 */
final class ProjectGetParams implements BaseModel
{
    /** @use SdkModel<ProjectGetParamsShape> */
    use SdkModel;
    use SdkParams;
