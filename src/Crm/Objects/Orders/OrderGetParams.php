 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\OrdersService::get()
 *
...
final class OrderGetParams implements BaseModel
{
    ...
    /**
     * `new OrderGetParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * OrderGetParams::with(inputs: ..., properties: ..., propertiesWithHistory: ...)
     * ```
     *
