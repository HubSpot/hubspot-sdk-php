 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\OrdersService::upsert()
 *
 ...
 *
 * @phpstan-type OrderUpsertParamsShape = array{
 *   inputs: list<SimplePublicObjectBatchInputUpsert|SimplePublicObjectBatchInputUpsertShape>,
 * }
 */
final class OrderUpsertParams implements BaseModel
{
    /** @use SdkModel<OrderUpsertParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new OrderUpsertParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * OrderUpsertParams::with(inputs: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new OrderUpsertParams)->withInputs(...)
     * ```
     */
