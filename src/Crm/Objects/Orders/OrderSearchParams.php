 ...
 *
 * @see HubspotSDK\Services\Crm\Objects\OrdersService::search()
 *
 * @phpstan-type OrderSearchParamsShape = array{
 *   after: string,
 ...
 * }
 */
final class OrderSearchParams implements BaseModel
{
    /** @use SdkModel<OrderSearchParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new OrderSearchParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * OrderSearchParams::with(
