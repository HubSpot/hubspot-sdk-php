...
use HubSpotSDK\Crm\BatchResponsePublicAssociationMultiWithLabelWithErrors\Status;
use HubSpotSDK\StandardError;

/**
 * @phpstan-import-type PublicAssociationMultiWithLabelShape from \HubSpotSDK\Crm\PublicAssociationMultiWithLabel
 ...
 * }
 */
final class BatchResponsePublicAssociationMultiWithLabelWithErrors implements BaseModel
{
    /** @use SdkModel<BatchResponsePublicAssociationMultiWithLabelWithErrorsShape> */
    use SdkModel;
    ...
    /**
     * `new BatchResponsePublicAssociationMultiWithLabelWithErrors()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BatchResponsePublicAssociationMultiWithLabelWithErrors::with(
     ...
     *
     * ```
     * (new BatchResponsePublicAssociationMultiWithLabelWithErrors)
     *   ->withCompletedAt(...)
     *   ->withResults(...)
     *   ->withStartedAt(...)
     *   ->withStatus(...)
