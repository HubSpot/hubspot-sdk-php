...
use HubSpotSDK\Crm\BatchResponseLabelsBetweenObjectPair\Status;
...
final class BatchResponseLabelsBetweenObjectPair implements BaseModel
{
    ...
    /**
     * `new BatchResponseLabelsBetweenObjectPair()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BatchResponseLabelsBetweenObjectPair::with(
     ...
     *
     * ```
     * (new BatchResponseLabelsBetweenObjectPair)
     *   ->withCompletedAt(...)
     *   ->withResults(...)
     *   ->withStartedAt(...)
     *   ->withStatus(...)
