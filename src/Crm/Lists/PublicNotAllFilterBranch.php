...
use HubSpotSDK\Crm\Lists\PublicNotAllFilterBranch\Filter;
use HubSpotSDK\Crm\Lists\PublicNotAllFilterBranch\FilterBranch;
use HubSpotSDK\Crm\Lists\PublicNotAllFilterBranch\FilterBranchType;

/**
 * @phpstan-import-type FilterVariants from \HubSpotSDK\Crm\Lists\PublicNotAllFilterBranch\Filter
 * @phpstan-import-type FilterShape from \HubSpotSDK\Crm\Lists\PublicNotAllFilterBranch\Filter
 *
 * @phpstan-type PublicNotAllFilterBranchShape = array{
 ...
 * }
 */
final class PublicNotAllFilterBranch implements BaseModel
{
    /** @use SdkModel<PublicNotAllFilterBranchShape> */
    use SdkModel;
    ...
    /**
     * `new PublicNotAllFilterBranch()` is missing required properties by the API.
     *
