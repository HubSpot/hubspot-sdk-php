...
/**
 * @see HubspotSDK\Services\Crm\Extensions\CallingService::createInboundCall()
 *
 * @phpstan-import-type FormattedPhoneNumberShape from \HubspotSDK\Crm\Extensions\Calling\FormattedPhoneNumber
 *
 * @phpstan-type CallingCreateInboundCallParamsShape = array{
 ...
 * }
 */
final class CallingCreateInboundCallParams implements BaseModel
{
    /** @use SdkModel<CallingCreateInboundCallParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new CallingCreateInboundCallParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CallingCreateInboundCallParams::with(
     *   createEngagement: ...,
     ...
     *
     * ```
     * (new CallingCreateInboundCallParams)
