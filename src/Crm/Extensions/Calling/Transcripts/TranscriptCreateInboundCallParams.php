...
/**
 * @see HubSpotSDK\Services\Crm\Extensions\Calling\TranscriptsService::createInboundCall()
 *
 * @phpstan-import-type FormattedPhoneNumberShape from \HubSpotSDK\Crm\Extensions\Calling\FormattedPhoneNumber
 *
 * @phpstan-type TranscriptCreateInboundCallParamsShape = array{
 ...
 * }
 */
final class TranscriptCreateInboundCallParams implements BaseModel
{
    /** @use SdkModel<TranscriptCreateInboundCallParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new TranscriptCreateInboundCallParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TranscriptCreateInboundCallParams::with(
     *   createEngagement: ...,
     ...
     *
     * ```
     * (new TranscriptCreateInboundCallParams)
