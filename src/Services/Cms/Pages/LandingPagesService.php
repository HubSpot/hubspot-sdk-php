...
use HubSpotSDK\Services\Cms\Pages\LandingPages\AbTestService;
use HubSpotSDK\Services\Cms\Pages\LandingPages\BatchService;
use HubSpotSDK\Services\Cms\Pages\LandingPages\DraftService;
use HubSpotSDK\Services\Cms\Pages\LandingPages\FoldersService;
use HubSpotSDK\Services\Cms\Pages\LandingPages\MultiLanguageService;
use HubSpotSDK\Services\Cms\Pages\LandingPages\RevisionsService;
...
final class LandingPagesService implements LandingPagesContract
{
    ...
    public function __construct(private Client $client)
    {
        ...
        $this->abTest = new AbTestService($client);
