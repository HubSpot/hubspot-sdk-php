...
final class URLRedirectsService implements URLRedirectsContract
{
    ...
    public function createURLMapping(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->createURLMapping(params: $params, requestOptions: $requestOptions);
    ...
    public function deleteURLMapping(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->deleteURLMapping($id, requestOptions: $requestOptions);
    ...
    public function getURLMapping(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->getURLMapping($id, requestOptions: $requestOptions);
    ...
    public function listURLMappings(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->listURLMappings(requestOptions: $requestOptions);
