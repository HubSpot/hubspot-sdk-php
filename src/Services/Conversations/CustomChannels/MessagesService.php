...
use HubspotSDK\Conversations\CustomChannels\Messages\MessageUpdateStatusParams;
...
final class MessagesService implements MessagesContract
{
    ...
    public function updateStatus(
        ...
        return $this->updateStatusRaw($messageID, $params, $requestOptions);
    }
    ...
    public function updateStatusRaw(
        ...
        [$parsed, $options] = MessageUpdateStatusParams::parseRequest(
            $params,
            $requestOptions
        );
        $channelID = $parsed['channelID'];
