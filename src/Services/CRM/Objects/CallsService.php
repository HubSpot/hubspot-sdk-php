...
final class CallsService implements CallsContract
{
    ...
    public function update(
        ...
        return $this->updateRaw($callID, $params, $requestOptions);
    }
    ...
    public function get(
        ...
        return $this->getRaw($callID, $params, $requestOptions);
    }
    ...
    public function getRaw(
        ...
        [$parsed, $options] = CallGetParams::parseRequest($params, $requestOptions);
