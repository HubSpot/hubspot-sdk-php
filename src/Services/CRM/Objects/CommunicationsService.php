...
use HubspotSDK\CRM\Objects\Communications\CommunicationReadParams;
...
final class CommunicationsService implements CommunicationsContract
{
    ...
    public function update(
        ...
        return $this->updateRaw($communicationID, $params, $requestOptions);
    }
    ...
    public function read(
        ...
        return $this->readRaw($communicationID, $params, $requestOptions);
    }
    ...
    public function readRaw(
        ...
        [$parsed, $options] = CommunicationReadParams::parseRequest(
            $params,
            $requestOptions
        );
