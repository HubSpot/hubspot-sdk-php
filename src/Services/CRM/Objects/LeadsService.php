...
final class LeadsService implements LeadsContract
{
    ...
    public function update(
        ...
        return $this->updateRaw($leadsID, $params, $requestOptions);
    }
    ...
    public function get(
        ...
        return $this->getRaw($leadsID, $params, $requestOptions);
    }
    ...
    public function getRaw(
        ...
        [$parsed, $options] = LeadGetParams::parseRequest($params, $requestOptions);
