...
use HubspotSDK\ServiceContracts\CRM\Objects\TaxesContract;
use HubspotSDK\Services\CRM\Objects\Taxes\BatchService;
...
final class TaxesService implements TaxesContract
{
    ...
    public function update(
        ...
        return $this->updateRaw($taxID, $params, $requestOptions);
    }
    ...
    public function listRaw(
        ...
        [$parsed, $options] = TaxListParams::parseRequest($params, $requestOptions);
    ...
    public function get(
        ...
        return $this->getRaw($taxID, $params, $requestOptions);
    }
    ...
    public function getRaw(
        ...
        [$parsed, $options] = TaxGetParams::parseRequest($params, $requestOptions);
