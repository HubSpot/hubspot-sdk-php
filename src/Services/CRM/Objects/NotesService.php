...
use HubspotSDK\ServiceContracts\CRM\Objects\NotesContract;
use HubspotSDK\Services\CRM\Objects\Notes\BatchService;
...
final class NotesService implements NotesContract
{
    ...
    public function update(
        ...
        return $this->updateRaw($noteID, $params, $requestOptions);
    }
    ...
    public function get(
        ...
        return $this->getRaw($noteID, $params, $requestOptions);
    }
    ...
    public function getRaw(
        ...
        [$parsed, $options] = NoteGetParams::parseRequest($params, $requestOptions);
