...
use HubspotSDK\CRM\Objects\Appointments\AppointmentCreateParams;
use HubspotSDK\CRM\Objects\Appointments\AppointmentGetParams;
use HubspotSDK\CRM\Objects\Appointments\AppointmentListParams;
use HubspotSDK\CRM\Objects\Appointments\AppointmentSearchParams;
use HubspotSDK\CRM\Objects\Appointments\AppointmentUpdateParams;
use HubspotSDK\CRM\PublicAssociationsForObject;
use HubspotSDK\CRM\SimplePublicObject;
use HubspotSDK\CRM\SimplePublicObjectWithAssociations;
use HubspotSDK\Page;
use HubspotSDK\RequestOptions;
use HubspotSDK\ServiceContracts\CRM\Objects\AppointmentsContract;
use HubspotSDK\Services\CRM\Objects\Appointments\BatchService;

use const HubspotSDK\Core\OMIT as omit;

final class AppointmentsService implements AppointmentsContract
{
    /**
     * @@api
     */
    ...
    public function createRaw(
        ...
        [$parsed, $options] = AppointmentCreateParams::parseRequest(
            $params,
            $requestOptions
        );
    ...
    public function update(
        ...
        return $this->updateRaw($appointmentID, $params, $requestOptions);
    }
    ...
    public function updateRaw(
        ...
        [$parsed, $options] = AppointmentUpdateParams::parseRequest(
            $params,
            $requestOptions
        );
        ...
        return $this->client->request(
            method: 'patch',
            path: ['crm/v3/objects/0-421/%1$s', $appointmentID],
    ...
    public function listRaw(
        ...
        [$parsed, $options] = AppointmentListParams::parseRequest(
            $params,
            $requestOptions
        );
    ...
    public function get(
        ...
        return $this->getRaw($appointmentID, $params, $requestOptions);
    }
    ...
    public function getRaw(
        ...
        [$parsed, $options] = AppointmentGetParams::parseRequest(
            $params,
            $requestOptions
        );
    ...
    public function searchRaw(
        ...
        [$parsed, $options] = AppointmentSearchParams::parseRequest(
            $params,
            $requestOptions
        );
