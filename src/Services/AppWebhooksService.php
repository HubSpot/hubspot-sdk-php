...
use HubspotSDK\ServiceContracts\AppWebhooksContract;
 ...
 */
final class AppWebhooksService implements AppWebhooksContract
{
    /**
     * @api
     */
    public AppWebhooksRawService $raw;
    ...
    {
        $this->raw = new AppWebhooksRawService($client);
    }
    ...
    public function batchUpdateSubscriptions(
        ...
        $response = $this->raw->batchUpdateSubscriptions($appID, params: $params, requestOptions: $requestOptions);
