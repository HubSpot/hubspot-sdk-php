...
use HubspotSDK\ServiceContracts\Crm\Objects\GenericObjectsContract;
use HubspotSDK\Services\Crm\Objects\GenericObjects\BatchService;
 ...
 */
final class GenericObjectsService implements GenericObjectsContract
{
    /**
     * @api
     */
    public GenericObjectsRawService $raw;
    ...
    {
        $this->raw = new GenericObjectsRawService($client);
