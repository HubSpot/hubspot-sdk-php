...
final class GoalTargetsService implements GoalTargetsContract
{
     ...
     * @api
     */
    public GoalTargetsRawService $raw;
    ...
    {
        $this->raw = new GoalTargetsRawService($client);
    ...
    public function update(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->update($goalTargetID, params: $params, requestOptions: $requestOptions);
    ...
    public function delete(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->delete($goalTargetID, requestOptions: $requestOptions);
    ...
    public function get(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->get($goalTargetID, params: $params, requestOptions: $requestOptions);
