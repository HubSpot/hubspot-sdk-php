...
use HubspotSDK\ServiceContracts\Crm\Objects\FeesContract;
use HubspotSDK\Services\Crm\Objects\Fees\BatchService;

final class FeesService implements FeesContract
{
    /**
     * @api
     */
    public FeesRawService $raw;
    ...
    {
        $this->raw = new FeesRawService($client);
    ...
    public function update(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->update($feeID, params: $params, requestOptions: $requestOptions);
    ...
    public function delete(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->delete($feeID, requestOptions: $requestOptions);
    ...
    public function get(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->get($feeID, params: $params, requestOptions: $requestOptions);
