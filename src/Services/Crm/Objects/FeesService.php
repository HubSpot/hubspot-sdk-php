...
final class FeesService implements FeesContract
{
    ...
    public function update(
        ...
        return $this->updateRaw($feeID, $params, $requestOptions);
    }
    ...
    public function listRaw(
        ...
        [$parsed, $options] = FeeListParams::parseRequest($params, $requestOptions);
    ...
    public function get(
        ...
        return $this->getRaw($feeID, $params, $requestOptions);
    }
    ...
    public function getRaw(
        ...
        [$parsed, $options] = FeeGetParams::parseRequest($params, $requestOptions);
