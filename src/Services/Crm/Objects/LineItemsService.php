...
final class LineItemsService implements LineItemsContract
{
     ...
     * @api
     */
    public LineItemsRawService $raw;
    ...
    {
        $this->raw = new LineItemsRawService($client);
    ...
    public function update(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->update($lineItemID, params: $params, requestOptions: $requestOptions);
    ...
    public function delete(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->delete($lineItemID, requestOptions: $requestOptions);
    ...
    public function get(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->get($lineItemID, params: $params, requestOptions: $requestOptions);
