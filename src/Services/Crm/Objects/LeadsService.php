...
final class LeadsService implements LeadsContract
{
    ...
    {
        $this->raw = new LeadsRawService($client);
    ...
    public function update(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->update($leadsID, params: $params, requestOptions: $requestOptions);
    ...
    public function delete(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->delete($leadsID, requestOptions: $requestOptions);
    ...
    public function get(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->get($leadsID, params: $params, requestOptions: $requestOptions);
