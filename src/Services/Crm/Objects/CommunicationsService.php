...
final class CommunicationsService implements CommunicationsContract
{
     ...
     * @api
     */
    public CommunicationsRawService $raw;
    ...
    {
        $this->raw = new CommunicationsRawService($client);
    ...
    public function update(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->update($communicationID, params: $params, requestOptions: $requestOptions);
    ...
    public function delete(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->delete($communicationID, requestOptions: $requestOptions);
    ...
    public function get(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->get($communicationID, params: $params, requestOptions: $requestOptions);
