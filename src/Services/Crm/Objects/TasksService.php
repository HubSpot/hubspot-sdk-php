...
final class TasksService implements TasksContract
{
    ...
    public function update(
        ...
        return $this->updateRaw($taskID, $params, $requestOptions);
    }
    ...
    public function get(
        ...
        return $this->getRaw($taskID, $params, $requestOptions);
    }
    ...
    public function getRaw(
        ...
        [$parsed, $options] = TaskGetParams::parseRequest($params, $requestOptions);
