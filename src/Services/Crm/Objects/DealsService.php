...
final class DealsService implements DealsContract
{
    ...
    {
        $this->raw = new DealsRawService($client);
    ...
    public function update(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->update($dealID, params: $params, requestOptions: $requestOptions);
    ...
    public function delete(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->delete($dealID, requestOptions: $requestOptions);
    ...
    public function get(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->get($dealID, params: $params, requestOptions: $requestOptions);
