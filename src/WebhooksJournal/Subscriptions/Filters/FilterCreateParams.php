...
namespace HubSpotSDK\WebhooksJournal\Subscriptions\Filters;
 ...
 *
 * @see HubSpotSDK\Services\WebhooksJournal\Subscriptions\FiltersService::create()
 *
...
final class FilterCreateParams implements BaseModel
{
     ...
     * ```
     * FilterCreateParams::with(filter: ..., subscriptionID: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new FilterCreateParams)->withFilter(...)->withSubscriptionID(...)
     * ```
     */
