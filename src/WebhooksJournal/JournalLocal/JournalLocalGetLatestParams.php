 ...
 *
 * @see HubSpotSDK\Services\WebhooksJournal\JournalLocalService::getLatest()
 *
 * @phpstan-type JournalLocalGetLatestParamsShape = array{
 *   installPortalID?: int|null
 * }
 */
final class JournalLocalGetLatestParams implements BaseModel
{
    /** @use SdkModel<JournalLocalGetLatestParamsShape> */
    use SdkModel;
    use SdkParams;
