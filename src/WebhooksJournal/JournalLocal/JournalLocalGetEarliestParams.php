 ...
 *
 * @see HubSpotSDK\Services\WebhooksJournal\JournalLocalService::getEarliest()
 *
 * @phpstan-type JournalLocalGetEarliestParamsShape = array{
 *   installPortalID?: int|null
 * }
 */
final class JournalLocalGetEarliestParams implements BaseModel
{
    /** @use SdkModel<JournalLocalGetEarliestParamsShape> */
    use SdkModel;
    use SdkParams;
