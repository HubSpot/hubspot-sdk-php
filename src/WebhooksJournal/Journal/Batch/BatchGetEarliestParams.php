...
namespace HubSpotSDK\WebhooksJournal\Journal\Batch;
 ...
 *
 * @see HubSpotSDK\Services\WebhooksJournal\Journal\BatchService::getEarliest()
 *
 * @phpstan-type BatchGetEarliestParamsShape = array{installPortalID?: int|null}
 */
final class BatchGetEarliestParams implements BaseModel
{
    /** @use SdkModel<BatchGetEarliestParamsShape> */
    use SdkModel;
    use SdkParams;
