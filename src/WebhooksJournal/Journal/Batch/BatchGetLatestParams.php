 ...
 *
 * @see HubSpotSDK\Services\WebhooksJournal\Journal\BatchService::getLatest()
 *
 * @phpstan-type BatchGetLatestParamsShape = array{installPortalID?: int|null}
 */
final class BatchGetLatestParams implements BaseModel
{
    /** @use SdkModel<BatchGetLatestParamsShape> */
    use SdkModel;
    use SdkParams;
