...
/**
 * @see HubspotSDK\Services\DataStudio\DatasourceService::update()
 *
 ...
 *
 * @phpstan-type DatasourceUpdateParamsShape = array{
 ...
 * }
 */
final class DatasourceUpdateParams implements BaseModel
{
    /** @use SdkModel<DatasourceUpdateParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new DatasourceUpdateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * DatasourceUpdateParams::with(
     *   bodyParts: ...,
     *   contentDisposition: ...,
     *   entity: ...,
     *   fields: ...,
