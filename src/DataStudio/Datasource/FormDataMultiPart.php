 ...
 *
 * @phpstan-type FormDataMultiPartShape = array{
 ...
 * }
 */
final class FormDataMultiPart implements BaseModel
{
    /** @use SdkModel<FormDataMultiPartShape> */
    use SdkModel;
    ...
    /**
     * `new FormDataMultiPart()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * FormDataMultiPart::with(
     *   bodyParts: ...,
     *   contentDisposition: ...,
     *   entity: ...,
     *   fields: ...,
