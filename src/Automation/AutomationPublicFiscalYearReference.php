...
use HubspotSDK\Automation\AutomationPublicFiscalYearReference\ReferenceType;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type automation_public_fiscal_year_reference = array{
 *   day: int,
 *   month: int,
 ...
 * }
 */
final class AutomationPublicFiscalYearReference implements BaseModel
{
    /** @use SdkModel<automation_public_fiscal_year_reference> */
    use SdkModel;
    ...
    /**
     * `new AutomationPublicFiscalYearReference()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutomationPublicFiscalYearReference::with(
     ...
     *
     * ```
     * (new AutomationPublicFiscalYearReference)
     *   ->withDay(...)
     *   ->withMonth(...)
     *   ->withReferenceType(...)
     * ```
