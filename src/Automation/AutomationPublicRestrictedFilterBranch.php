...
use HubspotSDK\Automation\AutomationPublicRestrictedFilterBranch\Filter;
use HubspotSDK\Automation\AutomationPublicRestrictedFilterBranch\FilterBranch;
use HubspotSDK\Automation\AutomationPublicRestrictedFilterBranch\FilterBranchType;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type automation_public_restricted_filter_branch = array{
 ...
 * }
 */
final class AutomationPublicRestrictedFilterBranch implements BaseModel
{
    /** @use SdkModel<automation_public_restricted_filter_branch> */
    use SdkModel;
    ...
    /**
     * `new AutomationPublicRestrictedFilterBranch()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutomationPublicRestrictedFilterBranch::with(
     *   filterBranches: ...,
     ...
     *
     * ```
     * (new AutomationPublicRestrictedFilterBranch)
     *   ->withFilterBranches(...)
