...
use HubspotSDK\Automation\APIPlatformFlowCreateRequest\Action;
use HubspotSDK\Automation\APIPlatformFlowCreateRequest\DataSource;
use HubspotSDK\Automation\APIPlatformFlowCreateRequest\FlowType;
use HubspotSDK\Automation\APIPlatformFlowCreateRequest\Type;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type api_platform_flow_create_request = array{
...
{
    /** @use SdkModel<api_platform_flow_create_request> */
    use SdkModel;
