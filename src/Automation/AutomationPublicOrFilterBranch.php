...
use HubspotSDK\Automation\AutomationPublicOrFilterBranch\Filter;
use HubspotSDK\Automation\AutomationPublicOrFilterBranch\FilterBranch;
use HubspotSDK\Automation\AutomationPublicOrFilterBranch\FilterBranchType;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type automation_public_or_filter_branch = array{
 ...
 * }
 */
final class AutomationPublicOrFilterBranch implements BaseModel
{
    /** @use SdkModel<automation_public_or_filter_branch> */
    use SdkModel;
    ...
    /**
     * `new AutomationPublicOrFilterBranch()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutomationPublicOrFilterBranch::with(
     *   filterBranches: ...,
     ...
     *
     * ```
     * (new AutomationPublicOrFilterBranch)
     *   ->withFilterBranches(...)
