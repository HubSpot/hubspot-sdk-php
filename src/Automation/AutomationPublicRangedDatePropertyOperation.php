...
use HubspotSDK\Automation\AutomationPublicRangedDatePropertyOperation\OperationType;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type automation_public_ranged_date_property_operation = array{
 ...
 * }
 */
final class AutomationPublicRangedDatePropertyOperation implements BaseModel
{
    /** @use SdkModel<automation_public_ranged_date_property_operation> */
    use SdkModel;
    ...
    /**
     * `new AutomationPublicRangedDatePropertyOperation()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutomationPublicRangedDatePropertyOperation::with(
     ...
     *
     * ```
     * (new AutomationPublicRangedDatePropertyOperation)
