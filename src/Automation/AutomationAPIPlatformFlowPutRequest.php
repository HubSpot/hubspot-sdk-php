...
use HubspotSDK\Automation\AutomationAPIPlatformFlowPutRequest\Action;
use HubspotSDK\Automation\AutomationAPIPlatformFlowPutRequest\Type;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type automation_api_platform_flow_put_request = array{
 ...
 * }
 */
final class AutomationAPIPlatformFlowPutRequest implements BaseModel
{
    /** @use SdkModel<automation_api_platform_flow_put_request> */
    use SdkModel;
    ...
    /**
     * `new AutomationAPIPlatformFlowPutRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutomationAPIPlatformFlowPutRequest::with(
     *   actions: ...,
     *   blockedDates: ...,
     *   customProperties: ...,
     *   isEnabled: ...,
     ...
     *
     * ```
     * (new AutomationAPIPlatformFlowPutRequest)
     *   ->withActions(...)
     *   ->withBlockedDates(...)
