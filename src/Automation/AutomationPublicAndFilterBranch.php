...
use HubspotSDK\Automation\AutomationPublicAndFilterBranch\Filter;
use HubspotSDK\Automation\AutomationPublicAndFilterBranch\FilterBranch;
use HubspotSDK\Automation\AutomationPublicAndFilterBranch\FilterBranchType;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type automation_public_and_filter_branch = array{
 ...
 * }
 */
final class AutomationPublicAndFilterBranch implements BaseModel
{
    /** @use SdkModel<automation_public_and_filter_branch> */
    use SdkModel;
    ...
    /**
     * `new AutomationPublicAndFilterBranch()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutomationPublicAndFilterBranch::with(
     *   filterBranches: ...,
     ...
     *
     * ```
     * (new AutomationPublicAndFilterBranch)
     *   ->withFilterBranches(...)
