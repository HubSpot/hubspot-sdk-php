...
use HubspotSDK\Automation\AutomationPublicFiscalQuarterReference\ReferenceType;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type automation_public_fiscal_quarter_reference = array{
 *   day: int,
 *   month: int,
 ...
 * }
 */
final class AutomationPublicFiscalQuarterReference implements BaseModel
{
    /** @use SdkModel<automation_public_fiscal_quarter_reference> */
    use SdkModel;
    ...
    /**
     * `new AutomationPublicFiscalQuarterReference()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutomationPublicFiscalQuarterReference::with(
     ...
     *
     * ```
     * (new AutomationPublicFiscalQuarterReference)
     *   ->withDay(...)
     *   ->withMonth(...)
     *   ->withReferenceType(...)
     * ```
