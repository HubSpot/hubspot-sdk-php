...
use HubspotSDK\Automation\AutomationPublicComparativeDatePropertyOperation\OperationType;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type automation_public_comparative_date_property_operation = array{
 ...
 * }
 */
final class AutomationPublicComparativeDatePropertyOperation implements BaseModel
{
    /** @use SdkModel<automation_public_comparative_date_property_operation> */
    use SdkModel;
    ...
    /**
     * `new AutomationPublicComparativeDatePropertyOperation()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutomationPublicComparativeDatePropertyOperation::with(
     ...
     *
     * ```
     * (new AutomationPublicComparativeDatePropertyOperation)
