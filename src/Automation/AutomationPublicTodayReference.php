...
use HubspotSDK\Automation\AutomationPublicTodayReference\ReferenceType;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type automation_public_today_reference = array{
 ...
 * }
 */
final class AutomationPublicTodayReference implements BaseModel
{
    /** @use SdkModel<automation_public_today_reference> */
    use SdkModel;
    ...
    /**
     * `new AutomationPublicTodayReference()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutomationPublicTodayReference::with(referenceType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new AutomationPublicTodayReference)->withReferenceType(...)
     * ```
     */
