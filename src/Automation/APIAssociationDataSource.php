...
use HubspotSDK\Automation\APIAssociationDataSource\AssociationCategory;
use HubspotSDK\Automation\APIAssociationDataSource\Type;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type api_association_data_source = array{
...
{
    /** @use SdkModel<api_association_data_source> */
    use SdkModel;
