...
use HubspotSDK\Automation\APIPlatformFlow\Action;
use HubspotSDK\Automation\APIPlatformFlow\CRMObjectCreationStatus;
use HubspotSDK\Automation\APIPlatformFlow\DataSource;
use HubspotSDK\Automation\APIPlatformFlow\FlowType;
use HubspotSDK\Automation\APIPlatformFlow\Type;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type api_platform_flow = array{
 *   id: string,
...
{
    /** @use SdkModel<api_platform_flow> */
    use SdkModel;
