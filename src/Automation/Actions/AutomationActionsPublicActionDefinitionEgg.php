...
use HubspotSDK\Automation\Actions\AutomationActionsPublicActionDefinitionEgg\InputFieldDependency;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type automation_actions_public_action_definition_egg = array{
 *   actionURL: string,
 ...
 * }
 */
final class AutomationActionsPublicActionDefinitionEgg implements BaseModel
{
    /** @use SdkModel<automation_actions_public_action_definition_egg> */
    use SdkModel;
    ...
    /**
     * `new AutomationActionsPublicActionDefinitionEgg()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutomationActionsPublicActionDefinitionEgg::with(
     *   actionURL: ...,
     *   functions: ...,
     *   inputFields: ...,
     *   labels: ...,
     ...
     *
     * ```
     * (new AutomationActionsPublicActionDefinitionEgg)
     *   ->withActionURL(...)
     *   ->withFunctions(...)
     *   ->withInputFields(...)
     *   ->withLabels(...)
