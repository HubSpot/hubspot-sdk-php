...
final class AutomationActionsPublicActionDefinition implements BaseModel
{
    ...
    /** @var list<AutomationActionsPublicActionFunctionIdentifier> $functions */
    ...
    /**
     * `new AutomationActionsPublicActionDefinition()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutomationActionsPublicActionDefinition::with(
     *   id: ...,
     *   actionURL: ...,
     *   functions: ...,
     *   inputFields: ...,
     ...
     *
     * ```
     * (new AutomationActionsPublicActionDefinition)
     *   ->withID(...)
     *   ->withActionURL(...)
     *   ->withFunctions(...)
     *   ->withInputFields(...)
     ...
     *
     * @param list<AutomationActionsPublicActionFunctionIdentifier> $functions
