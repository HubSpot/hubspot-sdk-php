...
/**
 * @phpstan-type collection_response_public_action_definition_forward_paging = array{
...
{
    /**
     * @use SdkModel<collection_response_public_action_definition_forward_paging>
     */
    use SdkModel;
