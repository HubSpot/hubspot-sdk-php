...
use HubspotSDK\Automation\AutomationPublicRollingDateRangePropertyOperation\OperationType;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type automation_public_rolling_date_range_property_operation = array{
 ...
 * }
 */
final class AutomationPublicRollingDateRangePropertyOperation implements BaseModel
{
    /** @use SdkModel<automation_public_rolling_date_range_property_operation> */
    use SdkModel;
    ...
    /**
     * `new AutomationPublicRollingDateRangePropertyOperation()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutomationPublicRollingDateRangePropertyOperation::with(
     ...
     *
     * ```
     * (new AutomationPublicRollingDateRangePropertyOperation)
