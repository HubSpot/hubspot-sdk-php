...
use HubspotSDK\Automation\AutomationAPIContactFlowCreateRequest\Action;
use HubspotSDK\Automation\AutomationAPIContactFlowCreateRequest\DataSource;
use HubspotSDK\Automation\AutomationAPIContactFlowCreateRequest\FlowType;
use HubspotSDK\Automation\AutomationAPIContactFlowCreateRequest\Type;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type automation_api_contact_flow_create_request = array{
 ...
 * }
 */
final class AutomationAPIContactFlowCreateRequest implements BaseModel
{
    /** @use SdkModel<automation_api_contact_flow_create_request> */
    use SdkModel;
    ...
    /**
     * `new AutomationAPIContactFlowCreateRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutomationAPIContactFlowCreateRequest::with(
     *   actions: ...,
     *   blockedDates: ...,
     ...
     *
     * ```
     * (new AutomationAPIContactFlowCreateRequest)
     *   ->withActions(...)
     *   ->withBlockedDates(...)
