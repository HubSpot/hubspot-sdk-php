...
use HubspotSDK\Automation\AutomationPublicDatePoint\TimeType;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type automation_public_date_point = array{
 *   day: int,
 *   month: int,
 ...
 * }
 */
final class AutomationPublicDatePoint implements BaseModel
{
    /** @use SdkModel<automation_public_date_point> */
    use SdkModel;
    ...
    /**
     * `new AutomationPublicDatePoint()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutomationPublicDatePoint::with(
