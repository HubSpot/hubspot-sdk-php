...
use HubspotSDK\Automation\AutomationPublicMonthReference\ReferenceType;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type automation_public_month_reference = array{
 *   day: int,
 ...
 * }
 */
final class AutomationPublicMonthReference implements BaseModel
{
    /** @use SdkModel<automation_public_month_reference> */
    use SdkModel;
    ...
    /**
     * `new AutomationPublicMonthReference()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutomationPublicMonthReference::with(day: ..., referenceType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new AutomationPublicMonthReference)->withDay(...)->withReferenceType(...)
     * ```
     */
