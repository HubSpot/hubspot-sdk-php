...
use HubspotSDK\Automation\AutomationPublicYearReference\ReferenceType;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type automation_public_year_reference = array{
 *   day: int,
 *   month: int,
 ...
 * }
 */
final class AutomationPublicYearReference implements BaseModel
{
    /** @use SdkModel<automation_public_year_reference> */
    use SdkModel;
    ...
    /**
     * `new AutomationPublicYearReference()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutomationPublicYearReference::with(day: ..., month: ..., referenceType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new AutomationPublicYearReference)
     *   ->withDay(...)
     *   ->withMonth(...)
     *   ->withReferenceType(...)
     * ```
