...
use HubspotSDK\Automation\Workflows\PublicPropertyAssociationFilterBranch\Filter;
use HubspotSDK\Automation\Workflows\PublicPropertyAssociationFilterBranch\FilterBranch;
use HubspotSDK\Automation\Workflows\PublicPropertyAssociationFilterBranch\FilterBranchType;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type public_property_association_filter_branch = array{
...
{
    /** @use SdkModel<public_property_association_filter_branch> */
    use SdkModel;
