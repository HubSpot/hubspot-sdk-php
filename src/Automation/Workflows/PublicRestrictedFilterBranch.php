...
use HubspotSDK\Automation\Workflows\PublicRestrictedFilterBranch\Filter;
use HubspotSDK\Automation\Workflows\PublicRestrictedFilterBranch\FilterBranch;
use HubspotSDK\Automation\Workflows\PublicRestrictedFilterBranch\FilterBranchType;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type public_restricted_filter_branch = array{
...
{
    /** @use SdkModel<public_restricted_filter_branch> */
    use SdkModel;
