...
final class BatchResponseFlowIDWorkflowIDMappingResponse implements BaseModel
{
    ...
    /**
     * `new BatchResponseFlowIDWorkflowIDMappingResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BatchResponseFlowIDWorkflowIDMappingResponse::with(
     ...
     *
     * ```
     * (new BatchResponseFlowIDWorkflowIDMappingResponse)
     *   ->withCompletedAt(...)
     *   ->withResults(...)
     *   ->withStartedAt(...)
     *   ->withStatus(...)
