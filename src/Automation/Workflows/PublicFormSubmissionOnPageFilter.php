...
use HubspotSDK\Automation\Workflows\PublicFormSubmissionOnPageFilter\FilterType;
use HubspotSDK\Automation\Workflows\PublicFormSubmissionOnPageFilter\Operator;
