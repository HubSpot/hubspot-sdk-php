...
use HubspotSDK\Automation\Workflows\PublicMonthReference\ReferenceType;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type public_month_reference = array{
 *   day: int,
 ...
 * }
 */
final class PublicMonthReference implements BaseModel
{
    /** @use SdkModel<public_month_reference> */
    use SdkModel;
    ...
    /**
     * `new PublicMonthReference()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * PublicMonthReference::with(day: ..., referenceType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new PublicMonthReference)->withDay(...)->withReferenceType(...)
     * ```
     */
