...
use HubspotSDK\Automation\Workflows\PublicNotAllFilterBranch\Filter;
use HubspotSDK\Automation\Workflows\PublicNotAllFilterBranch\FilterBranch;
use HubspotSDK\Automation\Workflows\PublicNotAllFilterBranch\FilterBranchType;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type public_not_all_filter_branch = array{
...
{
    /** @use SdkModel<public_not_all_filter_branch> */
    use SdkModel;
