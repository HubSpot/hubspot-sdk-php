...
use HubspotSDK\Automation\Workflows\BatchResponseFlowIDWorkflowIDMappingResponseWithErrors\Status;
 ...
 *   results: list<FlowIDWorkflowIDMappingResponse|FlowIDWorkflowIDMappingResponseShape>,
...
final class BatchResponseFlowIDWorkflowIDMappingResponseWithErrors implements BaseModel
{
    ...
    /**
     * `new BatchResponseFlowIDWorkflowIDMappingResponseWithErrors()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BatchResponseFlowIDWorkflowIDMappingResponseWithErrors::with(
     ...
     *
     * ```
     * (new BatchResponseFlowIDWorkflowIDMappingResponseWithErrors)
     *   ->withCompletedAt(...)
     *   ->withResults(...)
     *   ->withStartedAt(...)
     *   ->withStatus(...)
     ...
     *
     * @param list<FlowIDWorkflowIDMappingResponse|FlowIDWorkflowIDMappingResponseShape> $results
