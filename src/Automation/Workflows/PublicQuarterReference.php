...
use HubspotSDK\Automation\Workflows\PublicQuarterReference\ReferenceType;
...
final class PublicQuarterReference implements BaseModel
{
    ...
    /**
     * `new PublicQuarterReference()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * PublicQuarterReference::with(day: ..., month: ..., referenceType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new PublicQuarterReference)
     *   ->withDay(...)
     *   ->withMonth(...)
     *   ->withReferenceType(...)
     * ```
