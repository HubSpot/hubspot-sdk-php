...
use HubspotSDK\Automation\Workflows\PublicAndFilterBranch\Filter;
use HubspotSDK\Automation\Workflows\PublicAndFilterBranch\FilterBranch;
use HubspotSDK\Automation\Workflows\PublicAndFilterBranch\FilterBranchType;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type public_and_filter_branch = array{
...
{
    /** @use SdkModel<public_and_filter_branch> */
    use SdkModel;
