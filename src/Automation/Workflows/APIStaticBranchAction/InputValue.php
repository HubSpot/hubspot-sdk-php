 ...
 *
 * @phpstan-type InputValueVariants = APIActionDataValue|APIObjectPropertyValue|APIStaticValue|APIRelativeDateTimeValue|APITimestampValue|APIIncrementValue|APIFetchedObjectPropertyValue|APIAppendObjectPropertyValue|APIStaticAppendValue|APIEnrollmentEventPropertyValue
 * @phpstan-type InputValueShape = InputValueVariants|APIActionDataValueShape|APIObjectPropertyValueShape|APIStaticValueShape|APIRelativeDateTimeValueShape|APITimestampValueShape|APIIncrementValueShape|APIFetchedObjectPropertyValueShape|APIAppendObjectPropertyValueShape|APIStaticAppendValueShape|APIEnrollmentEventPropertyValueShape
 */
