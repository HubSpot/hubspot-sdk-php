...
use HubspotSDK\Automation\Workflows\PublicCalendarDatePropertyOperation\FiscalYearStart;
use HubspotSDK\Automation\Workflows\PublicCalendarDatePropertyOperation\OperationType;
