...
use HubspotSDK\Automation\AutomationPublicEmailSubscriptionFilter\FilterType;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type automation_public_email_subscription_filter = array{
 ...
 * }
 */
final class AutomationPublicEmailSubscriptionFilter implements BaseModel
{
    /** @use SdkModel<automation_public_email_subscription_filter> */
    use SdkModel;
    ...
    /**
     * `new AutomationPublicEmailSubscriptionFilter()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutomationPublicEmailSubscriptionFilter::with(
     ...
     *
     * ```
     * (new AutomationPublicEmailSubscriptionFilter)
