...
use HubspotSDK\Automation\AutomationPublicQuarterReference\ReferenceType;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type automation_public_quarter_reference = array{
 *   day: int,
 *   month: int,
 ...
 * }
 */
final class AutomationPublicQuarterReference implements BaseModel
{
    /** @use SdkModel<automation_public_quarter_reference> */
    use SdkModel;
    ...
    /**
     * `new AutomationPublicQuarterReference()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutomationPublicQuarterReference::with(day: ..., month: ..., referenceType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new AutomationPublicQuarterReference)
     *   ->withDay(...)
     *   ->withMonth(...)
     *   ->withReferenceType(...)
     * ```
