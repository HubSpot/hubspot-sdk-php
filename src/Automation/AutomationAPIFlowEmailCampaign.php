...
/**
 * @phpstan-type automation_api_flow_email_campaign = array{
 *   emailCampaignID: string, emailContentID: string, flowID: string
 * }
 */
final class AutomationAPIFlowEmailCampaign implements BaseModel
{
    /** @use SdkModel<automation_api_flow_email_campaign> */
    use SdkModel;
    ...
    /**
     * `new AutomationAPIFlowEmailCampaign()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutomationAPIFlowEmailCampaign::with(
     ...
     *
     * ```
     * (new AutomationAPIFlowEmailCampaign)
     *   ->withEmailCampaignID(...)
     *   ->withEmailContentID(...)
     *   ->withFlowID(...)
     * ```
