...
use HubspotSDK\Automation\AutomationAPIAssociationDataSource\AssociationCategory;
use HubspotSDK\Automation\AutomationAPIAssociationDataSource\Type;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type automation_api_association_data_source = array{
 ...
 * }
 */
final class AutomationAPIAssociationDataSource implements BaseModel
{
    /** @use SdkModel<automation_api_association_data_source> */
    use SdkModel;
    ...
    /**
     * `new AutomationAPIAssociationDataSource()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutomationAPIAssociationDataSource::with(
     *   associationCategory: ...,
     *   associationTypeID: ...,
     *   name: ...,
     *   objectTypeID: ...,
     ...
     *
     * ```
     * (new AutomationAPIAssociationDataSource)
