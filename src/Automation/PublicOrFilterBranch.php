...
use HubspotSDK\Automation\PublicOrFilterBranch\Filter;
use HubspotSDK\Automation\PublicOrFilterBranch\FilterBranch;
use HubspotSDK\Automation\PublicOrFilterBranch\FilterBranchType;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type public_or_filter_branch = array{
...
{
    /** @use SdkModel<public_or_filter_branch> */
    use SdkModel;
