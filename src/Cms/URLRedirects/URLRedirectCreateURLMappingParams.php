...
/**
 * @see HubSpotSDK\Services\Cms\URLRedirectsService::createURLMapping()
 *
 * @phpstan-type URLRedirectCreateURLMappingParamsShape = array{
 *   id: string,
 ...
 * }
 */
final class URLRedirectCreateURLMappingParams implements BaseModel
{
    /** @use SdkModel<URLRedirectCreateURLMappingParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new URLRedirectCreateURLMappingParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * URLRedirectCreateURLMappingParams::with(
     *   id: ...,
     *   created: ...,
     *   destination: ...,
     *   isMatchFullURL: ...,
     ...
     *
     * ```
     * (new URLRedirectCreateURLMappingParams)
     *   ->withID(...)
     *   ->withCreated(...)
     *   ->withDestination(...)
     *   ->withIsMatchFullURL(...)
