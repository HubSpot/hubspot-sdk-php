...
/**
 * @phpstan-type cms_url_mapping = array{
 *   id: string,
 *   destination: string,
 *   isMatchFullURL: bool,
 ...
 * }
 */
final class CmsURLMapping implements BaseModel
{
    /** @use SdkModel<cms_url_mapping> */
    use SdkModel;
    ...
    /**
     * `new CmsURLMapping()` is missing required properties by the API.
     *
