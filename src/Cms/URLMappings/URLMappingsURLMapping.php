...
use HubSpotSDK\Cms\URLMappings\URLMappingsURLMapping\CosObjectType;
use HubSpotSDK\Core\Attributes\Required;
use HubSpotSDK\Core\Concerns\SdkModel;
use HubSpotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type URLMappingsURLMappingShape = array{
 *   id: int,
 ...
 * }
 */
final class URLMappingsURLMapping implements BaseModel
{
    /** @use SdkModel<URLMappingsURLMappingShape> */
    use SdkModel;
    ...
    /**
     * `new URLMappingsURLMapping()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * URLMappingsURLMapping::with(
     *   id: ...,
     *   cdnPurgeEmbargoTime: ...,
     *   contentGroupID: ...,
     *   cosObjectType: ...,
