 ...
 * }
 */
final class AuditLogExportParams implements BaseModel
{
    /** @use SdkModel<AuditLogExportParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new AuditLogExportParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AuditLogExportParams::with(
     *   email: ...,
     *   format: ...,
     *   portalID: ...,
     *   recipientUserIDs: ...,
