...
/**
 * @phpstan-type cms_url_mapping_create_request_body = array{
 *   destination: string,
 *   redirectStyle: int,
 *   routePrefix: string,
 *   isMatchFullURL?: bool,
 ...
 * }
 */
final class CmsURLMappingCreateRequestBody implements BaseModel
{
    /** @use SdkModel<cms_url_mapping_create_request_body> */
    use SdkModel;
    ...
    /**
     * `new CmsURLMappingCreateRequestBody()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CmsURLMappingCreateRequestBody::with(
     ...
     *
     * ```
     * (new CmsURLMappingCreateRequestBody)
     *   ->withDestination(...)
     *   ->withRedirectStyle(...)
     *   ->withRoutePrefix(...)
     * ```
