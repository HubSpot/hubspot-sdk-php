...
/**
 * @see HubspotSDK\Services\Cms\PagesService::listSitePages()
 *
 * @phpstan-type PageListSitePagesParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class PageListSitePagesParams implements BaseModel
{
    /** @use SdkModel<PageListSitePagesParamsShape> */
    use SdkModel;
    use SdkParams;
