...
/**
 * @see HubspotSDK\Services\Cms\PagesService::getLandingPageFoldersByQuery()
 *
 * @phpstan-type PageGetLandingPageFoldersByQueryParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class PageGetLandingPageFoldersByQueryParams implements BaseModel
{
    /** @use SdkModel<PageGetLandingPageFoldersByQueryParamsShape> */
    use SdkModel;
    use SdkParams;
