...
/**
 * @see HubspotSDK\Services\Cms\PagesService::queryLandingPages()
 *
 * @phpstan-type PageQueryLandingPagesParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class PageQueryLandingPagesParams implements BaseModel
{
    /** @use SdkModel<PageQueryLandingPagesParamsShape> */
    use SdkModel;
    use SdkParams;
