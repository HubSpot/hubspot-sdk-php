...
/**
 * @see HubSpotSDK\Services\Cms\PagesService::getLandingPages()
 *
 * @phpstan-type PageGetLandingPagesParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class PageGetLandingPagesParams implements BaseModel
{
    /** @use SdkModel<PageGetLandingPagesParamsShape> */
    use SdkModel;
    use SdkParams;
