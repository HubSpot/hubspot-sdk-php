 ...
 *
 * @see HubspotSDK\Services\Cms\Pages\WebsitePagesService::list()
 *
 * @phpstan-type WebsitePageListParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class WebsitePageListParams implements BaseModel
{
    /** @use SdkModel<WebsitePageListParamsShape> */
    use SdkModel;
    use SdkParams;
