 ...
 * }
 */
final class WebsitePageCloneParams implements BaseModel
{
    /** @use SdkModel<WebsitePageCloneParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new WebsitePageCloneParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * WebsitePageCloneParams::with(id: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new WebsitePageCloneParams)->withID(...)
     * ```
     */
