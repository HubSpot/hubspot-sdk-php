 ...
 * }
 */
final class WebsitePageUpdateParams implements BaseModel
{
    /** @use SdkModel<WebsitePageUpdateParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new WebsitePageUpdateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * WebsitePageUpdateParams::with(
     *   id: ...,
     *   abStatus: ...,
     *   abTestID: ...,
     *   archivedAt: ...,
