 ...
 * }
 */
final class WebsitePageUpdateDraftParams implements BaseModel
{
    /** @use SdkModel<WebsitePageUpdateDraftParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new WebsitePageUpdateDraftParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * WebsitePageUpdateDraftParams::with(
     *   id: ...,
     *   abStatus: ...,
     *   abTestID: ...,
     *   archivedAt: ...,
     ...
     *
     * ```
     * (new WebsitePageUpdateDraftParams)
     *   ->withID(...)
     *   ->withAbStatus(...)
     *   ->withAbTestID(...)
     *   ->withArchivedAt(...)
