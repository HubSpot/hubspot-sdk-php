 ...
 * }
 */
final class WebsitePageCreateParams implements BaseModel
{
    /** @use SdkModel<WebsitePageCreateParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new WebsitePageCreateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * WebsitePageCreateParams::with(
     *   id: ...,
     *   abStatus: ...,
     *   abTestID: ...,
     *   archivedAt: ...,
