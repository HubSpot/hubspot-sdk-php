 ...
 * }
 */
final class WebsitePageScheduleParams implements BaseModel
{
    /** @use SdkModel<WebsitePageScheduleParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new WebsitePageScheduleParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * WebsitePageScheduleParams::with(id: ..., publishDate: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new WebsitePageScheduleParams)->withID(...)->withPublishDate(...)
     * ```
     */
