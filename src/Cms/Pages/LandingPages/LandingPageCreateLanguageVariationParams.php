 ...
 *
 * @see HubspotSDK\Cms\Pages\LandingPages->createLanguageVariation
 *
 * @phpstan-type landing_page_create_language_variation_params = array{
...
{
    /** @use SdkModel<landing_page_create_language_variation_params> */
    use SdkModel;
    use SdkParams;
