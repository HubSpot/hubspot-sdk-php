 ...
 *
 * @see HubSpotSDK\Services\Cms\Pages\LandingPages\FoldersService::list()
 *
 * @phpstan-type FolderListParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class FolderListParams implements BaseModel
{
    /** @use SdkModel<FolderListParamsShape> */
    use SdkModel;
    use SdkParams;
