 ...
 *
 * @see HubSpotSDK\Services\Cms\Pages\LandingPages\FoldersService::listRevisions()
 *
 * @phpstan-type FolderListRevisionsParamsShape = array{
 *   after?: string|null, before?: string|null, limit?: int|null
 * }
 */
final class FolderListRevisionsParams implements BaseModel
{
    /** @use SdkModel<FolderListRevisionsParamsShape> */
    use SdkModel;
    use SdkParams;
