 ...
 *
 * @phpstan-type landing_page_update_params = array{
 *   id: string,
 ...
 * }
 */
final class LandingPageUpdateParams implements BaseModel
{
    /** @use SdkModel<landing_page_update_params> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new LandingPageUpdateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * LandingPageUpdateParams::with(
     *   id: ...,
     *   abStatus: ...,
     *   abTestID: ...,
     *   archivedAt: ...,
