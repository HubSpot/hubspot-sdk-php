 ...
 *
 * @phpstan-type landing_page_create_params = array{
 *   id: string,
 ...
 * }
 */
final class LandingPageCreateParams implements BaseModel
{
    /** @use SdkModel<landing_page_create_params> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new LandingPageCreateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * LandingPageCreateParams::with(
     *   id: ...,
     *   abStatus: ...,
     *   abTestID: ...,
     *   archivedAt: ...,
