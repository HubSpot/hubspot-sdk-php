...
use HubspotSDK\Cms\Pages\SitePages\SitePageUpdateParams\AbStatus;
use HubspotSDK\Cms\Pages\SitePages\SitePageUpdateParams\ContentTypeCategory;
use HubspotSDK\Cms\Pages\SitePages\SitePageUpdateParams\CurrentState;
use HubspotSDK\Cms\Pages\SitePages\SitePageUpdateParams\Language;
 ...
 *
 * @see HubspotSDK\Services\Cms\Pages\SitePagesService::update()
 *
...
final class SitePageUpdateParams implements BaseModel
{
    ...
    /**
     * `new SitePageUpdateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SitePageUpdateParams::with(
     *   id: ...,
     *   abStatus: ...,
     *   abTestId: ...,
     *   archivedAt: ...,
