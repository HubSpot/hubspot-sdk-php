 ...
 *
 * @see HubSpotSDK\Services\Cms\Pages\SitePages\BatchService::deleteSitePages()
 *
 * @phpstan-type BatchDeleteSitePagesParamsShape = array{inputs: list<string>}
 */
final class BatchDeleteSitePagesParams implements BaseModel
{
    /** @use SdkModel<BatchDeleteSitePagesParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new BatchDeleteSitePagesParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BatchDeleteSitePagesParams::with(inputs: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new BatchDeleteSitePagesParams)->withInputs(...)
     * ```
     */
