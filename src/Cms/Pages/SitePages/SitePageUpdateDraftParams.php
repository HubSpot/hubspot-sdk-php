...
use HubspotSDK\Cms\Pages\SitePages\SitePageUpdateDraftParams\AbStatus;
use HubspotSDK\Cms\Pages\SitePages\SitePageUpdateDraftParams\ContentTypeCategory;
use HubspotSDK\Cms\Pages\SitePages\SitePageUpdateDraftParams\CurrentState;
use HubspotSDK\Cms\Pages\SitePages\SitePageUpdateDraftParams\Language;
 ...
 *
 * @see HubspotSDK\Services\Cms\Pages\SitePagesService::updateDraft()
 *
 * @phpstan-type SitePageUpdateDraftParamsShape = array{
 *   id: string,
 ...
 * }
 */
final class SitePageUpdateDraftParams implements BaseModel
{
    /** @use SdkModel<SitePageUpdateDraftParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new SitePageUpdateDraftParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SitePageUpdateDraftParams::with(
     *   id: ...,
     *   abStatus: ...,
     *   abTestID: ...,
     *   archivedAt: ...,
