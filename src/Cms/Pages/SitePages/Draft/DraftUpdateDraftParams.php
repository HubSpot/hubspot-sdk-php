...
namespace HubSpotSDK\Cms\Pages\SitePages\Draft;
 ...
 *
 * @see HubSpotSDK\Services\Cms\Pages\SitePages\DraftService::updateDraft()
 *
 * @phpstan-import-type ContentLanguageVariationShape from \HubSpotSDK\Cms\ContentLanguageVariation
 *
 * @phpstan-type DraftUpdateDraftParamsShape = array{
 *   id: string,
 ...
 * }
 */
final class DraftUpdateDraftParams implements BaseModel
{
    /** @use SdkModel<DraftUpdateDraftParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new DraftUpdateDraftParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * DraftUpdateDraftParams::with(
     *   id: ...,
     *   abStatus: ...,
     *   abTestID: ...,
     *   archivedAt: ...,
