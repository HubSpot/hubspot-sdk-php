...
/**
 * @see HubSpotSDK\Services\Cms\PagesService::getLandingPageFolders()
 *
 * @phpstan-type PageGetLandingPageFoldersParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class PageGetLandingPageFoldersParams implements BaseModel
{
    /** @use SdkModel<PageGetLandingPageFoldersParamsShape> */
    use SdkModel;
    use SdkParams;
