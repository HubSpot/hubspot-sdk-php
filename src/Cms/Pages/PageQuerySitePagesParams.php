...
/**
 * @see HubspotSDK\Services\Cms\PagesService::querySitePages()
 *
 * @phpstan-type PageQuerySitePagesParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class PageQuerySitePagesParams implements BaseModel
{
    /** @use SdkModel<PageQuerySitePagesParamsShape> */
    use SdkModel;
    use SdkParams;
