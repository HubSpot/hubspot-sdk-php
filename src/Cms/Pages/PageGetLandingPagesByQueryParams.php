...
/**
 * @see HubSpotSDK\Services\Cms\PagesService::getLandingPagesByQuery()
 *
 * @phpstan-type PageGetLandingPagesByQueryParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class PageGetLandingPagesByQueryParams implements BaseModel
{
    /** @use SdkModel<PageGetLandingPagesByQueryParamsShape> */
    use SdkModel;
    use SdkParams;
