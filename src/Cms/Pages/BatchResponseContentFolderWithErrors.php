...
use HubspotSDK\Cms\Pages\BatchResponseContentFolderWithErrors\Status;
...
final class BatchResponseContentFolderWithErrors implements BaseModel
{
    ...
    /**
     * `new BatchResponseContentFolderWithErrors()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BatchResponseContentFolderWithErrors::with(
     ...
     *
     * ```
     * (new BatchResponseContentFolderWithErrors)
     *   ->withCompletedAt(...)
     *   ->withResults(...)
     *   ->withStartedAt(...)
     *   ->withStatus(...)
