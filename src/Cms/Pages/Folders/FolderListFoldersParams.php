 ...
 *
 * @see HubspotSDK\Services\Cms\Pages\FoldersService::listFolders()
 *
 * @phpstan-type FolderListFoldersParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class FolderListFoldersParams implements BaseModel
{
    /** @use SdkModel<FolderListFoldersParamsShape> */
    use SdkModel;
    use SdkParams;
