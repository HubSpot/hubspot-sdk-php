 ...
 *
 * @see HubspotSDK\Services\Cms\Pages\FoldersService::createFolder()
 *
 * @phpstan-type FolderCreateFolderParamsShape = array{
 *   id: string,
 *   category: int,
 ...
 * }
 */
final class FolderCreateFolderParams implements BaseModel
{
    /** @use SdkModel<FolderCreateFolderParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new FolderCreateFolderParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * FolderCreateFolderParams::with(
     *   id: ...,
     *   category: ...,
     *   created: ...,
     *   deletedAt: ...,
