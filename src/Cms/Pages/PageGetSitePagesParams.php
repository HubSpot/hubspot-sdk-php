...
/**
 * @see HubspotSDK\Services\Cms\PagesService::getSitePages()
 *
 * @phpstan-type PageGetSitePagesParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class PageGetSitePagesParams implements BaseModel
{
    /** @use SdkModel<PageGetSitePagesParamsShape> */
    use SdkModel;
    use SdkParams;
