 ...
 * Example usage:
 * ```
 * $params = (new PostUpdateDraftParams); // set properties as needed
 * $client->cms.blogs.posts->updateDraft(...$params->toArray());
 * ```
...
final class PostUpdateDraftParams implements BaseModel
{
    ...
    /**
     * `new PostUpdateDraftParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * PostUpdateDraftParams::with(
     *   id: ...,
     *   abStatus: ...,
     *   abTestID: ...,
     *   archivedAt: ...,
