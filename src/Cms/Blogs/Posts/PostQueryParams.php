...
/**
 * @see HubSpotSDK\Services\Cms\Blogs\PostsService::query()
 *
 * @phpstan-type PostQueryParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class PostQueryParams implements BaseModel
{
    /** @use SdkModel<PostQueryParamsShape> */
    use SdkModel;
    use SdkParams;
