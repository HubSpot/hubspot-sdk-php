...
/**
 * @see HubSpotSDK\Services\Cms\Blogs\PostsService::queryAuthors()
 *
 * @phpstan-type PostQueryAuthorsParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class PostQueryAuthorsParams implements BaseModel
{
    /** @use SdkModel<PostQueryAuthorsParamsShape> */
    use SdkModel;
    use SdkParams;
