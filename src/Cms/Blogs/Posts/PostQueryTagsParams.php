...
/**
 * @see HubSpotSDK\Services\Cms\Blogs\PostsService::queryTags()
 *
 * @phpstan-type PostQueryTagsParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class PostQueryTagsParams implements BaseModel
{
    /** @use SdkModel<PostQueryTagsParamsShape> */
    use SdkModel;
    use SdkParams;
