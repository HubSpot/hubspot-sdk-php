...
/**
 * @see HubspotSDK\Services\Cms\Blogs\PostsService::listAuthors()
 *
 * @phpstan-type PostListAuthorsParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class PostListAuthorsParams implements BaseModel
{
    /** @use SdkModel<PostListAuthorsParamsShape> */
    use SdkModel;
    use SdkParams;
