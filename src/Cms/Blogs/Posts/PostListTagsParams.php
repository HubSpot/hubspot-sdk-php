...
/**
 * @see HubSpotSDK\Services\Cms\Blogs\PostsService::listTags()
 *
 * @phpstan-type PostListTagsParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class PostListTagsParams implements BaseModel
{
    /** @use SdkModel<PostListTagsParamsShape> */
    use SdkModel;
    use SdkParams;
