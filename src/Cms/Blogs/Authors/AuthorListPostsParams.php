...
/**
 * @see HubspotSDK\Services\Cms\Blogs\AuthorsService::listPosts()
 *
 * @phpstan-type AuthorListPostsParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class AuthorListPostsParams implements BaseModel
{
    /** @use SdkModel<AuthorListPostsParamsShape> */
    use SdkModel;
    use SdkParams;
