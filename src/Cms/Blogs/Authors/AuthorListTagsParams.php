...
/**
 * @see HubspotSDK\Services\Cms\Blogs\AuthorsService::listTags()
 *
 * @phpstan-type AuthorListTagsParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class AuthorListTagsParams implements BaseModel
{
    /** @use SdkModel<AuthorListTagsParamsShape> */
    use SdkModel;
    use SdkParams;
