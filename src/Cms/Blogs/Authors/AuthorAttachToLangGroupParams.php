 ...
 *
 * @see HubspotSDK\Cms\Blogs\Authors->attachToLangGroup
 *
 * @phpstan-type author_attach_to_lang_group_params = array{
...
{
    /** @use SdkModel<author_attach_to_lang_group_params> */
    use SdkModel;
    use SdkParams;
