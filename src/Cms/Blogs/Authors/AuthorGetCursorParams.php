...
/**
 * @see HubSpotSDK\Services\Cms\Blogs\AuthorsService::getCursor()
 *
 * @phpstan-type AuthorGetCursorParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class AuthorGetCursorParams implements BaseModel
{
    /** @use SdkModel<AuthorGetCursorParamsShape> */
    use SdkModel;
    use SdkParams;
