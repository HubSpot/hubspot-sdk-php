...
/**
 * @see HubSpotSDK\Services\Cms\Blogs\TagsService::listAuthorsCursor()
 *
 * @phpstan-type TagListAuthorsCursorParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class TagListAuthorsCursorParams implements BaseModel
{
    /** @use SdkModel<TagListAuthorsCursorParamsShape> */
    use SdkModel;
    use SdkParams;
