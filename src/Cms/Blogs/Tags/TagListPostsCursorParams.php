...
/**
 * @see HubSpotSDK\Services\Cms\Blogs\TagsService::listPostsCursor()
 *
 * @phpstan-type TagListPostsCursorParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class TagListPostsCursorParams implements BaseModel
{
    /** @use SdkModel<TagListPostsCursorParamsShape> */
    use SdkModel;
    use SdkParams;
