...
/**
 * @see HubspotSDK\Services\Cms\Blogs\TagsService::listCursor()
 *
 * @phpstan-type TagListCursorParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class TagListCursorParams implements BaseModel
{
    /** @use SdkModel<TagListCursorParamsShape> */
    use SdkModel;
    use SdkParams;
