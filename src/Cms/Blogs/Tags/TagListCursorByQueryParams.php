...
/**
 * @see HubspotSDK\Services\Cms\Blogs\TagsService::listCursorByQuery()
 *
 * @phpstan-type TagListCursorByQueryParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class TagListCursorByQueryParams implements BaseModel
{
    /** @use SdkModel<TagListCursorByQueryParamsShape> */
    use SdkModel;
    use SdkParams;
