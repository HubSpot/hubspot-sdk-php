...
/**
 * @see HubspotSDK\Services\Cms\Blogs\TagsService::listPostsCursorByQuery()
 *
 * @phpstan-type TagListPostsCursorByQueryParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class TagListPostsCursorByQueryParams implements BaseModel
{
    /** @use SdkModel<TagListPostsCursorByQueryParamsShape> */
    use SdkModel;
    use SdkParams;
