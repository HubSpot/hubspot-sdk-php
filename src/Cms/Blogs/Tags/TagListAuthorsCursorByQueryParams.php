...
/**
 * @see HubSpotSDK\Services\Cms\Blogs\TagsService::listAuthorsCursorByQuery()
 *
 * @phpstan-type TagListAuthorsCursorByQueryParamsShape = array{
 *   after?: string|null,
 *   archived?: bool|null,
 ...
 * }
 */
final class TagListAuthorsCursorByQueryParams implements BaseModel
{
    /** @use SdkModel<TagListAuthorsCursorByQueryParamsShape> */
    use SdkModel;
    use SdkParams;
