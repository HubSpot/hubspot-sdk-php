...
final class CmsDomainsCollectionResponseWithTotalDomainForwardPaging implements BaseModel, ResponseConverter
{
    ...
    /**
     * `new CmsDomainsCollectionResponseWithTotalDomainForwardPaging()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CmsDomainsCollectionResponseWithTotalDomainForwardPaging::with(
     *   results: ..., total: ...
     * )
     * ```
     *
     ...
     *
     * ```
     * (new CmsDomainsCollectionResponseWithTotalDomainForwardPaging)
     *   ->withResults(...)
     *   ->withTotal(...)
     * ```
     */
     ...
     *
     * @param list<CmsDomainsDomain> $results
     */
