...
use HubspotSDK\Cms\MediaBridge\And\Input;
use HubspotSDK\Cms\MediaBridge\And\Operator;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
  * @phpstan-type and_alias = array{
  ...
  * 
 */
final class And implements BaseModel
{
  /** @use SdkModel<and_alias> */
  use SdkModel;
 ...
 */
  ...
  /**
  * `new And()` is missing required properties by the API.
  * 
  * To enforce required parameters use
  * ```
  * And::with(enclosedInParentheses: ..., operator: ...)
  * ```
  * 
  * Otherwise ensure the following setters are called
  * 
  * ```
  * (new And)->withEnclosedInParentheses(...)->withOperator(...)
  * ```
 */
