...
use HubspotSDK\Cms\MediaBridge\MinNumbers\Input;
use HubspotSDK\Cms\MediaBridge\MinNumbers\Operator;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type MinNumbersShape = array{
 ...
 * }
 */
final class MinNumbers implements BaseModel
{
    /** @use SdkModel<MinNumbersShape> */
    use SdkModel;
    ...
    /**
     * `new MinNumbers()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MinNumbers::with(operator: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new MinNumbers)->withOperator(...)
     * ```
     */
    ...
    public static function with(
        Operator|string $operator = 'MIN_NUMBERS',
        ?array $inputs = null,
