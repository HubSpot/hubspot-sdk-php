...
use HubspotSDK\Cms\MediaBridge\CreateDocumentObjectRequest\MediaType;
...
/**
 * @phpstan-type CreateDocumentObjectRequestShape = array{
 ...
 * }
 */
final class CreateDocumentObjectRequest implements BaseModel
{
    /** @use SdkModel<CreateDocumentObjectRequestShape> */
    use SdkModel;
    ...
    /**
     * `new CreateDocumentObjectRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CreateDocumentObjectRequest::with(mediaType: ..., title: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new CreateDocumentObjectRequest)->withMediaType(...)->withTitle(...)
     * ```
     */
