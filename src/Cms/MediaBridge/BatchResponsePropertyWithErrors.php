...
use HubspotSDK\Cms\MediaBridge\BatchResponsePropertyWithErrors\Status;
 ...
 *   results: list<\HubspotSDK\Property|PropertyShape>,
...
final class BatchResponsePropertyWithErrors implements BaseModel
{
    ...
    /**
     * `new BatchResponsePropertyWithErrors()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BatchResponsePropertyWithErrors::with(
     ...
     *
     * ```
     * (new BatchResponsePropertyWithErrors)
     *   ->withCompletedAt(...)
     *   ->withResults(...)
     *   ->withStartedAt(...)
     *   ->withStatus(...)
