...
use HubspotSDK\Cms\MediaBridge\CreateOtherObjectRequest\MediaType;
...
/**
 * @phpstan-type CreateOtherObjectRequestShape = array{
 ...
 * }
 */
final class CreateOtherObjectRequest implements BaseModel
{
    /** @use SdkModel<CreateOtherObjectRequestShape> */
    use SdkModel;
    ...
    /**
     * `new CreateOtherObjectRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CreateOtherObjectRequest::with(mediaType: ..., title: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new CreateOtherObjectRequest)->withMediaType(...)->withTitle(...)
     * ```
     */
