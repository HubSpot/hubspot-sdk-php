...
use HubspotSDK\Cms\MediaBridge\LowerCase\Input;
use HubspotSDK\Cms\MediaBridge\LowerCase\Operator;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type LowerCaseShape = array{
 ...
 * }
 */
final class LowerCase implements BaseModel
{
    /** @use SdkModel<LowerCaseShape> */
    use SdkModel;
    ...
    /**
     * `new LowerCase()` is missing required properties by the API.
     *
    ...
    public static function with(
        Operator|string $operator = 'LOWER_CASE',
        ?array $inputs = null,
