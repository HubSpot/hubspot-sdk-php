...
use HubspotSDK\Cms\MediaBridge\MaxNumbers\Input;
use HubspotSDK\Cms\MediaBridge\MaxNumbers\Operator;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type MaxNumbersShape = array{
 ...
 * }
 */
final class MaxNumbers implements BaseModel
{
    /** @use SdkModel<MaxNumbersShape> */
    use SdkModel;
    ...
    /**
     * `new MaxNumbers()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MaxNumbers::with(operator: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new MaxNumbers)->withOperator(...)
     * ```
     */
    ...
    public static function with(
        Operator|string $operator = 'MAX_NUMBERS',
        ?array $inputs = null,
