 ...
 *
 * @see HubspotSDK\Services\Cms\MediaBridgeService::updateOembedDomain()
 *
...
{
    /** @use SdkModel<MediaBridgeUpdateOembedDomainParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new MediaBridgeUpdateOembedDomainParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MediaBridgeUpdateOembedDomainParams::with(appID: ..., endpoints: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new MediaBridgeUpdateOembedDomainParams)->withAppID(...)->withEndpoints(...)
     * ```
     */
