...
use HubspotSDK\Cms\MediaBridge\UpdateOtherObjectRequest\MediaType;
...
/**
 * @phpstan-type UpdateOtherObjectRequestShape = array{
 ...
 * }
 */
final class UpdateOtherObjectRequest implements BaseModel
{
    /** @use SdkModel<UpdateOtherObjectRequestShape> */
    use SdkModel;
    ...
    /**
     * `new UpdateOtherObjectRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * UpdateOtherObjectRequest::with(mediaType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new UpdateOtherObjectRequest)->withMediaType(...)
     * ```
     */
