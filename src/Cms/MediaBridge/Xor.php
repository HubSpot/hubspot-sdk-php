...
use HubspotSDK\Cms\MediaBridge\Xor\Input;
use HubspotSDK\Cms\MediaBridge\Xor\Operator;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
  * @phpstan-type xor_alias = array{
  ...
  * 
 */
final class Xor implements BaseModel
{
  /** @use SdkModel<xor_alias> */
  use SdkModel;
 ...
 */
  ...
  /**
  * `new Xor()` is missing required properties by the API.
  * 
  * To enforce required parameters use
  * ```
  * Xor::with(enclosedInParentheses: ..., operator: ...)
  * ```
  * 
  * Otherwise ensure the following setters are called
  * 
  * ```
  * (new Xor)->withEnclosedInParentheses(...)->withOperator(...)
  * ```
 */
