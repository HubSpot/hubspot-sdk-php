...
use HubspotSDK\Cms\MediaBridge\UpdateImageObjectRequest\MediaType;
...
/**
 * @phpstan-type UpdateImageObjectRequestShape = array{
 ...
 * }
 */
final class UpdateImageObjectRequest implements BaseModel
{
    /** @use SdkModel<UpdateImageObjectRequestShape> */
    use SdkModel;
    ...
    /**
     * `new UpdateImageObjectRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * UpdateImageObjectRequest::with(mediaType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new UpdateImageObjectRequest)->withMediaType(...)
     * ```
     */
