...
use HubspotSDK\Cms\MediaBridge\Year\Input;
use HubspotSDK\Cms\MediaBridge\Year\Operator;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type year_alias = array{
 ...
 * }
 */
final class Year implements BaseModel
{
    /** @use SdkModel<year_alias> */
    use SdkModel;
    ...
    /**
     * `new Year()` is missing required properties by the API.
     *
