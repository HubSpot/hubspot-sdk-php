...
use HubspotSDK\Cms\MediaBridge\BooleanTargetPropertyVariable\Input;
...
/**
 * @phpstan-type boolean_target_property_variable = array{
...
{
    /** @use SdkModel<boolean_target_property_variable> */
    use SdkModel;
