...
use HubspotSDK\Cms\MediaBridge\Now\Input;
use HubspotSDK\Cms\MediaBridge\Now\Operator;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type now_alias = array{
 ...
 * }
 */
final class Now implements BaseModel
{
    /** @use SdkModel<now_alias> */
    use SdkModel;
    ...
    /**
     * `new Now()` is missing required properties by the API.
     *
