...
use HubspotSDK\Cms\MediaBridge\StringLength\Input;
use HubspotSDK\Cms\MediaBridge\StringLength\Operator;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type StringLengthShape = array{
 ...
 * }
 */
final class StringLength implements BaseModel
{
    /** @use SdkModel<StringLengthShape> */
    use SdkModel;
    ...
    /**
     * `new StringLength()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * StringLength::with(operator: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new StringLength)->withOperator(...)
     * ```
     */
    ...
    public static function with(
        Operator|string $operator = 'STRING_LENGTH',
        ?array $inputs = null,
