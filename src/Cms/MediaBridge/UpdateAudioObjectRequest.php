...
use HubspotSDK\Cms\MediaBridge\UpdateAudioObjectRequest\MediaType;
...
/**
 * @phpstan-type UpdateAudioObjectRequestShape = array{
 ...
 * }
 */
final class UpdateAudioObjectRequest implements BaseModel
{
    /** @use SdkModel<UpdateAudioObjectRequestShape> */
    use SdkModel;
    ...
    /**
     * `new UpdateAudioObjectRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * UpdateAudioObjectRequest::with(mediaType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new UpdateAudioObjectRequest)->withMediaType(...)
     * ```
     */
