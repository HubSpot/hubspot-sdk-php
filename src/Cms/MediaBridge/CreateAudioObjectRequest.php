...
use HubspotSDK\Cms\MediaBridge\CreateAudioObjectRequest\MediaType;
...
/**
 * @phpstan-type CreateAudioObjectRequestShape = array{
 ...
 * }
 */
final class CreateAudioObjectRequest implements BaseModel
{
    /** @use SdkModel<CreateAudioObjectRequestShape> */
    use SdkModel;
    ...
    /**
     * `new CreateAudioObjectRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CreateAudioObjectRequest::with(mediaType: ..., title: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new CreateAudioObjectRequest)->withMediaType(...)->withTitle(...)
     * ```
     */
