...
use HubspotSDK\Cms\MediaBridge\DivideNumbers\Input;
use HubspotSDK\Cms\MediaBridge\DivideNumbers\Operator;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type DivideNumbersShape = array{
 ...
 * }
 */
final class DivideNumbers implements BaseModel
{
    /** @use SdkModel<DivideNumbersShape> */
    use SdkModel;
    ...
    /**
     * `new DivideNumbers()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * DivideNumbers::with(enclosedInParentheses: ..., operator: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new DivideNumbers)->withEnclosedInParentheses(...)->withOperator(...)
     * ```
     */
    ...
    public static function with(
        ...
        Operator|string $operator = 'DIVIDE_NUMBERS',
        ?array $inputs = null,
