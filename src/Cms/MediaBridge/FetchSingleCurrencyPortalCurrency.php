...
use HubspotSDK\Cms\MediaBridge\FetchSingleCurrencyPortalCurrency\Input;
use HubspotSDK\Cms\MediaBridge\FetchSingleCurrencyPortalCurrency\Operator;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type FetchSingleCurrencyPortalCurrencyShape = array{
 ...
 * }
 */
final class FetchSingleCurrencyPortalCurrency implements BaseModel
{
    /** @use SdkModel<FetchSingleCurrencyPortalCurrencyShape> */
    use SdkModel;
    ...
    /**
     * `new FetchSingleCurrencyPortalCurrency()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * FetchSingleCurrencyPortalCurrency::with(operator: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new FetchSingleCurrencyPortalCurrency)->withOperator(...)
     * ```
     */
    ...
    public static function with(
        Operator|string $operator = 'FETCH_SINGLE_CURRENCY_PORTAL_CURRENCY',
        ?array $inputs = null,
