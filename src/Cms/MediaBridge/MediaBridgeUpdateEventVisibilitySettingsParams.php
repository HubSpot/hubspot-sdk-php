 ...
 *
 * @see HubSpotSDK\Services\Cms\MediaBridgeService::updateEventVisibilitySettings()
 *
 * @phpstan-type MediaBridgeUpdateEventVisibilitySettingsParamsShape = array{
 ...
 * }
 */
final class MediaBridgeUpdateEventVisibilitySettingsParams implements BaseModel
{
    /** @use SdkModel<MediaBridgeUpdateEventVisibilitySettingsParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new MediaBridgeUpdateEventVisibilitySettingsParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MediaBridgeUpdateEventVisibilitySettingsParams::with(
     *   eventType: ..., updatedAt: ...
     * )
     * ```
     *
     ...
     *
     * ```
     * (new MediaBridgeUpdateEventVisibilitySettingsParams)
     *   ->withEventType(...)
     *   ->withUpdatedAt(...)
     * ```
     */
