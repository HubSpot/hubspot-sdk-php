...
use HubSpotSDK\Cms\MediaBridge\SubtractTime\Input;
use HubSpotSDK\Cms\MediaBridge\SubtractTime\Operator;
...
/**
 * @phpstan-import-type StringToCheckVariants from \HubSpotSDK\Cms\MediaBridge\SubtractTime\StringToCheck
 * @phpstan-import-type StringToCheckShape from \HubSpotSDK\Cms\MediaBridge\SubtractTime\StringToCheck
 *
 * @phpstan-type SubtractTimeShape = array{
 ...
 * }
 */
final class SubtractTime implements BaseModel
{
    /** @use SdkModel<SubtractTimeShape> */
    use SdkModel;
    ...
    /**
     * `new SubtractTime()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SubtractTime::with(operator: ..., stringToCheck: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new SubtractTime)->withOperator(...)->withStringToCheck(...)
     * ```
     */
    ...
    public static function with(
        ...
        Operator|string $operator = 'SUBTRACT_TIME',
        ?array $inputs = null,
