...
use HubSpotSDK\Cms\MediaBridge\MediaBridgeProperty\DataSensitivity;
use HubSpotSDK\Cms\MediaBridge\MediaBridgeProperty\DateDisplayHint;
use HubSpotSDK\Cms\MediaBridge\MediaBridgeProperty\DisplayMode;
use HubSpotSDK\Cms\MediaBridge\MediaBridgeProperty\NumberDisplayHint;
use HubSpotSDK\Cms\MediaBridge\MediaBridgeProperty\OptionSortStrategy;
use HubSpotSDK\Cms\MediaBridge\MediaBridgeProperty\ReferencedObjectType;
use HubSpotSDK\Cms\MediaBridge\MediaBridgeProperty\SearchTextAnalysisMode;
use HubSpotSDK\Cms\MediaBridge\MediaBridgeProperty\TextDisplayHint;
use HubSpotSDK\Cms\MediaBridge\MediaBridgeProperty\Type;
 ...
 *
 * @phpstan-type MediaBridgePropertyShape = array{
 ...
 * }
 */
final class MediaBridgeProperty implements BaseModel
{
    /** @use SdkModel<MediaBridgePropertyShape> */
    use SdkModel;
    ...
    /**
     * `new MediaBridgeProperty()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MediaBridgeProperty::with(
     *   allowedObjectTypes: ...,
     *   calculated: ...,
     *   canArchive: ...,
     *   canRestore: ...,
