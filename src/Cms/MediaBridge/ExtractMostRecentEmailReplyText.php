...
use HubspotSDK\Cms\MediaBridge\ExtractMostRecentEmailReplyText\Input;
...
/**
 * @phpstan-type extract_most_recent_email_reply_text = array{
...
{
    /** @use SdkModel<extract_most_recent_email_reply_text> */
    use SdkModel;
