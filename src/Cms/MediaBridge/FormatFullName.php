...
use HubspotSDK\Cms\MediaBridge\FormatFullName\Input;
use HubspotSDK\Cms\MediaBridge\FormatFullName\Operator;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type format_full_name = array{
 ...
 * }
 */
final class FormatFullName implements BaseModel
{
    /** @use SdkModel<format_full_name> */
    use SdkModel;
    ...
    /**
     * `new FormatFullName()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * FormatFullName::with(operator: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new FormatFullName)->withOperator(...)
     * ```
     */
    ...
    public static function with(
        Operator|string $operator = 'FORMAT_FULL_NAME',
        ?array $inputs = null,
