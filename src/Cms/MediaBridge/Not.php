...
use HubspotSDK\Cms\MediaBridge\Not\Input;
use HubspotSDK\Cms\MediaBridge\Not\Operator;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type not_alias = array{
 ...
 * }
 */
final class Not implements BaseModel
{
    /** @use SdkModel<not_alias> */
    use SdkModel;
    ...
    /**
     * `new Not()` is missing required properties by the API.
     *
