...
use HubspotSDK\Cms\MediaBridge\Date\Input;
use HubspotSDK\Cms\MediaBridge\Date\Operator;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type date_alias = array{
...
final class Date implements BaseModel
{
    ...
    /**
     * `new Date()` is missing required properties by the API.
     *
