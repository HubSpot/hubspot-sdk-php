...
use HubspotSDK\Cms\MediaBridge\ConstantBoolean\Input;
use HubspotSDK\Cms\MediaBridge\ConstantBoolean\Operator;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type ConstantBooleanShape = array{
 ...
 * }
 */
final class ConstantBoolean implements BaseModel
{
    /** @use SdkModel<ConstantBooleanShape> */
    use SdkModel;
    ...
    /**
     * `new ConstantBoolean()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ConstantBoolean::with(operator: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ConstantBoolean)->withOperator(...)
     * ```
     */
    ...
    public static function with(
        Operator|string $operator = 'CONSTANT_BOOLEAN',
        ?array $inputs = null,
