...
use HubspotSDK\Cms\MediaBridge\Or\Input;
use HubspotSDK\Cms\MediaBridge\Or\Operator;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
  * @phpstan-type or_alias = array{
  ...
  * 
 */
final class Or implements BaseModel
{
  /** @use SdkModel<or_alias> */
  use SdkModel;
 ...
 */
  ...
  /**
  * `new Or()` is missing required properties by the API.
  * 
  * To enforce required parameters use
  * ```
  * Or::with(enclosedInParentheses: ..., operator: ...)
  * ```
  * 
  * Otherwise ensure the following setters are called
  * 
  * ```
  * (new Or)->withEnclosedInParentheses(...)->withOperator(...)
  * ```
 */
