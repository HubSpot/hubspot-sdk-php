...
use HubspotSDK\Cms\MediaBridge\SquareRoot\Input;
use HubspotSDK\Cms\MediaBridge\SquareRoot\Operator;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type SquareRootShape = array{
 ...
 * }
 */
final class SquareRoot implements BaseModel
{
    /** @use SdkModel<SquareRootShape> */
    use SdkModel;
    ...
    /**
     * `new SquareRoot()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SquareRoot::with(operator: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new SquareRoot)->withOperator(...)
     * ```
     */
    ...
    public static function with(
        Operator|string $operator = 'SQUARE_ROOT',
        ?array $inputs = null,
