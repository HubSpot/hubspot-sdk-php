...
use HubspotSDK\Cms\MediaBridge\TimestampOfPropertyVariable\Input;
...
/**
 * @phpstan-type timestamp_of_property_variable = array{
...
{
    /** @use SdkModel<timestamp_of_property_variable> */
    use SdkModel;
