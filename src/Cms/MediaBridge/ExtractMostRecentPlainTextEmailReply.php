...
use HubspotSDK\Cms\MediaBridge\ExtractMostRecentPlainTextEmailReply\Input;
use HubspotSDK\Cms\MediaBridge\ExtractMostRecentPlainTextEmailReply\Operator;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type extract_most_recent_plain_text_email_reply = array{
 ...
 * }
 */
final class ExtractMostRecentPlainTextEmailReply implements BaseModel
{
    /** @use SdkModel<extract_most_recent_plain_text_email_reply> */
    use SdkModel;
    ...
    /**
     * `new ExtractMostRecentPlainTextEmailReply()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ExtractMostRecentPlainTextEmailReply::with(operator: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ExtractMostRecentPlainTextEmailReply)->withOperator(...)
     * ```
     */
    ...
    public static function with(
        Operator|string $operator = 'EXTRACT_MOST_RECENT_PLAIN_TEXT_EMAIL_REPLY',
        ?array $inputs = null,
