...
use HubspotSDK\Cms\MediaBridge\StringTargetPropertyVariable\Input;
...
/**
 * @phpstan-type StringTargetPropertyVariableShape = array{
 ...
 * }
 */
final class StringTargetPropertyVariable implements BaseModel
{
    /** @use SdkModel<StringTargetPropertyVariableShape> */
    use SdkModel;
    ...
    /**
     * `new StringTargetPropertyVariable()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * StringTargetPropertyVariable::with(operator: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new StringTargetPropertyVariable)->withOperator(...)
     * ```
     */
    ...
    public static function with(
        Operator|string $operator = 'STRING_TARGET_PROPERTY_VARIABLE',
        ?array $inputs = null,
