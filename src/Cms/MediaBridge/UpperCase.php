...
use HubspotSDK\Cms\MediaBridge\UpperCase\Input;
use HubspotSDK\Cms\MediaBridge\UpperCase\Operator;
use HubspotSDK\Core\Attributes\Api;
use HubspotSDK\Core\Concerns\SdkModel;
use HubspotSDK\Core\Contracts\BaseModel;

/**
 * @phpstan-type UpperCaseShape = array{
 ...
 * }
 */
final class UpperCase implements BaseModel
{
    /** @use SdkModel<UpperCaseShape> */
    use SdkModel;
    ...
    /**
     * `new UpperCase()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * UpperCase::with(operator: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new UpperCase)->withOperator(...)
     * ```
     */
    ...
    public static function with(
        Operator|string $operator = 'UPPER_CASE',
        ?array $inputs = null,
