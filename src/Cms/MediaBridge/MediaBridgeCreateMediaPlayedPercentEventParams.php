...
use HubspotSDK\Cms\MediaBridge\MediaBridgeCreateMediaPlayedPercentEventParams\ExternalPlayContext;
use HubspotSDK\Cms\MediaBridge\MediaBridgeCreateMediaPlayedPercentEventParams\MediaType;
 ...
 *
 * @see HubspotSDK\Services\Cms\MediaBridgeService::createMediaPlayedPercentEvent()
 *
 * @phpstan-type MediaBridgeCreateMediaPlayedPercentEventParamsShape = array{
 ...
 * }
 */
final class MediaBridgeCreateMediaPlayedPercentEventParams implements BaseModel
{
    /** @use SdkModel<MediaBridgeCreateMediaPlayedPercentEventParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new MediaBridgeCreateMediaPlayedPercentEventParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MediaBridgeCreateMediaPlayedPercentEventParams::with(
     ...
     *
     * ```
     * (new MediaBridgeCreateMediaPlayedPercentEventParams)
     *   ->withMediaType(...)
