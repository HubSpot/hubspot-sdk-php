 ...
 * Example usage:
 * ```
 * $params = (new HubdbCreateTableParams); // set properties as needed
 * $client->cms.hubdb->createTable(...$params->toArray());
 * ```
 * Create a new table.
 *
 * @method toArray()
 ...
 *   `$client->cms.hubdb->createTable(...$params->toArray());`
 *
 * @see HubspotSDK\Cms\Hubdb->createTable
 *
 * @phpstan-type hubdb_create_table_params = array{
 *   label: string,
 *   name: string,
 ...
 * }
 */
final class HubdbCreateTableParams implements BaseModel
{
    /** @use SdkModel<hubdb_create_table_params> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new HubdbCreateTableParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * HubdbCreateTableParams::with(label: ..., name: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new HubdbCreateTableParams)->withLabel(...)->withName(...)
     * ```
     */
