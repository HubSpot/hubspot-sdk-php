...
/**
 * @phpstan-type cms_hubdb_hub_db_table_v3_request = array{
 *   label: string,
 *   name: string,
 ...
 * }
 */
final class CmsHubdbHubDBTableV3Request implements BaseModel
{
    /** @use SdkModel<cms_hubdb_hub_db_table_v3_request> */
    use SdkModel;
    ...
    /**
     * `new CmsHubdbHubDBTableV3Request()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CmsHubdbHubDBTableV3Request::with(label: ..., name: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new CmsHubdbHubDBTableV3Request)->withLabel(...)->withName(...)
     * ```
     */
