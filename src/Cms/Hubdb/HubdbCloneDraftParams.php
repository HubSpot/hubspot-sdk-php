 ...
 * Example usage:
 * ```
 * $params = (new HubdbCloneDraftParams); // set properties as needed
 * $client->cms.hubdb->cloneDraft(...$params->toArray());
 * ```
 ...
 *   `$client->cms.hubdb->cloneDraft(...$params->toArray());`
 *
 * @see HubspotSDK\Cms\Hubdb->cloneDraft
 *
 * @phpstan-type hubdb_clone_draft_params = array{
 *   copyRows: bool, isHubspotDefined: bool, newLabel?: string, newName?: string
 * }
 */
final class HubdbCloneDraftParams implements BaseModel
{
    /** @use SdkModel<hubdb_clone_draft_params> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new HubdbCloneDraftParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * HubdbCloneDraftParams::with(copyRows: ..., isHubspotDefined: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new HubdbCloneDraftParams)->withCopyRows(...)->withIsHubspotDefined(...)
     * ```
     */
