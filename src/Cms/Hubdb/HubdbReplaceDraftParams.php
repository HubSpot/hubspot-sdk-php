 ...
 * Example usage:
 * ```
 * $params = (new HubdbReplaceDraftParams); // set properties as needed
 * $client->cms.hubdb->replaceDraft(...$params->toArray());
 * ```
 ...
 *   `$client->cms.hubdb->replaceDraft(...$params->toArray());`
 *
 * @see HubspotSDK\Cms\Hubdb->replaceDraft
 *
 * @phpstan-type hubdb_replace_draft_params = array{
 ...
 * }
 */
final class HubdbReplaceDraftParams implements BaseModel
{
    /** @use SdkModel<hubdb_replace_draft_params> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new HubdbReplaceDraftParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * HubdbReplaceDraftParams::with(tableIDOrName: ..., values: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new HubdbReplaceDraftParams)->withTableIDOrName(...)->withValues(...)
     * ```
     */
