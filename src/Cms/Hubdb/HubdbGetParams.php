 ...
 * Example usage:
 * ```
 * $params = (new HubdbGetParams); // set properties as needed
 * $client->cms.hubdb->get(...$params->toArray());
 * ```
 ...
 *   `$client->cms.hubdb->get(...$params->toArray());`
 *
 * @see HubspotSDK\Cms\Hubdb->get
 *
 * @phpstan-type hubdb_get_params = array{
 *   archived?: bool, includeForeignIDs?: bool, isGetLocalizedSchema?: bool
 * }
 */
final class HubdbGetParams implements BaseModel
{
    /** @use SdkModel<hubdb_get_params> */
    use SdkModel;
    use SdkParams;
