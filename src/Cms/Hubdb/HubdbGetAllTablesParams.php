 ...
 *   `$client->cms.hubdb->getAllTables(...$params->toArray());`
 *
 * @see HubspotSDK\Cms\Hubdb->getAllTables
 *
 * @phpstan-type hubdb_get_all_tables_params = array{
 *   after?: string,
 *   archived?: bool,
 *   contentType?: string,
 ...
 * }
 */
final class HubdbGetAllTablesParams implements BaseModel
{
    /** @use SdkModel<hubdb_get_all_tables_params> */
    use SdkModel;
    use SdkParams;
