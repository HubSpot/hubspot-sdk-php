 ...
 * Example usage:
 * ```
 * $params = (new HubdbGetAllDraftTablesParams); // set properties as needed
 * $client->cms.hubdb->getAllDraftTables(...$params->toArray());
 * ```
 ...
 *   `$client->cms.hubdb->getAllDraftTables(...$params->toArray());`
 *
 * @see HubspotSDK\Cms\Hubdb->getAllDraftTables
 *
 * @phpstan-type hubdb_get_all_draft_tables_params = array{
 *   after?: string,
 *   archived?: bool,
 *   contentType?: string,
 ...
 * }
 */
final class HubdbGetAllDraftTablesParams implements BaseModel
{
    /** @use SdkModel<hubdb_get_all_draft_tables_params> */
    use SdkModel;
    use SdkParams;
