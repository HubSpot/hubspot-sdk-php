 ...
 * Example usage:
 * ```
 * $params = (new HubdbUpdateDraftTableParams); // set properties as needed
 * $client->cms.hubdb->updateDraftTable(...$params->toArray());
 * ```
 ...
 *   `$client->cms.hubdb->updateDraftTable(...$params->toArray());`
 *
 * @see HubspotSDK\Cms\Hubdb->updateDraftTable
 *
 * @phpstan-type hubdb_update_draft_table_params = array{
 *   label: string,
 *   name: string,
 *   archived?: bool,
 ...
 * }
 */
final class HubdbUpdateDraftTableParams implements BaseModel
{
    /** @use SdkModel<hubdb_update_draft_table_params> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new HubdbUpdateDraftTableParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * HubdbUpdateDraftTableParams::with(label: ..., name: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new HubdbUpdateDraftTableParams)->withLabel(...)->withName(...)
     * ```
     */
