 ...
 * Example usage:
 * ```
 * $params = (new HubdbCreateParams); // set properties as needed
 * $client->cms.hubdb->create(...$params->toArray());
 * ```
 ...
 *   `$client->cms.hubdb->create(...$params->toArray());`
 *
 * @see HubspotSDK\Cms\Hubdb->create
 *
 * @phpstan-type hubdb_create_params = array{
 *   label: string,
 *   name: string,
 ...
 * }
 */
final class HubdbCreateParams implements BaseModel
{
    /** @use SdkModel<hubdb_create_params> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new HubdbCreateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * HubdbCreateParams::with(label: ..., name: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new HubdbCreateParams)->withLabel(...)->withName(...)
     * ```
     */
