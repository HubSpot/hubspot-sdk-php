 ...
 *
 * @see HubspotSDK\Cms\Hubdb->createTableRow
 *
 * @phpstan-type hubdb_create_table_row_params = array{
 ...
 * }
 */
final class HubdbCreateTableRowParams implements BaseModel
{
    /** @use SdkModel<hubdb_create_table_row_params> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new HubdbCreateTableRowParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * HubdbCreateTableRowParams::with(values: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new HubdbCreateTableRowParams)->withValues(...)
     * ```
     */
