 ...
 * Example usage:
 * ```
 * $params = (new HubdbListParams); // set properties as needed
 * $client->cms.hubdb->list(...$params->toArray());
 * ```
 ...
 *   `$client->cms.hubdb->list(...$params->toArray());`
 *
 * @see HubspotSDK\Cms\Hubdb->list
 *
 * @phpstan-type hubdb_list_params = array{
 *   after?: string,
 *   archived?: bool,
 *   contentType?: string,
 ...
 * }
 */
final class HubdbListParams implements BaseModel
{
    /** @use SdkModel<hubdb_list_params> */
    use SdkModel;
    use SdkParams;
