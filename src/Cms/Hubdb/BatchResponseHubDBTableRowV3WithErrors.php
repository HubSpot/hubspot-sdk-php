...
final class BatchResponseHubDBTableRowV3WithErrors implements BaseModel
{
    ...
    /**
     * `new BatchResponseHubDBTableRowV3WithErrors()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BatchResponseHubDBTableRowV3WithErrors::with(
     ...
     *
     * ```
     * (new BatchResponseHubDBTableRowV3WithErrors)
     *   ->withCompletedAt(...)
     *   ->withResults(...)
     *   ->withStartedAt(...)
     *   ->withStatus(...)
