...
/**
 * @phpstan-type cms_hubdb_standard_error = array{
 *   category: string,
 ...
 * }
 */
final class CmsHubdbStandardError implements BaseModel
{
    /** @use SdkModel<cms_hubdb_standard_error> */
    use SdkModel;
    ...
    /**
     * `new CmsHubdbStandardError()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CmsHubdbStandardError::with(
     *   category: ...,
     *   context: ...,
     *   errors: ...,
     *   links: ...,
