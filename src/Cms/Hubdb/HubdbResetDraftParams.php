 ...
 * Example usage:
 * ```
 * $params = (new HubdbResetDraftParams); // set properties as needed
 * $client->cms.hubdb->resetDraft(...$params->toArray());
 * ```
 ...
 *   `$client->cms.hubdb->resetDraft(...$params->toArray());`
 *
 * @see HubspotSDK\Cms\Hubdb->resetDraft
 *
 * @phpstan-type hubdb_reset_draft_params = array{includeForeignIDs?: bool}
 */
final class HubdbResetDraftParams implements BaseModel
{
    /** @use SdkModel<hubdb_reset_draft_params> */
    use SdkModel;
    use SdkParams;
