 ...
 *   `$client->cms.hubdb->updateDraftTableRow(...$params->toArray());`
 *
 * @see HubspotSDK\Cms\Hubdb->updateDraftTableRow
 *
 * @phpstan-type hubdb_update_draft_table_row_params = array{
 ...
 * }
 */
final class HubdbUpdateDraftTableRowParams implements BaseModel
{
    /** @use SdkModel<hubdb_update_draft_table_row_params> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new HubdbUpdateDraftTableRowParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * HubdbUpdateDraftTableRowParams::with(tableIDOrName: ..., values: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new HubdbUpdateDraftTableRowParams)->withTableIDOrName(...)->withValues(...)
     * ```
     */
