...
final class RowUpdateBatchParams implements BaseModel
{
    ...
    /**
     * `new RowUpdateBatchParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * RowUpdateBatchParams::with(inputs: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new RowUpdateBatchParams)->withInputs(...)
     * ```
     */
