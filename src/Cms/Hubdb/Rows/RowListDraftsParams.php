 ...
 * Example usage:
 * ```
 * $params = (new RowListDraftsParams); // set properties as needed
 * $client->cms.hubdb.rows->listDrafts(...$params->toArray());
 * ```
 ...
 *   `$client->cms.hubdb.rows->listDrafts(...$params->toArray());`
 *
 * @see HubspotSDK\Cms\Hubdb\Rows->listDrafts
 *
 * @phpstan-type row_list_drafts_params = array{
 *   after?: string,
 *   archived?: bool,
 *   limit?: int,
 *   offset?: int,
 ...
 * }
 */
final class RowListDraftsParams implements BaseModel
{
    /** @use SdkModel<row_list_drafts_params> */
    use SdkModel;
    use SdkParams;
