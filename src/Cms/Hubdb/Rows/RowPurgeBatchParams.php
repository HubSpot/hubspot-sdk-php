 ...
 */
final class RowPurgeBatchParams implements BaseModel
{
    /** @use SdkModel<RowPurgeBatchParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new RowPurgeBatchParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * RowPurgeBatchParams::with(inputs: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new RowPurgeBatchParams)->withInputs(...)
     * ```
     */
