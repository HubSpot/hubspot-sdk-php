 ...
 *
 * @phpstan-type hubdb_replace_draft_table_row_params = array{
 ...
 * }
 */
final class HubdbReplaceDraftTableRowParams implements BaseModel
{
    /** @use SdkModel<hubdb_replace_draft_table_row_params> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new HubdbReplaceDraftTableRowParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * HubdbReplaceDraftTableRowParams::with(tableIDOrName: ..., values: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new HubdbReplaceDraftTableRowParams)->withTableIDOrName(...)->withValues(...)
     * ```
     */
