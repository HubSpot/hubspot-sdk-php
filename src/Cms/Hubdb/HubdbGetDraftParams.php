 ...
 * Example usage:
 * ```
 * $params = (new HubdbGetDraftParams); // set properties as needed
 * $client->cms.hubdb->getDraft(...$params->toArray());
 * ```
 ...
 *   `$client->cms.hubdb->getDraft(...$params->toArray());`
 *
 * @see HubspotSDK\Cms\Hubdb->getDraft
 *
 * @phpstan-type hubdb_get_draft_params = array{
 *   archived?: bool, includeForeignIDs?: bool, isGetLocalizedSchema?: bool
 * }
 */
final class HubdbGetDraftParams implements BaseModel
{
    /** @use SdkModel<hubdb_get_draft_params> */
    use SdkModel;
    use SdkParams;
