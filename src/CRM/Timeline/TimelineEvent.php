 ...
 *
 * @phpstan-type timeline_event = array{
...
final class TimelineEvent implements BaseModel
{
    ...
    /**
     * `new TimelineEvent()` is missing required properties by the API.
     *
     ...
     *
     * ```
     * (new TimelineEvent)->withEventTemplateID(...)->withTokens(...)
     * ```
     */
