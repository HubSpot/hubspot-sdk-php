...
/**
 * @phpstan-type crm_object_type_definition_patch = array{
 ...
 * }
 */
final class CRMObjectTypeDefinitionPatch implements BaseModel
{
    /** @use SdkModel<crm_object_type_definition_patch> */
    use SdkModel;
