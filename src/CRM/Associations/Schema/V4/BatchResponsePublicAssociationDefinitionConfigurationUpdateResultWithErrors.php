...
use HubspotSDK\CRM\Associations\Schema\V4\BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors\Status;
...
final class BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors implements BaseModel
{
    ...
    #[Api(list: PublicAssociationDefinitionConfigurationUpdateResult::class)]
    ...
    /**
     * `new BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors::with(
     ...
     *
     * ```
     * (new BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors)
     *   ->withCompletedAt(...)
     *   ->withResults(...)
     *   ->withStartedAt(...)
     *   ->withStatus(...)
