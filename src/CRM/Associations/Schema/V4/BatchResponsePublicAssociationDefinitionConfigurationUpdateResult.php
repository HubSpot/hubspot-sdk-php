...
/**
 * @phpstan-type batch_response_public_association_definition_configuration_update_result = array{
...
{
    /**
     * @use SdkModel<batch_response_public_association_definition_configuration_update_result>
     */
    use SdkModel;
