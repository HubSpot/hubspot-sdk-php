...
/**
 * @phpstan-type batch_response_public_association_multi = array{
 ...
 * }
 */
final class BatchResponsePublicAssociationMulti implements BaseModel, ResponseConverter
{
    /** @use SdkModel<batch_response_public_association_multi> */
    use SdkModel;
