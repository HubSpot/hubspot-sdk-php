...
/**
 * @phpstan-type associations_v4_standard_error1 = array{
 *   category: string,
 ...
 * }
 */
final class AssociationsV4StandardError1 implements BaseModel
{
    /** @use SdkModel<associations_v4_standard_error1> */
    use SdkModel;
    ...
    /**
     * `new AssociationsV4StandardError1()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AssociationsV4StandardError1::with(
     *   category: ...,
     *   context: ...,
     *   errors: ...,
     *   links: ...,
     ...
     *
     * ```
     * (new AssociationsV4StandardError1)
     *   ->withCategory(...)
     *   ->withContext(...)
     *   ->withErrors(...)
     *   ->withLinks(...)
