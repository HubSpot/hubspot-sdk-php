...
final class BatchBatchDeleteLabelsParams implements BaseModel
{
    ...
    /**
     * `new BatchBatchDeleteLabelsParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BatchBatchDeleteLabelsParams::with(fromObjectType: ..., inputs: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new BatchBatchDeleteLabelsParams)->withFromObjectType(...)->withInputs(...)
     * ```
     */
