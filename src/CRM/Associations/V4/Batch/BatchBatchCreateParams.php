...
final class BatchBatchCreateParams implements BaseModel
{
    ...
    /**
     * `new BatchBatchCreateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BatchBatchCreateParams::with(fromObjectType: ..., inputs: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new BatchBatchCreateParams)->withFromObjectType(...)->withInputs(...)
     * ```
     */
