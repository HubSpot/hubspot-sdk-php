...
final class V4CreateDefaultAssociationParams implements BaseModel
{
    ...
    /**
     * `new V4CreateDefaultAssociationParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * V4CreateDefaultAssociationParams::with(
     ...
     *
     * ```
     * (new V4CreateDefaultAssociationParams)
     *   ->withFromObjectType(...)
     *   ->withFromObjectID(...)
     *   ->withToObjectType(...)
     * ```
