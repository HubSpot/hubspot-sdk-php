...
/**
 * @phpstan-type collection_response_public_property_validation_rule_no_paging = array{
...
{
    /**
     * @use SdkModel<collection_response_public_property_validation_rule_no_paging>
     */
    use SdkModel;
