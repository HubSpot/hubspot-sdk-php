 ...
 * Example usage:
 * ```
 * $params = (new ObjectSchemaCreateParams); // set properties as needed
 * $client->crm.objectSchemas->create(...$params->toArray());
 * ```
 * Create a new schema.
 *
 * @method toArray()
 ...
 *   `$client->crm.objectSchemas->create(...$params->toArray());`
 *
 * @see HubspotSDK\CRM\ObjectSchemas->create
 *
 * @phpstan-type object_schema_create_params = array{
 ...
 * }
 */
final class ObjectSchemaCreateParams implements BaseModel
{
    /** @use SdkModel<object_schema_create_params> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new ObjectSchemaCreateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ObjectSchemaCreateParams::with(
     *   associatedObjects: ...,
     *   labels: ...,
     *   name: ...,
     *   properties: ...,
