...
/**
 * @phpstan-type calculated_property_limit_response = array{
 ...
 * }
 */
final class CalculatedPropertyLimitResponse implements BaseModel, ResponseConverter
{
    /** @use SdkModel<calculated_property_limit_response> */
    use SdkModel;
