...
/**
 * @phpstan-type crm_object_type_definition_labels = array{
 *   plural?: string, singular?: string
 * }
 */
final class CRMObjectTypeDefinitionLabels implements BaseModel
{
    /** @use SdkModel<crm_object_type_definition_labels> */
    use SdkModel;
