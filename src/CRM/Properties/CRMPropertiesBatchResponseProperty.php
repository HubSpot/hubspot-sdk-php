...
/**
 * @phpstan-type crm_properties_batch_response_property = array{
...
final class CRMPropertiesBatchResponseProperty implements BaseModel, ResponseConverter
{
    ...
    /**
     * `new CRMPropertiesBatchResponseProperty()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CRMPropertiesBatchResponseProperty::with(
     ...
     *
     * ```
     * (new CRMPropertiesBatchResponseProperty)
     *   ->withCompletedAt(...)
     *   ->withResults(...)
     *   ->withStartedAt(...)
     *   ->withStatus(...)
