...
/**
 * @phpstan-type crm_objects_value_with_timestamp = array{
 *   sourceType: string,
 ...
 * }
 */
final class CRMObjectsValueWithTimestamp implements BaseModel
{
    /** @use SdkModel<crm_objects_value_with_timestamp> */
    use SdkModel;
    ...
    /**
     * `new CRMObjectsValueWithTimestamp()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CRMObjectsValueWithTimestamp::with(sourceType: ..., timestamp: ..., value: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new CRMObjectsValueWithTimestamp)
     *   ->withSourceType(...)
     *   ->withTimestamp(...)
     *   ->withValue(...)
     * ```
