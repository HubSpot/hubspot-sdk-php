...
/**
 * @phpstan-type crm_objects_public_object_search_request = array{
 *   after?: string,
 ...
 * }
 */
final class CRMObjectsPublicObjectSearchRequest implements BaseModel
{
    /** @use SdkModel<crm_objects_public_object_search_request> */
    use SdkModel;
