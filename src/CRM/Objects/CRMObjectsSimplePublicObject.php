...
/**
 * @phpstan-type crm_objects_simple_public_object = array{
 *   id: string,
 ...
 * }
 */
final class CRMObjectsSimplePublicObject implements BaseModel
{
    /** @use SdkModel<crm_objects_simple_public_object> */
    use SdkModel;
    ...
    /**
     * `new CRMObjectsSimplePublicObject()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CRMObjectsSimplePublicObject::with(
     ...
     *
     * ```
     * (new CRMObjectsSimplePublicObject)
     *   ->withID(...)
     *   ->withCreatedAt(...)
     *   ->withProperties(...)
     *   ->withUpdatedAt(...)
