 ...
 *
 * @see HubspotSDK\CRM\Objects\Custom->read
 *
 * @phpstan-type CustomReadParamsShape = array{
 *   objectType: string,
 *   archived?: bool,
 ...
 * }
 */
final class CustomReadParams implements BaseModel
{
    /** @use SdkModel<CustomReadParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new CustomReadParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CustomReadParams::with(objectType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new CustomReadParams)->withObjectType(...)
     * ```
     */
