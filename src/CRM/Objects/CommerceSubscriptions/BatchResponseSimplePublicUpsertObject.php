...
use HubspotSDK\CRM\Objects\CommerceSubscriptions\BatchResponseSimplePublicUpsertObject\Status;
use HubspotSDK\CRM\SimplePublicUpsertObject;
...
final class BatchResponseSimplePublicUpsertObject implements BaseModel
{
    ...
    /** @var list<SimplePublicUpsertObject>|null $results */
    #[Api(list: SimplePublicUpsertObject::class, optional: true)]
