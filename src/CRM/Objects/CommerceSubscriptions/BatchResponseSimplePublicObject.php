...
use HubspotSDK\CRM\Objects\CommerceSubscriptions\BatchResponseSimplePublicObject\Status;
...
final class BatchResponseSimplePublicObject implements BaseModel
{
    ...
    /** @var list<SimplePublicObject>|null $results */
    #[Api(list: SimplePublicObject::class, optional: true)]
