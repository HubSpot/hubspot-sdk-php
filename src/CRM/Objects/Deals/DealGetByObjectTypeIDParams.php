 ...
 * Example usage:
 * ```
 * $params = (new DealGetByObjectTypeIDParams); // set properties as needed
 * $client->crm.objects.deals->getByObjectTypeID(...$params->toArray());
 * ```
 * Read.
 *
 * @method toArray()
 ...
 *   `$client->crm.objects.deals->getByObjectTypeID(...$params->toArray());`
 *
 * @see HubspotSDK\CRM\Objects\Deals->getByObjectTypeID
 *
 * @phpstan-type deal_get_by_object_type_id_params = array{
 *   archived?: bool,
 ...
 * }
 */
final class DealGetByObjectTypeIDParams implements BaseModel
{
    /** @use SdkModel<deal_get_by_object_type_id_params> */
    use SdkModel;
    use SdkParams;
