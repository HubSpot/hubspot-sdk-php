 ...
 * Example usage:
 * ```
 * $params = (new DealUpsertParams); // set properties as needed
 * $client->crm.objects.deals->upsert(...$params->toArray());
 * ```
 ...
 *   `$client->crm.objects.deals->upsert(...$params->toArray());`
 *
 * @see HubspotSDK\CRM\Objects\Deals->upsert
 *
 * @phpstan-type deal_upsert_params = array{
 *   inputs: list<CRMObjectsSimplePublicObjectBatchInputUpsert>
 * }
 */
final class DealUpsertParams implements BaseModel
{
    /** @use SdkModel<deal_upsert_params> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new DealUpsertParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * DealUpsertParams::with(inputs: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new DealUpsertParams)->withInputs(...)
     * ```
     */
