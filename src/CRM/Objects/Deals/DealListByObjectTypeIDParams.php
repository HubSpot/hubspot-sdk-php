 ...
 * Example usage:
 * ```
 * $params = (new DealListByObjectTypeIDParams); // set properties as needed
 * $client->crm.objects.deals->listByObjectTypeID(...$params->toArray());
 * ```
 * List.
 *
 * @method toArray()
 ...
 *   `$client->crm.objects.deals->listByObjectTypeID(...$params->toArray());`
 *
 * @see HubspotSDK\CRM\Objects\Deals->listByObjectTypeID
 *
 * @phpstan-type deal_list_by_object_type_id_params = array{
 *   after?: string,
 *   archived?: bool,
 ...
 * }
 */
final class DealListByObjectTypeIDParams implements BaseModel
{
    /** @use SdkModel<deal_list_by_object_type_id_params> */
    use SdkModel;
    use SdkParams;
