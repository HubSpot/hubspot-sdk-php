 ...
 * Example usage:
 * ```
 * $params = (new DealReadParams); // set properties as needed
 * $client->crm.objects.deals->read(...$params->toArray());
 * ```
 ...
 *   `$client->crm.objects.deals->read(...$params->toArray());`
 *
 * @see HubspotSDK\CRM\Objects\Deals->read
 *
 * @phpstan-type deal_read_params = array{
 *   archived?: bool,
 ...
 * }
 */
final class DealReadParams implements BaseModel
{
    /** @use SdkModel<deal_read_params> */
    use SdkModel;
    use SdkParams;
