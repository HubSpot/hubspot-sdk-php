 ...
 * Example usage:
 * ```
 * $params = (new DealSearchByObjectTypeIDParams); // set properties as needed
 * $client->crm.objects.deals->searchByObjectTypeID(...$params->toArray());
 * ```.
 *
 * @method toArray()
 ...
 *   `$client->crm.objects.deals->searchByObjectTypeID(...$params->toArray());`
 *
 * @see HubspotSDK\CRM\Objects\Deals->searchByObjectTypeID
 *
 * @phpstan-type deal_search_by_object_type_id_params = array{
 *   after?: string,
 ...
 * }
 */
final class DealSearchByObjectTypeIDParams implements BaseModel
{
    /** @use SdkModel<deal_search_by_object_type_id_params> */
    use SdkModel;
    use SdkParams;
