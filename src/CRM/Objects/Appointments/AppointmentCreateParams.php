...
final class AppointmentCreateParams implements BaseModel
{
    ...
    /**
     * `new AppointmentCreateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AppointmentCreateParams::with(properties: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new AppointmentCreateParams)->withProperties(...)
     * ```
     */
