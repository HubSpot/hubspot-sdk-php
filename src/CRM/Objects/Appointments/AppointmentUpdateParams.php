...
final class AppointmentUpdateParams implements BaseModel
{
    ...
    /**
     * `new AppointmentUpdateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AppointmentUpdateParams::with(properties: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new AppointmentUpdateParams)->withProperties(...)
     * ```
     */
