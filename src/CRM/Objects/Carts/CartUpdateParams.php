 ...
 *
 * @phpstan-type cart_update_params = array{
 *   properties: array<string, string>, idProperty?: string
 * }
 */
final class CartUpdateParams implements BaseModel
{
    /** @use SdkModel<cart_update_params> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new CartUpdateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CartUpdateParams::with(properties: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new CartUpdateParams)->withProperties(...)
     * ```
     */
