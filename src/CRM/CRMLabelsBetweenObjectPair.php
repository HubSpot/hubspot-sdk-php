...
/**
 * @phpstan-type crm_labels_between_object_pair = array{
 *   fromObjectID: string,
 ...
 * }
 */
final class CRMLabelsBetweenObjectPair implements BaseModel
{
    /** @use SdkModel<crm_labels_between_object_pair> */
    use SdkModel;
    ...
    /**
     * `new CRMLabelsBetweenObjectPair()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CRMLabelsBetweenObjectPair::with(
     *   fromObjectID: ...,
     *   fromObjectTypeID: ...,
     *   labels: ...,
     *   toObjectID: ...,
     ...
     *
     * ```
     * (new CRMLabelsBetweenObjectPair)
     *   ->withFromObjectID(...)
