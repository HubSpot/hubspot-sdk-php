...
use HubspotSDK\Events\RelativeComparativeTimestampRefineBy\Comparison;
use HubspotSDK\Events\RelativeComparativeTimestampRefineBy\Type;

/**
 * @phpstan-import-type TimeOffsetShape from \HubspotSDK\Events\TimeOffset
 *
