...
final class EventDefinitionCreateParams implements BaseModel
{
    ...
    /**
     * `new EventDefinitionCreateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * EventDefinitionCreateParams::with(label: ..., propertyDefinitions: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new EventDefinitionCreateParams)->withLabel(...)->withPropertyDefinitions(...)
     * ```
     */
