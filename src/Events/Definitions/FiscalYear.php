...
use HubSpotSDK\Events\Definitions\FiscalYear\ReferenceType;
...
final class FiscalYear implements BaseModel
{
    ...
    /**
     * `new FiscalYear()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * FiscalYear::with(day: ..., month: ..., referenceType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new FiscalYear)->withDay(...)->withMonth(...)->withReferenceType(...)
     * ```
     */
