...
use HubSpotSDK\Events\Definitions\ComparativePropertyUpdatedOperation\Operator;
use HubSpotSDK\Events\Definitions\ComparativePropertyUpdatedOperation\PropertyType;
