...
use HubSpotSDK\Events\Definitions\DefinitionsAssociationDefinition\Cardinality;
use HubSpotSDK\Events\Definitions\DefinitionsAssociationDefinition\Category;
use HubSpotSDK\Events\Definitions\DefinitionsAssociationDefinition\FromObjectType;
use HubSpotSDK\Events\Definitions\DefinitionsAssociationDefinition\HiddenReason;
use HubSpotSDK\Events\Definitions\DefinitionsAssociationDefinition\InverseCardinality;
use HubSpotSDK\Events\Definitions\DefinitionsAssociationDefinition\ToObjectType;

/**
 * The definition of an association.
 *
 * @phpstan-type DefinitionsAssociationDefinitionShape = array{
 *   id: int,
 ...
 * }
 */
final class DefinitionsAssociationDefinition implements BaseModel
{
    /** @use SdkModel<DefinitionsAssociationDefinitionShape> */
    use SdkModel;
    ...
    /**
     * `new DefinitionsAssociationDefinition()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * DefinitionsAssociationDefinition::with(
     *   id: ...,
     *   allowsCustomLabels: ...,
     *   cardinality: ...,
     *   category: ...,
     ...
     *
     * ```
     * (new DefinitionsAssociationDefinition)
     *   ->withID(...)
