...
use HubSpotSDK\Events\Definitions\ComparativeStringPropertyOperation\Operator;
use HubSpotSDK\Events\Definitions\ComparativeStringPropertyOperation\PropertyType;

/**
 * @phpstan-type ComparativeStringPropertyOperationShape = array{
 ...
 * }
 */
final class ComparativeStringPropertyOperation implements BaseModel
{
    /** @use SdkModel<ComparativeStringPropertyOperationShape> */
    use SdkModel;
    ...
    /**
     * `new ComparativeStringPropertyOperation()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ComparativeStringPropertyOperation::with(
     ...
     *
     * ```
     * (new ComparativeStringPropertyOperation)
    ...
    public static function with(
        ...
        string $operatorName,
        PropertyType|string $propertyType = 'string-comparative',
