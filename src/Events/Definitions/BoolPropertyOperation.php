...
use HubspotSDK\Events\Definitions\BoolPropertyOperation\Operator;
use HubspotSDK\Events\Definitions\BoolPropertyOperation\PropertyType;
...
final class BoolPropertyOperation implements BaseModel
{
    ...
    /**
     * `new BoolPropertyOperation()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BoolPropertyOperation::with(
