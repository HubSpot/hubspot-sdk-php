...
use HubSpotSDK\Events\Definitions\RangedNumberPropertyOperation\Operator;
use HubSpotSDK\Events\Definitions\RangedNumberPropertyOperation\PropertyType;
...
final class RangedNumberPropertyOperation implements BaseModel
{
    ...
    public function withLowerBound(float $lowerBound): self
    {
        $self = clone $this;
        $self['lowerBound'] = $lowerBound;
    ...
    public function withUpperBound(float $upperBound): self
    {
        $self = clone $this;
        $self['upperBound'] = $upperBound;
