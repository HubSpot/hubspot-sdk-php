...
use HubSpotSDK\Events\Definitions\FiscalQuarter\ReferenceType;
...
final class FiscalQuarter implements BaseModel
{
    ...
    /**
     * `new FiscalQuarter()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * FiscalQuarter::with(day: ..., month: ..., referenceType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new FiscalQuarter)->withDay(...)->withMonth(...)->withReferenceType(...)
     * ```
     */
