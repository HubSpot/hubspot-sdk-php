...
use HubSpotSDK\Events\Definitions\YearReference\ReferenceType;
...
final class YearReference implements BaseModel
{
    ...
    /**
     * `new YearReference()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * YearReference::with(day: ..., month: ..., referenceType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new YearReference)->withDay(...)->withMonth(...)->withReferenceType(...)
     * ```
     */
