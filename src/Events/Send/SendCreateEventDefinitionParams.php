 ...
 * }
 */
final class SendCreateEventDefinitionParams implements BaseModel
{
    /** @use SdkModel<SendCreateEventDefinitionParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new SendCreateEventDefinitionParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SendCreateEventDefinitionParams::with(
     ...
     *
     * ```
     * (new SendCreateEventDefinitionParams)
