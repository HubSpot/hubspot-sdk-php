...
use HubspotSDK\Events\Send\IndexedTimePoint\TimeType;
use HubspotSDK\Events\Send\IndexedTimePoint\TimezoneSource;

/**
 * @phpstan-import-type IndexReferenceVariants from \HubspotSDK\Events\Send\IndexedTimePoint\IndexReference
 * @phpstan-import-type IndexReferenceShape from \HubspotSDK\Events\Send\IndexedTimePoint\IndexReference
 * @phpstan-import-type IndexOffsetShape from \HubspotSDK\Events\Send\IndexOffset
 *
 ...
 *   shouldGenerateRefreshTime?: bool|null,
 * }
 */
final class IndexedTimePoint implements BaseModel
{
    ...
    #[Optional]
    public ?bool $shouldGenerateRefreshTime;
    ...
    public static function with(
        ...
        ?bool $shouldGenerateRefreshTime = null,
    ): self {
        $self = new self;
        ...
        null !== $shouldGenerateRefreshTime && $self['shouldGenerateRefreshTime'] = $shouldGenerateRefreshTime;
    ...
    public function withShouldGenerateRefreshTime(
        bool $shouldGenerateRefreshTime
    ): self {
        $self = clone $this;
        $self['shouldGenerateRefreshTime'] = $shouldGenerateRefreshTime;
