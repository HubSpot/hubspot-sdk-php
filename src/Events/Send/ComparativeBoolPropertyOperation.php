...
use HubspotSDK\Events\Send\ComparativeBoolPropertyOperation\Operator;
use HubspotSDK\Events\Send\ComparativeBoolPropertyOperation\PropertyType;
 ...
 * }
 */
final class ComparativeBoolPropertyOperation implements BaseModel
{
    /** @use SdkModel<ComparativeBoolPropertyOperationShape> */
    use SdkModel;
    ...
    /**
     * `new ComparativeBoolPropertyOperation()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ComparativeBoolPropertyOperation::with(
     ...
     *
     * ```
     * (new ComparativeBoolPropertyOperation)
    ...
    public static function with(
        ...
        string $operatorName,
        PropertyType|string $propertyType = 'bool-comparative',
