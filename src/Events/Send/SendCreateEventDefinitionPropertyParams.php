...
/**
 * @see HubspotSDK\Services\Events\SendService::createEventDefinitionProperty()
 *
 * @phpstan-import-type OptionInputShape from \HubspotSDK\Events\Send\OptionInput
 *
 * @phpstan-type SendCreateEventDefinitionPropertyParamsShape = array{
 *   label: string,
 *   type: string,
 ...
 * }
 */
final class SendCreateEventDefinitionPropertyParams implements BaseModel
{
    /** @use SdkModel<SendCreateEventDefinitionPropertyParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new SendCreateEventDefinitionPropertyParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SendCreateEventDefinitionPropertyParams::with(label: ..., type: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new SendCreateEventDefinitionPropertyParams)->withLabel(...)->withType(...)
     * ```
     */
