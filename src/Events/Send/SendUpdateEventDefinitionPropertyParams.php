 ...
 * }
 */
final class SendUpdateEventDefinitionPropertyParams implements BaseModel
{
    /** @use SdkModel<SendUpdateEventDefinitionPropertyParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new SendUpdateEventDefinitionPropertyParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SendUpdateEventDefinitionPropertyParams::with(eventName: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new SendUpdateEventDefinitionPropertyParams)->withEventName(...)
     * ```
     */
