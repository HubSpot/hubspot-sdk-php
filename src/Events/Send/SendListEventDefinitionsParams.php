...
/**
 * @see HubspotSDK\Services\Events\SendService::listEventDefinitions()
 *
 * @phpstan-type SendListEventDefinitionsParamsShape = array{
 *   after?: string|null,
 ...
 * }
 */
final class SendListEventDefinitionsParams implements BaseModel
{
    /** @use SdkModel<SendListEventDefinitionsParamsShape> */
    use SdkModel;
    use SdkParams;
