 ...
 *
 * @see HubspotSDK\Events->send
 *
 * @phpstan-type event_send_params = array{
 *   eventName: string,
 *   email?: string,
 *   objectID?: string,
...
{
    /** @use SdkModel<event_send_params> */
    use SdkModel;
    use SdkParams;
     ...
     * ```
     * EventSendParams::with(eventName: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new EventSendParams)->withEventName(...)
     * ```
     */
