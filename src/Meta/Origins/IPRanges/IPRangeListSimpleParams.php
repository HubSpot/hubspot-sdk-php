...
final class IPRangeListSimpleParams implements BaseModel
{
    ...
    /**
     * An array of directions to filter the IP ranges by. Valid values are `INGRESS` and `EGRESS`.
     *
    ...
    /**
     * An array specifying the service types to filter by. Valid values include `EMAIL`, `API`, `DNS`, `WEB_SCRAPING`, and `TEST_SERVICE`.
     *
