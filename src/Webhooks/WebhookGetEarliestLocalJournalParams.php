...
/**
 * @see HubspotSDK\Services\WebhooksService::getEarliestLocalJournal()
 *
 * @phpstan-type WebhookGetEarliestLocalJournalParamsShape = array{
 *   installPortalID?: int|null
 * }
 */
final class WebhookGetEarliestLocalJournalParams implements BaseModel
{
    /** @use SdkModel<WebhookGetEarliestLocalJournalParamsShape> */
    use SdkModel;
    use SdkParams;
