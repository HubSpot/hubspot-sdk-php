...
/**
 * @see HubspotSDK\Services\Webhooks\WebhooksService::getNextJournalLocalByOffset()
 *
 * @phpstan-type WebhookGetNextJournalLocalByOffsetParamsShape = array{
 *   installPortalID?: int|null
 * }
 */
final class WebhookGetNextJournalLocalByOffsetParams implements BaseModel
{
    /** @use SdkModel<WebhookGetNextJournalLocalByOffsetParamsShape> */
    use SdkModel;
    use SdkParams;
