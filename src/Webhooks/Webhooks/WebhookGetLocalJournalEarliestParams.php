...
/**
 * @see HubspotSDK\Services\Webhooks\WebhooksService::getLocalJournalEarliest()
 *
 * @phpstan-type WebhookGetLocalJournalEarliestParamsShape = array{
 *   installPortalID?: int|null
 * }
 */
final class WebhookGetLocalJournalEarliestParams implements BaseModel
{
    /** @use SdkModel<WebhookGetLocalJournalEarliestParamsShape> */
    use SdkModel;
    use SdkParams;
