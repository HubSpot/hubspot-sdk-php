...
/**
 * @see HubspotSDK\Services\Webhooks\WebhooksService::getJournalEarliest()
 *
 * @phpstan-type WebhookGetJournalEarliestParamsShape = array{
 *   installPortalID?: int|null
 * }
 */
final class WebhookGetJournalEarliestParams implements BaseModel
{
    /** @use SdkModel<WebhookGetJournalEarliestParamsShape> */
    use SdkModel;
    use SdkParams;
