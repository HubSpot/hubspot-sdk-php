...
/**
 * @see HubspotSDK\Services\Webhooks\WebhooksService::getNextJournalByOffset()
 *
 * @phpstan-type WebhookGetNextJournalByOffsetParamsShape = array{
 *   installPortalID?: int|null
 * }
 */
final class WebhookGetNextJournalByOffsetParams implements BaseModel
{
    /** @use SdkModel<WebhookGetNextJournalByOffsetParamsShape> */
    use SdkModel;
    use SdkParams;
