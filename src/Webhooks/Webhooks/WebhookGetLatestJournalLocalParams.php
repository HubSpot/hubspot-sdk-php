...
/**
 * @see HubspotSDK\Services\Webhooks\WebhooksService::getLatestJournalLocal()
 *
 * @phpstan-type WebhookGetLatestJournalLocalParamsShape = array{
 *   installPortalID?: int|null
 * }
 */
final class WebhookGetLatestJournalLocalParams implements BaseModel
{
    /** @use SdkModel<WebhookGetLatestJournalLocalParamsShape> */
    use SdkModel;
    use SdkParams;
