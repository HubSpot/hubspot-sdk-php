...
/**
 * @see HubspotSDK\Services\Webhooks\WebhooksService::getEarliestJournalLocal()
 *
 * @phpstan-type WebhookGetEarliestJournalLocalParamsShape = array{
 *   installPortalID?: int|null
 * }
 */
final class WebhookGetEarliestJournalLocalParams implements BaseModel
{
    /** @use SdkModel<WebhookGetEarliestJournalLocalParamsShape> */
    use SdkModel;
    use SdkParams;
