...
/**
 * @see HubspotSDK\Services\Webhooks\WebhooksService::getJournalLatest()
 *
 * @phpstan-type WebhookGetJournalLatestParamsShape = array{
 *   installPortalID?: int|null
 * }
 */
final class WebhookGetJournalLatestParams implements BaseModel
{
    /** @use SdkModel<WebhookGetJournalLatestParamsShape> */
    use SdkModel;
    use SdkParams;
