...
/**
 * @see HubspotSDK\Services\Webhooks\WebhooksService::getEarliestJournal()
 *
 * @phpstan-type WebhookGetEarliestJournalParamsShape = array{
 *   installPortalID?: int|null
 * }
 */
final class WebhookGetEarliestJournalParams implements BaseModel
{
    /** @use SdkModel<WebhookGetEarliestJournalParamsShape> */
    use SdkModel;
    use SdkParams;
