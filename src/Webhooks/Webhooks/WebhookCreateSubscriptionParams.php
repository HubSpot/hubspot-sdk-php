 ...
 *
 * @see HubspotSDK\Services\Webhooks\WebhooksService::createSubscription()
 *
 ...
 * }
 */
final class WebhookCreateSubscriptionParams implements BaseModel
{
    /** @use SdkModel<WebhookCreateSubscriptionParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new WebhookCreateSubscriptionParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * WebhookCreateSubscriptionParams::with(active: ..., eventType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new WebhookCreateSubscriptionParams)->withActive(...)->withEventType(...)
     * ```
     */
