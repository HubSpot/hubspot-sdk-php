...
/**
 * @see HubspotSDK\Services\Webhooks\WebhooksService::getLatestJournal()
 *
 * @phpstan-type WebhookGetLatestJournalParamsShape = array{
 *   installPortalID?: int|null
 * }
 */
final class WebhookGetLatestJournalParams implements BaseModel
{
    /** @use SdkModel<WebhookGetLatestJournalParamsShape> */
    use SdkModel;
    use SdkParams;
