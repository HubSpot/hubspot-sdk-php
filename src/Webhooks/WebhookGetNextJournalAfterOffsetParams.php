...
/**
 * @see HubSpotSDK\Services\WebhooksService::getNextJournalAfterOffset()
 *
 * @phpstan-type WebhookGetNextJournalAfterOffsetParamsShape = array{
 *   installPortalID?: int|null
 * }
 */
final class WebhookGetNextJournalAfterOffsetParams implements BaseModel
{
    /** @use SdkModel<WebhookGetNextJournalAfterOffsetParamsShape> */
    use SdkModel;
    use SdkParams;
