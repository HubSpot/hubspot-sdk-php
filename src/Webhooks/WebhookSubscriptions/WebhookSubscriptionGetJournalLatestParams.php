...
/**
 * @see HubspotSDK\Services\Webhooks\WebhookSubscriptionsService::getJournalLatest()
 *
 * @phpstan-type WebhookSubscriptionGetJournalLatestParamsShape = array{
 *   installPortalID?: int|null
 * }
 */
final class WebhookSubscriptionGetJournalLatestParams implements BaseModel
{
    /** @use SdkModel<WebhookSubscriptionGetJournalLatestParamsShape> */
    use SdkModel;
    use SdkParams;
