...
use HubspotSDK\Webhooks\WebhookSubscriptions\SnapshotStatusResponse\ErrorCode;
use HubspotSDK\Webhooks\WebhookSubscriptions\SnapshotStatusResponse\Status;
