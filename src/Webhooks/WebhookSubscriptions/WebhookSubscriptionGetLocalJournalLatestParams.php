...
/**
 * @see HubspotSDK\Services\Webhooks\WebhookSubscriptionsService::getLocalJournalLatest()
 *
 * @phpstan-type WebhookSubscriptionGetLocalJournalLatestParamsShape = array{
 *   installPortalID?: int|null
 * }
 */
final class WebhookSubscriptionGetLocalJournalLatestParams implements BaseModel
{
    /** @use SdkModel<WebhookSubscriptionGetLocalJournalLatestParamsShape> */
    use SdkModel;
    use SdkParams;
