...
/**
 * @see HubspotSDK\Services\Webhooks\WebhookSubscriptionsService::getJournalEarliest()
 *
 * @phpstan-type WebhookSubscriptionGetJournalEarliestParamsShape = array{
 *   installPortalID?: int|null
 * }
 */
final class WebhookSubscriptionGetJournalEarliestParams implements BaseModel
{
    /** @use SdkModel<WebhookSubscriptionGetJournalEarliestParamsShape> */
    use SdkModel;
    use SdkParams;
