...
/**
 * @see HubspotSDK\Services\Webhooks\WebhookSubscriptionsService::getLocalJournalEarliest()
 *
 * @phpstan-type WebhookSubscriptionGetLocalJournalEarliestParamsShape = array{
 *   installPortalID?: int|null
 * }
 */
final class WebhookSubscriptionGetLocalJournalEarliestParams implements BaseModel
{
    /** @use SdkModel<WebhookSubscriptionGetLocalJournalEarliestParamsShape> */
    use SdkModel;
    use SdkParams;
