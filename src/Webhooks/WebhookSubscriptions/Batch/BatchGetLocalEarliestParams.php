...
/**
 * @see HubspotSDK\Services\Webhooks\WebhookSubscriptions\BatchService::getLocalEarliest()
 *
 * @phpstan-type BatchGetLocalEarliestParamsShape = array{
 *   installPortalID?: int|null
 * }
 */
final class BatchGetLocalEarliestParams implements BaseModel
{
    /** @use SdkModel<BatchGetLocalEarliestParamsShape> */
    use SdkModel;
    use SdkParams;
