...
use HubspotSDK\Files\FilesFileUpdateInput\Access;

/**
 * @phpstan-type files_file_update_input = array{
 ...
 * }
 */
final class FilesFileUpdateInput implements BaseModel
{
    /** @use SdkModel<files_file_update_input> */
    use SdkModel;
