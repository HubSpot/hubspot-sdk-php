...
use HubspotSDK\Files\File\SourceGroup;
 ...
 *   path?: string|null,
 *   size?: int|null,
 *   sourceGroup?: null|SourceGroup|value-of<SourceGroup>,
 *   type?: string|null,
 *   url?: string|null,
 *   width?: int|null,
 * }
...
final class File implements BaseModel
{
    ...
    /** @var value-of<SourceGroup>|null $sourceGroup */
    #[Optional(enum: SourceGroup::class)]
     ...
     * ```
     * File::with(id: ..., archived: ..., createdAt: ..., updatedAt: ...)
     * ```
     *
     ...
     * @param SourceGroup|value-of<SourceGroup>|null $sourceGroup
     */
    public static function with(
        ...
        ?string $path = null,
        ?int $size = null,
        SourceGroup|string|null $sourceGroup = null,
        ?string $type = null,
        ?string $url = null,
        ?int $width = null,
    ): self {
    ...
    /**
     * @param SourceGroup|value-of<SourceGroup> $sourceGroup
     */
    public function withSourceGroup(SourceGroup|string $sourceGroup): self
    {
        $self = clone $this;
