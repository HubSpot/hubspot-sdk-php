...
use HubspotSDK\Files\FilesImportFromURLInput\Access;
use HubspotSDK\Files\FilesImportFromURLInput\DuplicateValidationScope;
use HubspotSDK\Files\FilesImportFromURLInput\DuplicateValidationStrategy;

/**
 * @phpstan-type files_import_from_url_input = array{
 ...
 * }
 */
final class FilesImportFromURLInput implements BaseModel
{
    /** @use SdkModel<files_import_from_url_input> */
    use SdkModel;
    ...
    /**
     * `new FilesImportFromURLInput()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * FilesImportFromURLInput::with(access: ..., url: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new FilesImportFromURLInput)->withAccess(...)->withURL(...)
     * ```
     */
