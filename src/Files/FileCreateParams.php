 ...
 * Example usage:
 * ```
 * $params = (new FileCreateParams); // set properties as needed
 * $client->files->create(...$params->toArray());
 * ```
 * Create folder.
 *
 * @method toArray()
