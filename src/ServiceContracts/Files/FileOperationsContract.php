...
interface FileOperationsContract
{
    ...
    public function importFromURLAsync(
        \HubspotSDK\Files\FileOperations\FileOperationImportFromURLAsyncParams\Access|string $access,
        string $url,
